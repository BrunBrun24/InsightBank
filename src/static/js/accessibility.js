!(
  ...
  })('u' < typeof window ? this : window, (e, t, i, r, s, n, o, a, l) =>
    (() => {
      'use strict';
      let h;
      var d,
      ...
      function b(e) {
        ...
        let i = (m[e] = { exports: {} });
        return (g[e](i, i.exports, b), i.exports);
      }
      ((b.n = (e) => {
          ...
          if (Array.isArray(t))
            for (var i = 0; i < t.length; ) {
              ...
              b.o(e, r)
                ? 0 === s && i++
                : 0 === s
                  ? Object.defineProperty(e, r, { enumerable: !0, value: t[i++] })
                  : Object.defineProperty(e, r, { enumerable: !0, get: s });
            }
          else
            for (var r in t)
              b.o(t, r) &&
      ...
      var x = b(944),
        y = b.n(x);
      let { doc: v, win: E } = y(),
        w = (E.EventTarget && new E.EventTarget()) || 'none';
      function A(e) {
        if ('function' == typeof E.MouseEvent) return new E.MouseEvent(e.type, e);
        if (v?.createEvent) {
          let t = v.createEvent('MouseEvent');
          if (t.initMouseEvent)
            return (
              t.initMouseEvent(
                e.type,
      ...
      function T(e, t, i) {
        let r = t || { x: 0, y: 0 };
        if ('function' == typeof E.MouseEvent)
          return new E.MouseEvent(e, {
            bubbles: !0,
            cancelable: !0,
            composed: !0,
            button: 0,
      ...
      let k = {
        ...
        cloneTouchEvent: function (e) {
          ...
          if ('function' == typeof E.TouchEvent) {
            let i = new E.TouchEvent(e.type, {
              touches: t(e.touches),
      ...
      function D(e, t, i) {
        let r = (e, t) => {
            let i = e.slice(t || 0),
              ...
              s = i.indexOf('}');
            if (r > -1 && s > r)
              return { statement: i.substring(r + 1, s), begin: t + r + 1, end: t + s };
          },
          s = [],
          n,
          o,
        ...
        do
          ((n = r(e, a)),
            (o = e.substring(a, n && n.begin - 1)).length &&
              s.push({ value: o, type: 'constant' }),
            n && s.push({ value: n.statement, type: 'statement' }),
            (a = n ? n.end + 1 : a + 1));
        while (n);
        return (
          s.forEach((e) => {
            'statement' === e.type &&
              (e.value = (function (e, t) {
                let i,
                  ...
                  a = e.indexOf(']');
                if (s > -1) {
                  let n = e.slice(s).indexOf(')') + s,
                    o = e.substring(0, s),
                    a = e.substring(n + 1),
                    l = e.substring(s + 6, n).split(','),
                    h = Number(l[1]),
                    d;
                  if (((r = ''), (i = (0, x.getNestedProperty)(l[0], t)))) {
                    d =
                      (h = isNaN(h) ? i.length : h) < 0
                        ? i.length + h
                        : Math.min(h, i.length);
                    for (let e = 0; e < d; ++e) r += o + i[e] + a;
                  }
                  return r.length ? r : '';
                }
                if (n > -1) {
                  ...
                  let i = e.slice(n).indexOf(')') + n,
                    s = e.substring(n + 8, i).split(',');
                  switch (Number((0, x.getNestedProperty)(s[0], t))) {
                    case 0:
                      r = (0, x.pick)(s[4], s[1]);
                      break;
                    case 1:
                  ...
                  return r
                    ? ((l = r).trim && l.trim()) || l.replace(/^\s+|\s+$/g, '')
                    : '';
                }
                if (o > -1) {
                  let r,
                  ...
                  return (
                    (i = (0, x.getNestedProperty)(s, t)),
                    !isNaN(n) &&
                      i &&
                      (n < 0
                        ? void 0 === (r = i[i.length + n]) && (r = i[0])
                        : void 0 === (r = i[n]) && (r = i[i.length - 1])),
                    void 0 !== r ? r : ''
                  );
                }
                return '{' + e + '}';
      ...
      function N(e, t) {
        let i = e.split('.'),
          r = this.options.lang,
          s = 0;
        for (; s < i.length; ++s) r = r && r[i[s]];
        return 'string' == typeof r ? D(r, t, this) : '';
      }
      ((P.compose = function (e) {
        let t = e.prototype;
        t.langFormat || (t.langFormat = N);
      }),
        (P.i18nFormat = D));
      let B = d,
        { doc: I } = y(),
        { stripHTMLTagsFromString: F } = k;
      function O(e) {
        if (e.points && e.points.length) {
          let t = (0, x.find)(e.points, (e) => !!e.graphic);
      ...
      let L = {
          fireEventOnWrappedOrUnwrappedElement: function e(t, i) {
            let r = i.type,
              s = t.hcEvents;
            I?.createEvent && (t.dispatchEvent || t.fireEvent)
              ? t.dispatchEvent
                ? t.dispatchEvent(i)
                : t.fireEvent(r, i)
              : s && s[r]
          ...
          getAxisDescription: function (e) {
            return (
              ...
              (e.options.accessibility?.description ||
                ...
                (e.dateTime &&
                  e.chart.langFormat('accessibility.axis.defaultAxisNames.time', {})) ||
                e.chart.langFormat('accessibility.axis.defaultAxisNames.values', {}))
            );
          },
          getAxisRangeDescription: function (e) {
            ...
            let s,
              ...
              m,
              b = e.options || {};
            return b.accessibility && void 0 !== b.accessibility.rangeDescription
              ...
              : e.categories
                ...
                : e.dateTime && (0 === e.min || 0 === e.dataMin)
                  ? ((n = (i = e).chart),
                    ...
                    (d = o[h].toFixed(+('Seconds' !== h && 'Minutes' !== h))),
                  ...
                  : ((p =
                      ((u = (c = (r = e).chart).options) &&
                        u.accessibility &&
                        u.accessibility.screenReaderSection.axisRangeDateFormat) ||
                      ''),
                    (g = { min: r.dataMin || r.min || 0, max: r.dataMax || r.max || 0 }),
                    (m = function (e) {
                      return r.dateTime ? c.time.dateFormat(p, g[e]) : g[e].toString();
                    }),
                    c.langFormat('accessibility.axis.rangeFromTo', {
                      chart: c,
                      axis: r,
                      rangeFrom: m('min'),
                      rangeTo: m('max'),
          ...
          getPointFromXY: function (e, t, i) {
            ...
            for (; r--; )
              if (
                (s = (0, x.find)(e[r].points || [], function (e) {
                  return e.x === t && e.y === i;
                }))
              )
                return s;
          },
          getSeriesFirstPointElement: O,
          ...
          scrollAxisToPoint: function (e) {
            let t = e.series.xAxis,
              ...
              r = t && t.scrollbar ? t : i,
              s = r && r.scrollbar;
            if (s && (0, x.defined)(s.to) && (0, x.defined)(s.from)) {
              let t = s.to - s.from,
                i = (function (e, t) {
                  if (!(0, x.defined)(e.dataMin) || !(0, x.defined)(e.dataMax)) return 0;
                  let i = e.toPixels(e.dataMin),
                    r = e.toPixels(e.dataMax),
                    s = 'xAxis' === e.coll ? 'x' : 'y';
                  return (e.toPixels(t[s] || 0) - i) / (r - i);
                })(r, e);
              (s.updatePosition(i - t / 2, i + t / 2),
                (0, x.fireEvent)(s, 'changed', {
                  from: s.from,
                  to: s.to,
                  trigger: 'scrollbar',
                  DOMEvent: null,
        ...
        q = class {
          ...
          createElement() {
            let e = H.createElement.apply(H, arguments);
            return (this.elements.push(e), e);
          }
          removeElement(e) {
            (z(e), this.elements.splice(this.elements.indexOf(e), 1));
          }
        ...
        U = class {
          ...
          addEvent() {
            let e = x.addEvent.apply(y(), arguments);
        ...
        { fireEventOnWrappedOrUnwrappedElement: G } = L,
        { getFakeMouseEvent: K } = k,
        V = class {
          destroy() {}
          ...
          addEvent(e, t, i, r) {
            return this.eventProvider.addEvent(e, t, i, r);
          }
          createElement(e, t) {
        ...
        W = class {
          ...
          run(e) {
            let t = e.which || e.keyCode,
              ...
              r = (0, x.find)(this.keyCodeMap, function (e) {
        ...
        { unhideChartElementFromAT: X, getChartTitle: Y } = L,
        { doc: j } = y(),
        { stripHTMLTagsFromString: Z } = k,
        _ = class extends V {
          onChartUpdate() {
          ...
          handleSVGTitleElement() {
            let e = this.chart,
              ...
              i = Z(
                e.langFormat('accessibility.svgContainerTitle', { chartTitle: Y(e) })
              );
            if (i.length) {
              let r = (this.svgTitleElement =
                this.svgTitleElement ||
                j.createElementNS('http://www.w3.org/2000/svg', 'title'));
              ((r.textContent = i),
                (r.id = t),
                e.renderTo.insertBefore(r, e.renderTo.firstChild));
            }
          }
          setSVGContainerLabel() {
            let e = this.chart,
              t = e.langFormat('accessibility.svgContainerLabel', { chartTitle: Y(e) });
              ...
              (t.textStr &&
                t.element.setAttribute(
                  ...
                  e.langFormat('accessibility.credits', {
                    creditsStr: Z(t.textStr, e.renderer.forExport),
                  })
                ),
              X(e, t.element));
          }
      ...
      !(function (e) {
        ...
        function r(e, t) {
          ...
          (r &&
            r.focus &&
            ((r.hcEvents && r.hcEvents.focusin) ||
              (0, x.addEvent)(r, 'focusin', function () {}),
            r.focus(),
            i.hideBrowserFocusOutline && (r.style.outline = 'none')),
            this.focusElement && this.focusElement.removeFocusBorder(),
            (this.focusElement = e),
            (0, x.addEvent)(this, 'endResize', function () {
        ...
        function s(e, i) {
          ...
          if ('text' === this.element.nodeName || g) {
            let e,
              ...
              a = +this.attr('y');
            if (
              (isNaN(o) || (d = o - r.width * n.x - s),
              isNaN(a) ||
                (c = a - ('start' === this.attr('text-anchor') ? h : r.height) * n.y - s),
              g && i)
            ) {
              let e = u;
              ((u = p),
                (p = e),
                isNaN(o) || (d = o - r.height * n.x - s),
                isNaN(a) || (c = a - r.width * n.y - s));
            }
          }
          ((this.focusBorder = this.renderer
            .rect(d, c, u, p, parseInt(((i && i.r) || 0).toString(), 10) / l)
            ...
            (function (e, ...i) {
              e.focusBorderUpdateHooks ||
                ...
                t.forEach((t) => {
                  let r = t + 'Setter',
                    s = e[r] || e._defaultSetter;
                  ((e.focusBorderUpdateHooks[r] = s),
                    (e[r] = function () {
                      let t = s.apply(e, arguments);
        ...
        e.compose = function (e, t) {
          let o = e.prototype,
            a = t.prototype;
          (o.renderFocusBorder || ((o.renderFocusBorder = i), (o.setFocusToElement = r)),
            a.addFocusBorder || ((a.addFocusBorder = s), (a.removeFocusBorder = n)));
        };
      })(c || (c = {}));
      let $ = c;
      var Q = b(660),
        J = b.n(Q);
      let { doc: ee } = y(),
        { addClass: et, visuallyHideElement: ei } = k,
        er = class {
          constructor(e, t) {
            ((this.chart = e),
              (this.domElementProvider = new q()),
          ...
          announce(e) {
            (J().setElementHTML(this.announceRegion, e),
              this.clearAnnouncementRegionTimer &&
                (0, x.internalClearTimeout)(this.clearAnnouncementRegionTimer),
              (this.clearAnnouncementRegionTimer = setTimeout(() => {
                ((this.announceRegion.innerHTML = J().emptyHTML),
          ...
          addAnnounceRegion(e) {
            ...
            return (
              (0, x.attr)(i, { 'aria-hidden': !1, 'aria-live': e, 'aria-atomic': !0 }),
              ei(i),
              this.chart.styledMode && et(i, 'highcharts-visually-hidden'),
              t.appendChild(i),
              i
            );
          }
        ...
        { escapeStringForHTML: es, stripHTMLTagsFromString: en } = k;
      function eo(e) {
      ...
      function el(e) {
        ...
        let i = e.chart,
          ...
          a = {
            ...
            numPoints: n,
            annotationPoint: s[0],
            additionalAnnotationPoints: s.slice(1),
          };
        return i.langFormat(
          'accessibility.screenReaderSection.annotations.description' + o,
          a
        );
      }
      function eh(e) {
        return eo(e).map((t) => {
          let i = es(en(el(t), e.renderer.forExport));
          return i ? `<li>${i}</li>` : '';
        });
      }
      let ed = {
          ...
          getPointAnnotationTexts: function (e) {
            let t = eo(e.series.chart).filter((t) => t.points.indexOf(e) > -1);
            return t.length ? t.map((e) => `${ea(e)}`) : [];
          },
        },
        { getAnnotationsInfoHTML: ec } = ed,
        {
        ...
        { doc: ef } = y(),
        {
          ...
          stripHTMLTagsFromString: eE,
          visuallyHideElement: ew,
        } = k;
      function eA(e) {
        return (0, x.replaceNested)(e, [/<([\w\-.:!]+)\b[^<>]*>\s*<\/\1>/g, '']);
      }
      let eT = class extends V {
          ...
          init() {
            ...
            (this.initRegionsDefinitions(),
              ...
              (this.announcer = new er(e, 'assertive')));
          }
            ...
            this.screenReaderSections = {
              before: {
                ...
                buildContent: function (i) {
                  ...
                  return r ? r(i, e) : e.defaultBeforeChartFormatter();
                },
              ...
              after: {
                ...
                buildContent: function (i) {
                  ...
                  return r ? r(i, e) : e.defaultAfterChartFormatter();
                },
                insertIntoDOM: function (e, t) {
          ...
          getLinkedDescriptionElement() {
            ...
            let t = eb(e, this.chart),
              i = ef.querySelectorAll(t);
          ...
          setLinkedDescriptionAttrs() {
            ...
            e &&
              ...
              ex(e, 'highcharts-linked-description'));
          }
          updateScreenReaderSection(e) {
            let t = this.chart,
              i = this.screenReaderSections[e],
              r = i.buildContent(t),
              s = (i.element = i.element || this.createElement('div')),
              n = s.firstChild || this.createElement('div');
            r
              ? (this.setScreenReaderSectionAttribs(s, e),
                J().setElementHTML(n, r),
                s.appendChild(n),
                i.insertIntoDOM(s, t),
                ew(n),
                t.styledMode && ex(n, 'highcharts-visually-hidden'),
                em(t, n),
                i.afterInserted && i.afterInserted())
              : (s.parentNode && s.parentNode.removeChild(s), (i.element = null));
          }
          setScreenReaderSectionAttribs(e, t) {
            let i = this.chart,
              r = i.langFormat('accessibility.screenReaderSection.' + t + 'RegionLabel', {
                chart: i,
                chartTitle: eg(i),
              }),
              s = `highcharts-screen-reader-region-${t}-${i.index}`;
            ((0, x.attr)(e, { id: s, 'aria-label': r || void 0 }),
          ...
          defaultBeforeChartFormatter() {
            ...
            let i = this.getAxesDescription(),
              r = e.sonify && e.options.sonification && e.options.sonification.enabled,
              s = 'highcharts-a11y-sonify-data-btn-' + e.index,
              ...
              l = {
                ...
                playAsSoundButton: r ? this.getSonifyButtonText(s) : '',
              ...
              h = B.i18nFormat(t, l, e);
            return ((this.dataTableButtonId = n), (this.sonifyButtonId = s), eA(h));
          }
          ...
          getLongdescText() {
            let e = this.chart.options,
              t = e.caption,
              i = t && t.text,
              r = this.getLinkedDescription();
            return e.accessibility.description || r || i || '';
          }
              ...
              ? e.options.accessibility.typeDescription ||
                  (function (e, t) {
                    let i,
                      ...
                      s,
                      n = t[0],
                      o = (e.series && e.series[0]) || {},
                      a = e.mapView && e.mapView.geoMap && e.mapView.geoMap.title,
                      l = {
                    ...
                    return n
                      ? 'map' === n || 'tiledwebmap' === n
                        ? l.mapTitle
                          ? e.langFormat('accessibility.chartTypes.mapTypeDescription', l)
                          : e.langFormat('accessibility.chartTypes.unknownMap', l)
                        : e.types.length > 1
                          ? e.langFormat('accessibility.chartTypes.combinationChart', l)
                          : ((i = t[0]),
                            (r = e.langFormat(
                              'accessibility.seriesTypeDescriptions.' + i,
                              l
                            )),
                            (s = e.series && e.series.length < 2 ? 'Single' : 'Multiple'),
                            (e.langFormat('accessibility.chartTypes.' + i + s, l) ||
                              e.langFormat('accessibility.chartTypes.default' + s, l)) +
                              (r ? ' ' + r : ''))
                      : e.langFormat('accessibility.chartTypes.emptyChart', l);
                  })(e, e.types)
              : '';
          }
          ...
          getEndOfChartMarkerText() {
            let e = ey(`highcharts-end-of-chart-marker-${this.chart.index}`);
            ...
            return (
              '<div id="highcharts-end-of-chart-marker-' + t.index + '">' + i + '</div>'
            );
          }
          ...
          initSonifyButton(e) {
            let t = (this.sonifyButton = ey(e)),
              ...
              r = (e) => {
                ...
                (this.announcer.announce(r),
                  setTimeout(() => {
                    (t &&
                      (t.removeAttribute('aria-hidden'), t.removeAttribute('aria-label')),
                      i.sonify && i.sonify());
                  }, 1e3));
              };
            t &&
          ...
          initDataTableButton(e) {
            let t = (this.viewDataTableButton = ey(e)),
              i = this.chart,
              r = e.replace('hc-linkto-', '');
            t &&
              ((0, x.attr)(t, { tabindex: -1, 'aria-expanded': !!ey(r) }),
              (t.onclick =
            ...
            let e = this.chart,
              t = function (t, i) {
                ...
                return (
                  ...
                  (r[0] &&
                    (0, x.pick)(
                      r[0].options.accessibility && r[0].options.accessibility.enabled,
                      i
                    ))
                );
              },
              ...
              r = !!e.hasCartesianSeries,
              s = t('xAxis', !e.angular && r && i),
              n = t('yAxis', r && i),
              o = {};
            return (
              s && (o.xAxis = this.getAxisDescriptionText('xAxis')),
        ...
        { getChartTitle: ek, unhideChartElementFromAT: eM } = L,
        { getFakeMouseEvent: eC } = k;
      function eS(e) {
      ...
      class eP extends V {
        ...
        onMenuShown() {
          ...
          (t && (this.addAccessibleContextMenuAttribs(), eM(e, t)),
            this.setExportButtonExpandedState('true'));
        }
        setExportButtonExpandedState(e) {
          this.exportButtonProxy &&
            this.exportButtonProxy.innerElement.setAttribute('aria-expanded', e);
        }
        onChartRender() {
          let e = this.chart,
            t = e.focusElement,
        ...
        onKbdPrevious(e) {
          let t = this.chart,
            ...
            r = e.response,
            s = t.highlightedExportItemIx || 0;
          for (; s--; ) if (t.highlightExportItem(s)) return r.success;
          return i.keyboardNavigation.wrapAround
            ? (t.highlightLastExportItem(), r.success)
            : r.prev;
        }
        onKbdNext(e) {
          let t = this.chart,
          ...
          for (
            ...
            if (t.highlightExportItem(e)) return r.success;
          return i.keyboardNavigation.wrapAround
            ? (t.highlightExportItem(0), r.success)
            : r.next;
        }
        onKbdClick(e) {
          let t = this.chart,
          ...
          return (
            t.exporting?.openMenu
              ...
              : (r && this.fakeClickEvent(r), t.highlightExportItem(0)),
            e.response.success
          );
        }
      }
      !(function (e) {
        ...
        function r(e) {
          ...
          if (t && 'LI' === t.tagName && !(t.children && t.children.length)) {
            ...
            return (
              t.focus && r && t.focus(),
              i && i.onmouseout && i.onmouseout(eC('mouseout')),
              t.onmouseover && t.onmouseover(eC('mouseover')),
        ...
        e.compose = function (e) {
          ...
          n.hideExportMenu ||
            ((n.hideExportMenu = i),
            (n.highlightExportItem = r),
            (n.highlightLastExportItem = s),
            (n.showExportMenu = t));
        };
      })(eP || (eP = {}));
      let eD = eP,
        { doc: eN, win: eB } = y(),
        { getElement: eI, simulatedEventTarget: eF } = k;
      class eO {
        constructor(e, t) {
          ((this.currentModuleIx = NaN), (this.modules = []), this.init(e, t));
        }
        init(e, t) {
          let i = (this.eventProvider = new U());
          ((this.chart = e),
            (this.components = t),
            (this.modules = []),
            ...
            ['mouseup', 'touchend'].forEach((e) =>
              i.addEvent(eN, e, (e) => this.onMouseUp(e))
            ),
          ...
          (this.updateContainerTabindex(),
            i && i.enabled && e && e.length
              ? ((this.modules = e.reduce(function (e, t) {
                  let i = r[t].getKeyboardNavigation();
                  return e.concat(i);
                }, [])),
        ...
        updateExitAnchor() {
          let e = eI(`highcharts-end-of-chart-marker-${this.chart.index}`);
          (this.removeExitAnchor(),
            e
        ...
        onMouseUp(e) {
          if (
            (delete this.isClickingChart, !this.keyboardReset && e.relatedTarget !== eF)
          ) {
            let t = this.chart;
        ...
        onKeydown(e) {
          let t,
            i = e || eB.event,
            r = this.modules && this.modules.length && this.modules[this.currentModuleIx],
            s = i.target;
          if (
            (!s ||
              'INPUT' !== s.nodeName ||
              s.classList.contains('highcharts-a11y-proxy-element')) &&
            ((this.keyboardReset = !1), (this.exiting = !1), r)
          ) {
            let e = r.run(i);
            (e === r.response.success
              ? (t = !0)
              : e === r.response.prev
                ? (t = this.move(-1))
                : e === r.response.next && (t = this.move(1)),
        ...
        updateContainerTabindex() {
          let e,
            ...
            s = this.chart,
            n = s.container;
          (s.renderTo.hasAttribute('tabindex')
            ? (n.removeAttribute('tabindex'), (e = s.renderTo))
            : (e = n),
            (this.tabindexContainer = e));
          let o = e.getAttribute('tabindex');
          r && !o
            ? e.setAttribute('tabindex', '0')
            : r || s.container.removeAttribute('tabindex');
        }
        createExitAnchor() {
          let e = this.chart,
            t = (this.exitAnchor = eN.createElement('div'));
        ...
        removeExitAnchor() {
          if (this.exitAnchor) {
            ...
            (e && (0, x.defined)(e.remover) && this.eventProvider.removeEvent(e.remover),
        ...
        addExitAnchorEventsToEl(e) {
          ...
          this.eventProvider.addEvent(e, 'focus', function (e) {
            let r = e || eB.event,
              s = !(
                (r.relatedTarget && t.container.contains(r.relatedTarget)) ||
                i.exiting
              );
            if ((t.focusElement && delete t.focusElement, s)) {
              if (
      ...
      function eR() {
        let e = this;
        (0, x.fireEvent)(this, 'dismissPopupContent', {}, function () {
      ...
      (eO || (eO = {})).compose = function (e) {
        eD.compose(e);
        let t = e.prototype;
        return (
          !t.dismissPopupContent &&
            ((t.dismissPopupContent = eR), eN && (0, x.addEvent)(eN, 'keydown', eL)),
          e
        );
      };
      let eH = eO;
      ...
      let { doc: eU } = y(),
        { getChartTitle: eG } = L,
        { stripHTMLTagsFromString: eK, addClass: eV, removeClass: eW } = k;
      function eX(e) {
        ...
        return !!(t && t.length && !r && !1 !== i.enabled);
      }
      function eY(e, t) {
        let i = t.legendItem || {};
        for (let r of (t.setState(e ? 'hover' : '', !0), ['group', 'label', 'symbol'])) {
          let t = i[r],
            s = (t && t.element) || t;
          s && (0, x.fireEvent)(s, e ? 'mouseover' : 'mouseout');
        }
      }
      class ej extends V {
        constructor() {
        ...
        init() {
          ...
          (this.recreateProxies(),
            this.addEvent(eq(), 'afterScroll', function () {
              this.chart === e.chart &&
            ...
            this.addEvent(eq(), 'afterPositionItem', function (t) {
              this.chart === e.chart &&
                this.chart.renderer &&
                e.updateProxyPositionForItem(t.item);
            }),
            this.addEvent(eq(), 'afterRender', function () {
              this.chart === e.chart &&
                this.chart.renderer &&
                e.recreateProxies() &&
                (0, x.syncTimeout)(
                  () => e.proxyProvider.updateGroupProxyElementPositions('legend'),
                  (0, x.animObject)((0, x.pick)(this.chart.renderer.globalAnimation, !0))
                    .duration
                );
            }));
        }
        updateLegendItemProxyVisibility() {
          ...
          r.forEach((r) => {
            if (r.a11yProxyElement) {
              ...
              l
                ? t.styledMode
                  ? eV(a, 'highcharts-a11y-invisible')
                  : (a.style.visibility = 'hidden')
                : (eW(a, 'highcharts-a11y-invisible'), (a.style.visibility = ''));
            }
          });
        }
        onChartRender() {
          eX(this.chart) || this.removeProxies();
        }
        ...
        updateLegendTitle() {
          let e = this.chart,
            t = eK(
              (
                (e.legend && e.legend.options.title && e.legend.options.title.text) ||
                ''
              ).replace(/<br ?\/?>/g, ' '),
              e.renderer.forExport
            ),
        ...
        proxyLegendItem(e) {
          let t = e.legendItem || {},
            ...
            r = i?.element,
            s = t.label?.styles?.textOverflow === 'ellipsis';
          if (!t.label || !t.group) return;
          let n = this.chart.langFormat('accessibility.legend.legendItem', {
              chart: this.chart,
              itemName: eK(e.name, this.chart.renderer.forExport),
              item: e,
            }),
            o = { tabindex: -1, 'aria-pressed': e.visible, 'aria-label': n, title: '' };
          s && -1 !== (r.textContent || '').indexOf('…') && (o.title = i?.textStr);
          ...
          return new W(i, {
            ...
            terminate: function () {
              ((t.highlightedLegendItemIx = -1),
                i.legend.allItems.forEach((e) => eY(!1, e)));
            },
          });
        }
        onKbdArrowKey(e, t) {
          let {
              keyCodes: { left: i, up: r },
              highlightedLegendItemIx: s,
              chart: n,
            } = this,
      ...
      function eZ(e) {
        ...
        if (r) {
          var n;
          let o, a;
          ((0, x.isNumber)(i) && t[i] && eY(!1, t[i]),
            (n = this.legend),
            (o = (n.allItems[e].legendItem || {}).pageIx),
            (a = n.currentPage),
            void 0 !== o && o + 1 !== a && n.scroll(1 + o - a));
          let l = s.label,
            h = r.a11yProxyElement && r.a11yProxyElement.innerElement;
          return (l && l.element && h && this.setFocusToElement(l, h), eY(!0, r), !0);
        }
        return !1;
      }
      function e_(e) {
      ...
      (ej || (ej = {})).compose = function (e, t) {
        let i = e.prototype;
        i.highlightLegendItem ||
          ((i.highlightLegendItem = eZ), (0, x.addEvent)(t, 'afterColorizeItem', e_));
      };
      let e$ = ej;
      var eQ = b(532),
        eJ = b.n(eQ);
      let { isTouchDevice: e0 } = y(),
        e1 = [];
      function e2() {
      ...
      function e3() {
        let e,
          ...
          s = this.navigator;
        if (s) {
          ((e = r && r.options), (t = s.xAxis), (i = s.yAxis));
          let { scrollbarHeight: n, scrollButtonSize: o } = s;
          (this.inverted
            ? ((s.left = s.opposite
                ? this.chartWidth - n - s.height
                : this.spacing[3] + n),
              (s.top = this.plotTop + o))
            : ((s.left = (0, x.pick)(t.left, this.plotLeft + o)),
              (s.top =
                s.navigatorOptions.top ||
                this.chartHeight -
                  s.height -
                  n -
                  ...
                  e.enabled &&
                  !e.floating
                    ? r.legendHeight + (0, x.pick)(e.margin, 10)
                    : 0) -
                  (this.titleOffset ? this.titleOffset[2] : 0))),
            t &&
              i &&
              (this.inverted
                ? (t.options.left = i.options.left = s.left)
                : (t.options.top = i.options.top = s.top),
              t.setAxisSize(),
              i.setAxisSize()));
        }
      }
      function e5(e) {
        !this.navigator &&
          ...
          (0, x.pick)(e.redraw, !0) && this.redraw(e.animation));
      }
      function e4() {
        let e = this.options;
      ...
      function e6() {
        ...
        if (
          ...
          ((!e0 && 'x' === this.zooming.type) || (e0 && 'x' === this.zooming.pinchType))
        )
          return !1;
      }
      function e8(e) {
      ...
      function e9(e) {
        ...
        !this.navigator &&
          !this.scroller &&
          (t.enabled || i.enabled) &&
          ((0, x.merge)(!0, this.options.navigator, t),
          (0, x.merge)(!0, this.options.scrollbar, i),
          delete e.options.navigator,
          delete e.options.scrollbar);
      }
      let e7 = function (e, t) {
          if ((0, x.pushUnique)(e1, e)) {
            let i = e.prototype;
            ((h = t),
              i.callbacks.push(e8),
              (0, x.addEvent)(e, 'afterAddSeries', e2),
              (0, x.addEvent)(e, 'afterSetChartSize', e3),
              (0, x.addEvent)(e, 'afterUpdate', e5),
              (0, x.addEvent)(e, 'beforeRender', e4),
              (0, x.addEvent)(e, 'beforeShowResetZoom', e6),
              (0, x.addEvent)(e, 'update', e9));
          }
        },
        { isTouchDevice: te } = y();
      function tt() {
        this.navigatorAxis || (this.navigatorAxis = new tr(this));
      }
      function ti(e) {
        let t,
          i = this.chart,
          ...
          a = r.rangeSelector,
          l = i.zooming.type;
        if (this.isXAxis && (s?.enabled || a?.enabled)) {
          if ('y' === l && 'zoom' === e.trigger) t = !1;
            ...
            (0, x.defined)(e.min)
              ...
              : t && ((e.min = t[0]), (e.max = t[1]), (n.previousZoom = void 0));
          }
        }
      ...
      class tr {
        static compose(e) {
          e.keepProps.includes('navigatorAxis') ||
            ...
            (0, x.addEvent)(e, 'init', tt),
            (0, x.addEvent)(e, 'setExtremes', ti));
        }
        constructor(e) {
          this.axis = e;
        }
        ...
        toFixedRange(e, t, i, r) {
          let s = this.axis,
            n = (s.pointRange || 0) / 2,
            o = (0, x.pick)(i, s.translate(e, !0, !s.horiz)),
            a = (0, x.pick)(r, s.translate(t, !0, !s.horiz));
          return (
            (0, x.defined)(i) || (o = (0, x.correctFloat)(o + n)),
            (0, x.defined)(r) || (a = (0, x.correctFloat)(a - n)),
            ((0, x.isNumber)(o) && (0, x.isNumber)(a)) || (o = a = void 0),
            { min: o, max: a }
          );
        }
      }
      ...
      let { seriesTypes: to } = tn(),
        ta = {
          ...
          maskFill:
            'color-mix(in srgb, var(--highcharts-highlight-color-60) 30%, transparent)',
          outlineColor: 'var(--highcharts-neutral-color-40)',
          outlineWidth: 1,
          series: {
            type: void 0 === to.areaspline ? 'line' : 'areaspline',
            fillOpacity: 0.05,
            lineWidth: 1,
            compare: null,
        ...
        { defaultOptions: tl } = y(),
        { noop: th } = y(),
        td = { radius: 0, scope: 'stack', where: void 0 },
        tc = {
          'navigator-handle': function (e, t, i, r, s = {}) {
            var n, o, a, l, h, d;
            let c = s.width ? s.width / 2 : i,
              u = (0, x.relativeLength)(
                ((n = s.borderRadius),
                !(0, x.isObject)(n) && (n = { radius: n || 0 }),
                (0, x.merge)(td, void 0, n)).radius,
                Math.min(2 * c, r)
              );
            return [
              ['M', -1.5, (r = s.height || r) / 2 - 3.5],
              ['L', -1.5, r / 2 + 4.5],
              ['M', 0.5, r / 2 - 3.5],
              ['L', 0.5, r / 2 + 4.5],
              ...((o = -c - 1),
      ...
      var tu = b(540),
        tp = b.n(tu);
      let { defaultOptions: tg } = y(),
        { composed: tm } = y(),
        { setFixedRange: tb } = {
          setFixedRange: function (e) {
            let t = this.xAxis[0];
            (0, x.defined)(t.dataMax) && (0, x.defined)(t.dataMin) && e
      ...
      let tx = function (e, t, i) {
          (tr.compose(t),
            (0, x.pushUnique)(tm, 'Navigator') &&
              ((e.prototype.setFixedRange = tb),
              (0, x.extend)(tp().prototype.symbols, tc),
              (0, x.extend)(tg, { navigator: ta }),
              (0, x.addEvent)(i, 'afterUpdate', tf)));
        },
        { composed: ty } = y();
      !(function (e) {
        let t;
        function i(e) {
          let t = (0, x.pick)(e.options?.min, e.min),
            i = (0, x.pick)(e.options?.max, e.max);
          return {
            axisMin: t,
            axisMax: i,
            scrollMin: (0, x.defined)(e.dataMin)
              ? Math.min(t, e.min ?? 1 / 0, e.dataMin, e.threshold ?? 1 / 0)
              : t,
            scrollMax:
              e.treeGrid?.adjustedMax ??
              ((0, x.defined)(e.dataMax)
                ? Math.max(i, e.max ?? -1 / 0, e.dataMax, e.threshold ?? -1 / 0)
                : i),
          };
        }
        function r() {
        ...
        function s() {
          ...
          e.options?.scrollbar?.enabled &&
            ...
            (0, x.addEvent)(e.scrollbar, 'changed', function (t) {
              let r,
                s,
                { axisMin: n, axisMax: o, scrollMin: a, scrollMax: l } = i(e),
                h = e.toPixels(a),
                d = e.toPixels(l) - h;
              if ((0, x.defined)(n) && (0, x.defined)(o))
                if (
                  ((e.horiz && !e.reversed) || (!e.horiz && e.reversed)
                    ? ((r = Math.min(l, e.toValue(h + d * this.to))),
                      (s = Math.max(a, e.toValue(h + d * this.from))))
                    : ((r = Math.min(l, e.toValue(h + d * (1 - this.from)))),
                      (s = Math.max(a, e.toValue(h + d * (1 - this.to))))),
                  this.shouldUpdateExtremes(t.DOMType))
                ) {
                  let i =
                    'mousemove' !== t.DOMType && 'touchmove' !== t.DOMType && void 0;
                  e.setExtremes((0, x.correctFloat)(s), (0, x.correctFloat)(r), !0, i, t);
        ...
        function n() {
          let e,
            t,
            r,
            { scrollMin: s, scrollMax: n } = i(this),
            o = this.scrollbar,
          ...
          if (o && l) {
            ...
            if (
              ...
              isNaN(s) ||
                isNaN(n) ||
                !(0, x.defined)(this.min) ||
                !(0, x.defined)(this.max) ||
                ((0, x.defined)(this.dataMin) && this.dataMin === this.dataMax))
            )
              o.setRange(0, 1);
              ...
              ((t =
                (this.toPixels(this.min) - this.toPixels(s)) /
                (this.toPixels(n) - this.toPixels(s))),
                (r =
                  (this.toPixels(this.max) - this.toPixels(s)) /
                  (this.toPixels(n) - this.toPixels(s))),
        ...
        e.compose = function (e, i) {
          (0, x.pushUnique)(ty, 'Axis.Scrollbar') &&
            ((t = i),
            (0, x.addEvent)(e, 'afterGetOffset', r),
            (0, x.addEvent)(e, 'afterInit', s),
            (0, x.addEvent)(e, 'afterRender', n));
        };
      })(u || (u = {}));
      let tv = u,
        tE = {
      ...
      class tT {
        static compose(e) {
          (tv.compose(e, tT),
            (0, x.pushUnique)(tA, 'Scrollbar') && (0, x.extend)(tw, { scrollbar: tE }));
        }
        static swapXY(e, t) {
          return (
            t &&
        ...
        addEvents() {
          let e = this.options.inverted ? [1, 0] : [0, 1],
            ...
            a = [
              ...
              [r, 'click', this.trackClick.bind(this)],
              [i, 'mousedown', s],
          ...
          (a.forEach(function (e) {
            x.addEvent.apply(null, e);
          }),
            (this._events = a));
        }
        buttonToMaxClick(e) {
          let t = (this.to - this.from) * (0, x.pick)(this.options.step, 0.2);
          (this.updatePosition(this.from + t, this.to + t),
            (0, x.fireEvent)(this, 'changed', {
              from: this.from,
              to: this.to,
              trigger: 'scrollbar',
              DOMEvent: e,
        ...
        buttonToMinClick(e) {
          let t =
            (0, x.correctFloat)(this.to - this.from) *
            (0, x.pick)(this.options.step, 0.2);
          (this.updatePosition(
            (0, x.correctFloat)(this.from - t),
            (0, x.correctFloat)(this.to - t)
          ),
            (0, x.fireEvent)(this, 'changed', {
              from: this.from,
              to: this.to,
        ...
        destroy() {
          ...
          (e.removeEvents(),
            ...
            t &&
              e === t.scrollbar &&
              ((t.scrollbar = null), (0, x.destroyObjectProperties)(t.scrollbarButtons)));
        }
        drawScrollbarButton(e) {
          ...
          if ((i.push(n), r.buttonsEnabled)) {
            ...
            (this.chart.styledMode ||
              ...
              o.attr(
                o.crisp(
                  { x: -0.5, y: -0.5, width: s, height: s, r: r.buttonBorderRadius },
                  o.strokeWidth()
                )
              ));
            let a = t
              ...
              .add(i[e]);
            this.chart.styledMode || a.attr({ fill: r.buttonArrowColor });
          }
        }
        init(e, t, i) {
          ((this.scrollbarButtons = []),
            (this.renderer = e),
            (this.userOptions = t),
            (this.options = (0, x.merge)(tE, tw.scrollbar, t)),
            (this.options.margin = (0, x.pick)(this.options.margin, 10)),
            (this.chart = i),
            (this.size = (0, x.pick)(this.options.size, this.options.height)),
        ...
        mouseMoveHandler(e) {
          ...
          this.grabbedCenter &&
            (!e.touches || 0 !== e.touches[0][r]) &&
            ((t = this.cursorToScrollbarPosition(i)[r] - this[r]),
            (this.hasDragged = !0),
            this.updatePosition(s[0] + t, s[1] + t),
            this.hasDragged &&
              (0, x.fireEvent)(this, 'changed', {
                from: this.from,
                to: this.to,
        ...
        position(e, t, i, r) {
          let { buttonsEnabled: s, margin: n = 0, vertical: o } = this.options,
          ...
          (this.group.show(),
            ...
            o
              ? ((this.width = this.yOffset = i = h = this.size),
                (this.xOffset = l = 0),
                (this.yOffset = h = s ? this.size : 0),
                (this.barWidth = r - (s ? 2 * i : 0)),
                (this.x = e += n))
              : ((this.height = r = this.size),
                (this.xOffset = l = s ? this.size : 0),
                (this.barWidth = i - (s ? 2 * r : 0)),
                (this.y = this.y + n)),
            this.group[a]({ translateX: e, translateY: this.y }),
            this.track[a]({ width: i, height: r }),
        ...
        render() {
          let e = this.renderer,
            ...
            s = e.g('scrollbar').attr({ zIndex: t.zIndex }).hide().add();
          ((this.group = s),
            (this.track = e
              .rect()
          ...
          (this.track.attr({ x: -(0, x.crisp)(0, n), y: -(0, x.crisp)(0, n) }),
            (this.scrollbarGroup = e.g().add(s)),
            (this.scrollbar = e
              .rect()
            ...
            this.scrollbarGroup.translate(
              -(0, x.crisp)(0, this.scrollbarStrokeWidth),
              -(0, x.crisp)(0, this.scrollbarStrokeWidth)
            ),
        ...
        setRange(e, t) {
          let i,
            ...
            l =
              ...
              (this.chart.navigator && this.chart.navigator.hasDragged)
                ? 'attr'
                : 'animate';
          if (!(0, x.defined)(a)) return;
          let h = a * Math.min(t, 1);
          ((i = Math.ceil(a * (e = Math.max(e, 0)))),
            (this.calculatedWidth = r = (0, x.correctFloat)(h - i)),
            r < o && ((i = (a - o + r) * e), (r = o)));
          ...
          ((this.from = e),
            (this.to = t),
            n
              ? (this.scrollbarGroup[l]({ translateY: d }),
                this.scrollbar[l]({ height: r }),
                this.scrollbarRifles[l]({ translateY: c }),
                (this.scrollbarTop = d),
                (this.scrollbarLeft = 0))
              : (this.scrollbarGroup[l]({ translateX: d }),
                this.scrollbar[l]({ width: r }),
                this.scrollbarRifles[l]({ translateX: c }),
                (this.scrollbarLeft = d),
                (this.scrollbarTop = 0)),
            r <= 12 ? this.scrollbarRifles.hide() : this.scrollbarRifles.show(),
            !1 === s.showFull &&
        ...
        shouldUpdateExtremes(e) {
          return (
            (0, x.pick)(
              ...
              y().svg && !y().isTouchDevice && !this.chart.boosted
            ) ||
            'mouseup' === e ||
            'touchend' === e ||
            !(0, x.defined)(e)
        ...
        trackClick(e) {
          let t = this.chart.pointer?.normalize(e) || e,
            i = this.to - this.from,
            r = this.y + this.scrollbarTop,
            s = this.x + this.scrollbarLeft;
          ((this.options.vertical && t.chartY > r) ||
          (!this.options.vertical && t.chartX > s)
        ...
        update(e) {
          (this.destroy(),
            this.init(
              this.chart.renderer,
              (0, x.merge)(!0, this.options, e),
              this.chart
            ));
        }
        updatePosition(e, t) {
          (t > 1 && ((e = (0, x.correctFloat)(1 - (0, x.correctFloat)(t - e))), (t = 1)),
            e < 0 && ((t = (0, x.correctFloat)(t - e)), (e = 0)),
            (this.from = e),
            (this.to = t));
        }
      }
      tT.defaultOptions = tE;
      let { defaultOptions: tk } = y(),
        { isTouchDevice: tM } = y();
      function tC(e, ...t) {
        let i = [].filter.call(t, x.isNumber);
      ...
      class tS {
          ...
          this.handles[t][r](
            i
              ? {
                  ...
                  translateY: Math.round(this.top + parseInt(e, 10) + 0.5 - s),
                }
              : {
        ...
        drawOutline(e, t, i, r) {
          let s = this.navigatorOptions.maskInside,
        ...
        drawMasks(e, t, i, r) {
          ...
          (i
            ...
            this.shades.forEach((e, t) => {
              e[r]({ x: o[t], y: a[t], width: n[t], height: s[t] });
            }));
        }
        renderElements() {
          let e = this,
            ...
            s = r.inverted,
            n = r.renderer,
            o = { cursor: s ? 'ns-resize' : 'ew-resize' },
            a =
              e.navigatorGroup ??
              (e.navigatorGroup = n
                .g('navigator')
          ...
          if (
            ([!i, i, !i].forEach((i, s) => {
              let l =
                ...
                (e.shades[s] = n
                  .rect()
                  .addClass(
                    'highcharts-navigator-mask' + (1 === s ? '-inside' : '-outside')
                  )
                  .add(a));
              r.styledMode ||
                (l.attr({ fill: i ? t.maskFill : 'rgba(0,0,0,0)' }), 1 === s && l.css(o));
            }),
            e.outline ||
              (e.outline = n.path().addClass('highcharts-navigator-outline').add(a)),
            r.styledMode ||
              e.outline.attr({ 'stroke-width': t.outlineWidth, stroke: t.outlineColor }),
            t.handles?.enabled)
          ) {
            let i = !1,
              s = t.handles,
            ...
            ([0, 1].forEach((t) => {
              let d = s.symbols[t];
              ((i = i || e.handles[t]?.symbolName !== d) &&
                (e.handles[t]?.destroy(),
                (e.handles[t] = n.symbol(d, -h / 2 - 1, 0, h, l, s)),
                e.handles[t]
                  .attr({ zIndex: 7 - t })
                  .addClass(
              ...
              i &&
                (e.partsEventsToUnbind?.forEach((e) => {
                  e();
                }),
                (e.partsEventsToUnbind = [
                  ...e.getPartsEvents('mousedown'),
                  ...e.getPartsEvents('touchstart'),
                ])));
          }
        }
        update(e, t = !1) {
          let i = this.chart,
            r = i.options.chart.inverted !== i.scrollbar?.options.vertical;
          if (
            ((0, x.merge)(!0, i.options.navigator, e),
            (this.navigatorOptions = i.options.navigator || {}),
            this.setOpposite(),
            (0, x.defined)(e.enabled) || r)
          )
            return (
              this.destroy(),
          ...
          if (
            ...
            !1 === e.adaptToUpdatedData &&
              this.baseSeries.forEach((e) => {
                (0, x.removeEvent)(e, 'updatedData', this.updatedDataHandler);
              }, this),
            e.adaptToUpdatedData &&
              this.baseSeries.forEach((e) => {
                e.eventsToUnbind.push(
                  (0, x.addEvent)(e, 'updatedData', this.updatedDataHandler)
                );
              }, this),
        ...
        render(e, t, i, r) {
          let s = this.chart,
            n = this.xAxis,
            o = n.pointRange || 0,
            a = n.navigatorAxis.fake ? s.xAxis[0] : n,
            l = this.navigatorEnabled,
            h = this.rendered,
            d = s.inverted,
            c = s.xAxis[0].minRange,
            u = s.xAxis[0].options.maxRange,
            ...
            y,
            v;
          if (this.hasDragged && !(0, x.defined)(i)) return;
          if (
            (this.isDirty && this.renderElements(),
            (e = (0, x.correctFloat)(e - o / 2)),
            (t = (0, x.correctFloat)(t + o / 2)),
            !(0, x.isNumber)(e) || !(0, x.isNumber)(t))
          )
            if (!h) return;
            else ((i = 0), (r = (0, x.pick)(n.width, a.width)));
          this.left = (0, x.pick)(n.left, s.plotLeft + p + (d ? s.plotWidth : 0));
          let E =
            (this.size =
            y =
              (0, x.pick)(n.len, (d ? s.plotHeight : s.plotWidth) - 2 * p));
          ((g = d ? f : y + 2 * p),
            (i = (0, x.pick)(i, n.toPixels(e, !0))),
            (r = (0, x.pick)(r, n.toPixels(t, !0))),
            ((0, x.isNumber)(i) && Math.abs(i) !== 1 / 0) || ((i = 0), (r = g)));
          let w = n.toValue(i, !0),
            A = n.toValue(r, !0),
            T = Math.abs((0, x.correctFloat)(A - w));
          ((0, x.defined)(c) && T < c
            ? this.grabbedLeft
              ? (i = n.toPixels(A - c - o, !0))
              : this.grabbedRight && (r = n.toPixels(w + c + o, !0))
            : (0, x.defined)(u) &&
              (0, x.correctFloat)(T - o) > u &&
              (this.grabbedLeft
                ? (i = n.toPixels(A - u - o, !0))
                : this.grabbedRight && (r = n.toPixels(w + u + o, !0))),
            (this.zoomedMax = (0, x.clamp)(Math.max(i, r), 0, E)),
            (this.zoomedMin = (0, x.clamp)(
              this.fixedWidth ? this.zoomedMax - this.fixedWidth : Math.min(i, r),
              0,
              E
            )),
          ...
          (l &&
            ...
            (v = h && !this.hasDragged ? 'animate' : 'attr'),
            this.drawMasks(k, E, d, v),
            this.drawOutline(k, E, d, v),
            this.navigatorOptions.handles?.enabled &&
              (this.drawHandle(k, 0, d, v), this.drawHandle(E, 1, d, v))),
            this.scrollbar &&
              (d
                ? ((b = this.top - p),
                  (m =
            ...
            (this.rendered = !0),
            (this.isDirty = !1),
            (0, x.fireEvent)(this, 'afterRender'));
        }
        addMouseEvents() {
          let e,
            t,
          ...
          ((i.mouseMoveHandler = e =
            ...
            n.push(
              (0, x.addEvent)(r.renderTo, 'mousemove', e),
              (0, x.addEvent)(s.ownerDocument, 'mouseup', t),
              (0, x.addEvent)(r.renderTo, 'touchmove', e),
              (0, x.addEvent)(s.ownerDocument, 'touchend', t)
            ),
            (i.eventsToUnbind = n),
            i.series &&
              i.series[0] &&
              n.push(
                (0, x.addEvent)(i.series[0].xAxis, 'foundExtremes', function () {
        ...
        getPartsEvents(e) {
          let t = this,
            i = [];
          return (
            ['shades', 'handles'].forEach((r) => {
              t[r].forEach(function (s, n) {
                i.push(
                  (0, x.addEvent)(s.element, e, function (e) {
                    t[`${r}Mousedown`](e, n);
                  })
                );
              });
                ...
                0 === t
                  ...
                  : 2 === t &&
                    ...
                    this.reversedExtremes
                      ? ((u -= o), (d = this.getUnionExtremes()?.dataMin))
                      : (h = this.getUnionExtremes()?.dataMax)),
                u !== s &&
                  ((this.fixedWidth = o),
                  (c = r.navigatorAxis.toFixedRange(u, u + o, d, h)),
                  (0, x.defined)(c.min) &&
                    (0, x.fireEvent)(this, 'setRange', {
        ...
        handlesMousedown(e, t) {
          ...
          (0 === t
            ? ((this.grabbedLeft = !0),
              ...
              (this.fixedExtreme = s ? r.min : r.max))
            : ((this.grabbedRight = !0),
              (this.otherHandlePos = this.zoomedMin),
              (this.fixedExtreme = s ? r.max : r.min)),
            ...
            t.grabbedLeft
              ...
              : t.grabbedRight
                ...
                : t.grabbedCenter &&
                  n &&
                  ((t.hasDragged = !0),
                  l < n ? (l = n) : l > r + n - s && (l = r + n - s),
                  t.render(0, 0, l - n, l - n + s)),
            t.hasDragged &&
              (0, x.pick)(t.scrollbarOptions?.liveRedraw, !tM && !this.chart.boosted) &&
              ((e.DOMType = e.type),
              setTimeout(function () {
                t.onMouseUp(e);
              }, 0)));
        ...
        onMouseUp(e) {
          ...
          (((this.hasDragged && (!h || !h.hasDragged)) || 'scrollbar' === e.trigger) &&
            ...
            this.zoomedMin === this.otherHandlePos
              ? (s = this.fixedExtreme)
              : this.zoomedMax === this.otherHandlePos && (n = this.fixedExtreme),
            this.zoomedMax === this.size &&
              (n = this.reversedExtremes ? r.dataMin : r.dataMax),
            0 === this.zoomedMin && (s = this.reversedExtremes ? r.dataMax : r.dataMin),
            (o = l.navigatorAxis.toFixedRange(this.zoomedMin, this.zoomedMax, s, n)),
            (0, x.defined)(o.min) &&
              (0, x.fireEvent)(this, 'setRange', {
            ...
            'mousemove' !== e.DOMType &&
              ...
              (this.grabbedLeft =
                ...
                this.dragOffset =
                  null),
            this.navigatorEnabled &&
              (0, x.isNumber)(this.zoomedMin) &&
              (0, x.isNumber)(this.zoomedMax) &&
              ((i = Math.round(this.zoomedMin)),
              (t = Math.round(this.zoomedMax)),
              this.shades && this.drawMasks(i, t, c, u),
              this.outline && this.drawOutline(i, t, c, u),
              this.navigatorOptions.handles?.enabled &&
                Object.keys(this.handles).length === this.handles.length &&
                (this.drawHandle(i, 0, c, u), this.drawHandle(t, 1, c, u))));
        }
        removeEvents() {
        ...
        init(e) {
          ...
          ((this.handles = []),
            ...
            (this.scrollbarOptions = s),
            this.setOpposite());
          let h = this,
            d = h.baseSeries,
            c = e.xAxis.length,
            u = e.yAxis.length,
            p = (d && d[0] && d[0].xAxis) || e.xAxis[0] || { options: {} };
          if (((e.isDirtyBox = !0), h.navigatorEnabled)) {
            ...
            ((h.xAxis = new (eJ())(
              ...
              d || i.series?.data || i.series?.dataTable
                ...
                : 0 === e.series.length &&
                  (h.unbindRedraw = (0, x.addEvent)(e, 'beforeRedraw', function () {
                    e.series.length > 0 &&
                      !h.series &&
            ...
            ((h.xAxis = {
              ...
              translate: function (t, i) {
                let r = e.xAxis[0],
                  s = r.getExtremes(),
                  n = r.len - 2 * l,
                  o = tC('min', r.options.min, s.dataMin),
                  a = tC('max', r.options.max, s.dataMax) - o;
              ...
              (h.xAxis.navigatorAxis.toFixedRange = tr.prototype.toFixedRange.bind(
                h.xAxis.navigatorAxis
              )));
          if (e.options.scrollbar?.enabled) {
            let t = (0, x.merge)(e.options.scrollbar, { vertical: e.inverted });
            ((0, x.isNumber)(t.margin) || (t.margin = e.inverted ? -3 : 3),
              (e.scrollbar = h.scrollbar = new tT(e.renderer, t, e)),
              (0, x.addEvent)(h.scrollbar, 'changed', function (e) {
                let t = h.size,
                  i = t * this.to,
                  r = t * this.from;
        ...
        setOpposite() {
          let e = this.navigatorOptions,
            ...
            i = this.chart;
          this.opposite = (0, x.pick)(e.opposite, !!(!t && i.inverted));
        }
        getUnionExtremes(e) {
          let t,
          ...
          return (
            (e && null === i.dataMin) ||
              (t = {
                dataMin: (0, x.pick)(
                  r.parse(n?.min),
                  tC('min', r.parse(o.min), i.dataMin, s.dataMin, s.min)
                ),
                dataMax: (0, x.pick)(
                  r.parse(n?.max),
                  tC('max', r.parse(o.max), i.dataMax, s.dataMax, s.max)
                ),
              }),
            t
          );
        ...
        setBaseSeries(e, t) {
          ...
          ((e =
            ...
            (i.series.length
              ? (0, x.find)(i.series, (e) => !e.options.isInternal).index
              : 0)),
        ...
        updateNavigatorSeries(e, t) {
          let i = this,
            ...
            o = (i.series = (i.series || []).filter((e) => {
              ...
              return (
                !(t && 0 > s.indexOf(t)) ||
                (t &&
                  ((0, x.removeEvent)(t, 'updatedData', i.updatedDataHandler),
          ...
          if (
            (s &&
              s.length &&
              s.forEach((e) => {
                let c = e.navigatorSeries,
                  u = (0, x.extend)(
                    { color: e.color, visible: e.visible },
                    (0, x.isArray)(h) ? tk.navigator.series : h
                  );
                if (c && !1 === i.navigatorOptions.adaptToUpdatedData) return;
                ((n.name = 'Navigator ' + s.length),
                  (d = (a = e.options || {}).navigatorOptions || {}),
                  (u.dataLabels = (0, x.splat)(u.dataLabels)),
                  ((l = (0, x.merge)(a, n, u, d)).pointRange = (0, x.pick)(
                    u.pointRange,
                    d.pointRange,
                    tk.plotOptions[l.type || 'line']?.pointRange
                  )));
                let p = d.data || u.data,
                  g = d.dataTable || u.dataTable;
                ((i.hasNavigatorData = i.hasNavigatorData || !!p || !!g),
                  (l.data = p || a.data?.slice(0)),
                  (l.dataTable = g || a.dataTable),
                  c && c.options
                    ? c.update(l, t)
                    : ((e.navigatorSeries = r.initSeries(l)),
                      (0, x.fireEvent)(e.navigatorSeries, 'afterUpdate'),
                      (e.navigatorSeries.baseSeries = e),
                      o.push(e.navigatorSeries)));
              }),
            ((h?.data || h?.dataTable) && !(s && s.length)) || (0, x.isArray)(h))
          ) {
            let e = r.options.colors || [];
            ((i.hasNavigatorData = !1),
              (h = (0, x.splat)(h)).forEach((t, s) => {
                ((n.name = 'Navigator ' + (o.length + 1)),
                  ...
                  (l.dataTable = t.dataTable),
                  (l.data || l.dataTable) &&
                    ((i.hasNavigatorData = !0), o.push(r.initSeries(l))));
              }));
          }
        ...
        addBaseSeriesEvents() {
          ...
          (t[0] &&
            ...
            t[0].eventsToUnbind.push(
              (0, x.addEvent)(t[0].xAxis, 'foundExtremes', this.modifyBaseAxisExtremes)
            ),
            t.forEach((i) => {
              (i.eventsToUnbind.push(
                (0, x.addEvent)(i, 'show', function () {
                  this.navigatorSeries && this.navigatorSeries.setVisible(!0, !1);
                })
              ),
                i.eventsToUnbind.push(
                  (0, x.addEvent)(i, 'hide', function () {
                ...
                !1 !== this.navigatorOptions.adaptToUpdatedData &&
                  i.xAxis &&
                  i.eventsToUnbind.push(
                    (0, x.addEvent)(i, 'updatedData', this.updatedDataHandler)
                  ),
                i.eventsToUnbind.push(
                  (0, x.addEvent)(i, 'remove', function () {
                    (t && (0, x.erase)(t, i),
                      this.navigatorSeries &&
                        e.series &&
                        ((0, x.erase)(e.series, this.navigatorSeries),
                        (0, x.defined)(this.navigatorSeries.options) &&
        ...
        modifyBaseAxisExtremes() {
          let e,
            ...
            h = i?.stickToMin,
            d = i?.stickToMax,
            c = (0, x.pick)(this.ordinal?.convertOverscroll(this.options.overscroll), 0),
        ...
        updatedDataHandler() {
          ...
          ((e.stickToMax = (0, x.pick)(
            ...
            t &&
              ...
              t.setData(this.options.data || this.options.dataTable, !1, void 0, !1)));
        }
        ...
        addChartEvents() {
          (this.eventsToUnbind || (this.eventsToUnbind = []),
            this.eventsToUnbind.push(
              (0, x.addEvent)(this.chart, 'redraw', function () {
                let e = this.navigator,
                  t =
                    e &&
                    ((e.baseSeries && e.baseSeries[0] && e.baseSeries[0].xAxis) ||
                      this.xAxis[0]);
                t && e.render(t.min, t.max);
              }),
              (0, x.addEvent)(this.chart, 'getMargins', function () {
                let e = this.navigator,
              ...
              (0, x.addEvent)(this, 'setRange', function (e) {
        ...
        destroy() {
          (this.removeEvents(),
            this.xAxis &&
              ((0, x.erase)(this.chart.xAxis, this.xAxis),
              (0, x.erase)(this.chart.axes, this.xAxis)),
            this.yAxis &&
              ((0, x.erase)(this.chart.yAxis, this.yAxis),
              (0, x.erase)(this.chart.axes, this.yAxis)),
      ...
      let { format: tP } = C(),
        { getFakeMouseEvent: tD } = k,
        { getAxisRangeDescription: tN, fireEventOnWrappedOrUnwrappedElement: tB } = L,
        tI = class extends V {
          init() {
            let e = this.chart,
              t = this;
            ((this.announcer = new er(e, 'polite')),
              this.addEvent(tS, 'afterRender', function () {
                this.chart === t.chart &&
                  this.chart.renderer &&
                  (0, x.syncTimeout)(
                    () => {
                    ...
                    (0, x.animObject)(
                      (0, x.pick)(this.chart.renderer.globalAnimation, !0)
                    ).duration
                  );
              }));
          }
          onChartUpdate() {
            ...
            if (i.enabled && i.accessibility?.enabled) {
              let i = t.accessibility.landmarkVerbosity,
                r = t.lang.accessibility?.navigator.groupLabel;
              (this.proxyProvider.removeGroup('navigator'),
                this.proxyProvider.addGroup('navigator', 'div', {
                  role: 'all' === i ? 'region' : 'group',
                  'aria-label': tP(r, { chart: e }, e),
                }));
              let s = t.lang.accessibility?.navigator.handleLabel;
              ([0, 1].forEach((t) => {
                let i = this.getHandleByIx(t);
                if (i) {
                  let r = this.proxyProvider.addProxyElement(
                    'navigator',
                    { click: i },
                    'input',
                    { type: 'range', 'aria-label': tP(s, { handleIx: t, chart: e }, e) }
                  );
                  ((this[t ? 'maxHandleProxy' : 'minHandleProxy'] = r.innerElement),
                    (r.innerElement.style.pointerEvents = 'none'),
                    (r.innerElement.oninput = () => this.updateNavigator()));
                }
              }),
          ...
          getNavigatorHandleNavigation(e) {
            let t = this,
              i = this.chart,
              r = e ? this.maxHandleProxy : this.minHandleProxy,
              s = this.keyCodes;
            return new W(i, {
              keyCodeMap: [
                [
                  ...
                  function (n) {
                    if (r) {
                      let o = n === s.left || n === s.up ? -1 : 1;
                      ((r.value = '' + (0, x.clamp)(parseFloat(r.value) + o, 0, 100)),
                        t.updateNavigator(() => {
                          let s = t.getHandleByIx(e);
                          s && i.setFocusToElement(s, r);
                        }));
                    }
              ...
              init: () => {
                i.setFocusToElement(this.getHandleByIx(e), r);
              },
              validate: () =>
                !!(
          ...
          destroy() {
            (this.updateNavigatorThrottleTimer &&
              (0, x.internalClearTimeout)(this.updateNavigatorThrottleTimer),
              this.proxyProvider.removeGroup('navigator'),
              this.announcer && this.announcer.destroy());
          }
          updateHandleValues() {
          ...
          updateNavigator(e) {
            let t = (e) => {
              let t = this.chart,
                { navigator: i, pointer: r } = t,
                s = this.chart.accessibility?.keyboardNavigation;
              if (i && r && this.minHandleProxy && this.maxHandleProxy) {
                let n = r.getChartPosition(),
                ...
                ([
                  ...
                  let s = this.getHandleByIx(e)?.element;
                  s && tB(s, tD(t, { x: n.left + i.left + r, y: n.top + i.top }, s));
                }),
                  s && (s.keyboardReset = !1),
                  e && e());
                let l = t.options.lang.accessibility?.navigator.changeAnnouncement,
                  h = tN(t.xAxis[0]);
                this.announcer.announce(tP(l, { axisRangeDescription: h, chart: t }, t));
              }
            };
            (this.updateNavigatorThrottleTimer &&
              (0, x.internalClearTimeout)(this.updateNavigatorThrottleTimer),
        ...
        { getPointAnnotationTexts: tF } = ed,
        {
          getAxisDescription: tO,
          getSeriesFirstPointElement: tR,
          getSeriesA11yElement: tL,
          unhideChartElementFromAT: tH,
        } = L,
        { format: tz, numberFormat: tq } = C(),
        { reverseChildNodes: tU, stripHTMLTagsFromString: tG } = k;
      function tK(e) {
      ...
      function tV(e, t) {
        let i = e.series,
          ...
          o = i.tooltipOptions || {},
          a = r.options.lang;
        return (0, x.isNumber)(t)
          ? tq(
              t,
              n.valueDecimals || s.valueDecimals || o.valueDecimals || -1,
              a.decimalPoint,
      ...
      function tX(e) {
        let t,
          ...
          u,
          p = e.series,
          g = p.chart.series.length > 1 || p.options.name,
          m =
            ((o = (n = e.series).chart),
            (l =
              ((a = n.options.accessibility) &&
                a.point &&
                a.point.valueDescriptionFormat) ||
              o.options.accessibility.point.valueDescriptionFormat),
            (d = (h = (0, x.pick)(
              n.xAxis &&
                n.xAxis.options.accessibility &&
                n.xAxis.options.accessibility.enabled,
              !o.angular && 'flowmap' !== n.type
            ))
              ? ((t = (function (e) {
                  let t = e.series,
                    i = t.chart,
                    r = (t.options.accessibility && t.options.accessibility.point) || {},
                ...
                (i =
                  ...
                  (0, x.defined)(e.category) &&
                  ('' + e.category).replace('<br/>', ' ')),
                (r = (0, x.defined)(e.id) && 0 > ('' + e.id).indexOf('highcharts-')),
                (s = 'x, ' + e.x),
                e.name || t || i || (r ? e.id : s))
              : ''),
            tz(
              ...
              {
                point: e,
                index: (0, x.defined)(e.index) ? e.index + 1 : '',
                xDescription: d,
                value: (function (e) {
                  let t = e.series,
                    ...
                    r =
                      ...
                      {},
                    s = t.tooltipOptions || {},
                    n = r.valuePrefix || i.valuePrefix || s.valuePrefix || '',
                    o = r.valueSuffix || i.valueSuffix || s.valueSuffix || '',
                  ...
                  if (t.pointArrayMap) {
                    ...
                    return (
                      ...
                      (i = o || ''),
                      (r = function (r) {
                        let s = tV(e, (0, x.pick)(e[r], e.options[r]));
                        return void 0 !== s ? r + ': ' + t + s + i : s;
                      }),
          ...
          b = e.options && e.options.accessibility && e.options.accessibility.description,
          f = g ? ' ' + p.name + '.' : '',
          y =
            ((c = e.series.chart),
            (u = tF(e)).length
              ? c.langFormat('accessibility.series.pointAnnotationsDescription', {
                  point: e,
                  annotations: u,
                })
              : '');
      ...
      function tY(e) {
        let t,
          ...
          r = i.types || [],
          s =
            ((t = (e.options.accessibility || {}).description) &&
          ...
          a = tW(e, 'xAxis'),
          l = tW(e, 'yAxis'),
          h = { seriesNumber: o, series: e, chart: i },
          d = r.length > 1 ? 'Combination' : '',
          c =
            i.langFormat('accessibility.series.summary.' + e.type + d, h) ||
            i.langFormat('accessibility.series.summary.default' + d, h),
          u = (n('yAxis') ? ' ' + l + '.' : '') + (n('xAxis') ? ' ' + a + '.' : '');
        return tz(
          (0, x.pick)(
            e.options.accessibility && e.options.accessibility.descriptionFormat,
            i.options.accessibility.series.descriptionFormat,
            ''
          ),
          {
            seriesDescription: c,
      ...
      let tj = {
          defaultPointDescriptionFormatter: tX,
          defaultSeriesDescriptionFormatter: tY,
          describeSeries: function (e) {
            let t = e.chart,
              ...
              s = t.is3d && t.is3d();
            if (r) {
              let n, o, a, l, h, d, c, u, p, g, m;
              if (
                (r.lastChild !== i || s || tU(r),
                (n = e.options.accessibility || {}),
                (a = !tK(e) && !n.exposeAsGroupOnly),
                (o = e.chart.options.accessibility.keyboardNavigation.seriesNavigation),
                (l = !!(
                  e.points &&
                  (e.points.length < +o.pointNavigationEnabledThreshold ||
                    !1 === o.pointNavigationEnabledThreshold)
                )),
                  ...
                  e.points.forEach((t) => {
                    let i,
                      ...
                      l =
                        ...
                        ((r = (i = t.series) && i.chart),
                        (s = i && i.is('sunburst')),
                        (n = t.isNull),
                        (o = r && r.options.accessibility.point.describeNull),
                        n &&
                          !s &&
                          o &&
                          (function (e) {
                            let t,
                              ...
                              r = (function (e) {
                                let t = e.index;
                                if (!e.series || !e.series.data || !(0, x.defined)(t))
                                  return null;
                                let i = e.series.options?.nullInteraction;
                                return (
                                  (0, x.find)(e.series.data, function (e) {
                                    return !!(
                                      e &&
                                      void 0 !== e.index &&
                                      (i || e.index > t) &&
                              ...
                              s = r && r.graphic,
                              n = s ? s.parentGroup : i.graph || i.group,
                              o = r
                                ? {
                                    x: (0, x.pick)(e.plotX, r.plotX, 0),
                                    y: (0, x.pick)(e.plotY, r.plotY, 0),
                                  }
                                : {
                                    x: (0, x.pick)(e.plotX, 0),
                                    y: (0, x.pick)(e.plotY, 0),
                                  },
                              a =
                                ((t = e.series.chart.renderer.rect(o.x, o.y, 1, 1)).attr({
                            ...
                            if (n && n.element)
                              return (
                                ...
                                (e.hasMockGraphic = !0),
                                a.add(n),
                                n.element.insertBefore(a.element, s ? s.element : null),
                                a.element
                              );
                          })(t)),
                      d =
                    ...
                    if (l) {
                      if (t.isNull && !h) return void l.setAttribute('aria-hidden', !0);
                      if (
                        ...
                        ((e = t.series),
                          ...
                          (s = tG(
                            ((0, x.isString)(i.descriptionFormat) &&
                              tz(i.descriptionFormat, t, e.chart)) ||
                              i.descriptionFormatter?.(t) ||
                              ((0, x.isString)(r.descriptionFormat) &&
                                tz(r.descriptionFormat, t, e.chart)) ||
                              r.descriptionFormatter?.(t) ||
                              tX(t),
                ...
                tH(t, r),
                (u = (c = (d = e.chart).options.chart).options3d && c.options3d.enabled),
                (p = d.series.length > 1),
                (g = d.options.accessibility.series.describeSingleSeries),
                (m = (e.options.accessibility || {}).exposeAsGroupOnly),
                !(u && p) && (p || g || m || tK(e)))
              ) {
                let t, i, s;
                ((t = e.options.accessibility || {}),
                  (s = (i = e.chart.options.accessibility).landmarkVerbosity),
                  t.exposeAsGroupOnly
        ...
        { composed: tZ } = y(),
        { getChartTitle: t_ } = L,
        { defaultPointDescriptionFormatter: t$, defaultSeriesDescriptionFormatter: tQ } =
          tj;
      function tJ(e) {
      ...
      class t0 {
        ...
        onSeriesAdded(e) {
          tJ(this.chart) &&
            ...
            (this.dirty.newSeries = (0, x.defined)(this.dirty.newSeries) ? void 0 : e));
        }
        announceDirtyData() {
          let e = this.chart,
            t = this;
          if (e.options.accessibility.announceNewData && this.dirty.hasDirty) {
            var i;
            let e,
              r = this.dirty.newPoint;
            (r &&
              (r =
                1 ===
                (e = (i = r).series.data.filter((e) => i.x === e.x && i.y === e.y)).length
                  ? e[0]
                  : i),
        ...
        queueAnnouncement(e, t, i) {
          ...
          if (r.enabled) {
            ...
            let n,
              o = +new Date(),
              a = o - this.lastAnnouncementTime,
              l = Math.max(0, r.minAnnounceInterval - a),
              h =
                ((s = this.queuedAnnouncement && this.queuedAnnouncement.series),
                Object.keys(
                  (n = (s || [])
                    .concat(e || [])
                    .reduce((e, t) => ((e[t.name + t.index] = t), e), {}))
                ).map((e) => n[e])),
              d = this.buildAnnouncementMessage(h, t, i);
            d &&
              (this.queuedAnnouncement &&
                (0, x.internalClearTimeout)(this.queuedAnnouncementTimer),
              (this.queuedAnnouncement = { time: o, message: d, series: h }),
        ...
        buildAnnouncementMessage(e, t, i) {
          let r = this.chart,
            s = r.options.accessibility.announceNewData;
          if (s.announcementFormatter) {
            let r = s.announcementFormatter(e, t, i, this);
            if (!1 !== r) return r.length ? r : null;
          }
          let n = y().charts && y().charts.length > 1 ? 'Multiple' : 'Single',
            o = t
              ? 'newSeriesAnnounce' + n
              : i
                ? 'newPointAnnounce' + n
          ...
          return r.langFormat('accessibility.announceNewData.' + o, {
            chartTitle: a,
            seriesDesc: t ? tQ(t) : null,
            pointDesc: i ? t$(i) : null,
            point: i,
            series: t,
          });
        }
      ...
      function t1(e) {
        ...
        i &&
          i.chart === t &&
          tJ(t) &&
          (i.dirty.newPoint = (0, x.defined)(i.dirty.newPoint) ? void 0 : e.point);
      }
      function t2() {
        let e = this.chart,
      ...
      (t0 || (t0 = {})).compose = function (e) {
        (0, x.pushUnique)(tZ, 'A11y.NDA') &&
          ((0, x.addEvent)(e, 'addPoint', t1), (0, x.addEvent)(e, 'updatedData', t2));
      };
      let t3 = t0,
        { doc: t5, win: t4 } = y(),
        { fireEventOnWrappedOrUnwrappedElement: t6 } = L,
        {
          cloneMouseEvent: t8,
          cloneTouchEvent: t9,
          getFakeMouseEvent: t7,
          removeElement: ie,
        } = k,
        it = class {
          constructor(e, t, i = 'button', r, s) {
            ((this.chart = e), (this.target = t), (this.eventProvider = new U()));
            const n = (this.innerElement = t5.createElement(i)),
              o = (this.element = r ? t5.createElement(r) : n);
            (e.styledMode || this.hideElementVisually(n),
              r &&
                ('li' !== r || e.styledMode || (o.style.listStyle = 'none'),
                o.appendChild(n),
                (this.element = o)),
              this.updateTarget(t, s));
          }
          click() {
            let e = this.getTargetPosition();
            ((e.x += e.width / 2), (e.y += e.height / 2));
            let t = t7('click', e);
            t6(this.target.click, t);
          }
          updateTarget(e, t) {
          ...
          remove() {
            (this.eventProvider.removeAddedEvents(), ie(this.element));
          }
          updateCSSClassName() {
            let e = (e) => e.indexOf('highcharts-no-tooltip') > -1,
              t = e(this.chart.legend?.group?.div?.className || ''),
              i = e(this.getTargetAttr(this.target.click, 'class') || '');
          ...
          addProxyEventsToElement(e, t) {
            [
              ...
              let r = 0 === i.indexOf('touch');
              this.eventProvider.addEvent(
                e,
                i,
                (e) => {
                  let i = r ? t9(e) : t8(e);
                  (t && t6(t, i), e.stopPropagation(), r || e.preventDefault());
                },
                { passive: !1 }
              );
            });
          ...
          getTargetPosition() {
            let e = this.target.click,
              ...
              r = this.chart.renderTo,
              s = this.chart.pointer;
            if (r && i?.getBoundingClientRect && s) {
              let e = t4.scrollY || t5.documentElement.scrollTop,
                t = i.getBoundingClientRect(),
                r = s.getChartPosition();
              return {
        ...
        { doc: ii } = y(),
        { unhideChartElementFromAT: ir } = L,
        { removeChildNodes: is } = k,
        io = class {
          constructor(e) {
            ((this.chart = e),
              (this.domElementProvider = new q()),
          ...
          addProxyElement(e, t, i = 'button', r) {
            let s = this.groups[e];
            if (!s) throw Error('ProxyProvider.addProxyElement: Invalid group key ' + e);
            let n = 'ul' === s.type || 'ol' === s.type ? 'li' : void 0,
              o = new it(this.chart, t, i, n, r);
            return (
              s.proxyContainerElement.appendChild(o.element),
              s.proxyElements.push(o),
              o
            );
          }
          addGroup(e, t = 'div', i) {
            let r,
              s = this.groups[e];
            if (s) return s.groupElement;
            let n = this.domElementProvider.createElement(t);
            return (
              i && i.role && 'div' !== t
                ? (r = this.domElementProvider.createElement('div')).appendChild(n)
                : (r = n),
              (r.className =
              ...
              this.afterChartProxyPosContainer.appendChild(r),
          ...
          updateGroupOrder(e) {
            ...
            (['before', 'after'].forEach((e) => {
              ...
              (is(t),
                ('before' === e ? i : r).forEach((e) => {
                  let i = this.groups[e];
                  i && t.appendChild(i.groupElement);
                }));
            }),
              (this.beforeChartProxyPosContainer.contains(s) ||
                this.afterChartProxyPosContainer.contains(s)) &&
                s &&
                s.focus &&
                s.focus());
          }
          ...
          getCurrentGroupOrderInDOM() {
            let e = (e) => {
                ...
                for (; i--; ) {
                  let r = t[i],
                    s = this.groups[r];
                  if (s && e === s.groupElement) return r;
                }
              },
              t = (t) => {
                let i = [],
              ...
              r = t(this.afterChartProxyPosContainer);
            return (i.push('series'), i.concat(r));
          }
          ...
          updatePosContainerPositions() {
            ...
            (e.container.insertBefore(this.afterChartProxyPosContainer, t.nextSibling),
              ...
              ir(this.chart, this.afterChartProxyPosContainer),
              ir(this.chart, this.beforeChartProxyPosContainer));
          }
        },
        { unhideChartElementFromAT: ia, getAxisRangeDescription: il } = L;
      class ih extends V {
        init() {
          let e = this.chart;
          this.announcer = new er(e, 'polite');
        ...
        onChartUpdate() {
          ...
          i &&
            ...
            i.maxInput &&
              i.minInput &&
              ['minInput', 'maxInput'].forEach(function (r, s) {
                let n = i[r];
                n &&
                  (ia(e, n),
                  t.setRangeInputAttrs(
                    n,
                    'accessibility.rangeSelector.' + (s ? 'max' : 'min') + 'InputLabel'
                  ));
              }));
        }
        updateSelectorVisibility() {
          ...
          t && t.hasVisibleDropdown && i
            ? (ia(e, i), r.forEach((e) => e.element.setAttribute('aria-hidden', !0)))
            : (i && i.setAttribute('aria-hidden', !0),
              r.forEach((t) => ia(e, t.element)));
        }
        setDropdownAttrs() {
          let e = this.chart,
        ...
        setRangeButtonAttrs(e) {
          (0, x.attr)(e.element, { tabindex: -1, role: 'button' });
        }
        setRangeInputAttrs(e, t) {
          let i = this.chart;
          (0, x.attr)(e, { tabindex: -1, 'aria-label': i.langFormat(t, { chart: i }) });
        }
        onButtonNavKbdArrowKey(e, t) {
          let i = e.response,
            r = this.keyCodes,
            s = this.chart,
            n = s.options.accessibility.keyboardNavigation.wrapAround,
            o = t === r.left || t === r.up ? -1 : 1;
          return s.highlightRangeSelectorButton(s.highlightedRangeSelectorItemIx + o)
            ? i.success
            : n
              ? (e.init(o), i.success)
              : i[o > 0 ? 'next' : 'prev'];
        ...
        onButtonNavKbdClick(e) {
          ...
          return (
            3 !== i.oldRangeSelectorItemState &&
              this.fakeClickEvent(
                i.rangeSelector.buttons[i.highlightedRangeSelectorItemIx].element
              ),
            t.success
          );
        }
        ...
        onInputKbdMove(e) {
          let t = this.chart,
            i = t.rangeSelector,
            r = (t.highlightedInputRangeIx = (t.highlightedInputRangeIx || 0) + e);
          if (r > 1 || r < 0) {
            if (t.accessibility)
              return (
            ...
            let e = i[r ? 'maxDateBox' : 'minDateBox'],
              s = i[r ? 'maxInput' : 'minInput'];
            e && s && t.setFocusToElement(e, s);
          }
          return !0;
        }
        onInputNavInit(e) {
          let t = this,
            ...
            r = e > 0 ? 0 : 1,
            s = i.rangeSelector,
            n = s && s[r ? 'maxDateBox' : 'minDateBox'],
            o = s && s.minInput,
            a = s && s.maxInput;
          if (((i.highlightedInputRangeIx = r), n && o && a)) {
            (i.setFocusToElement(n, r ? a : o),
            ...
            let e = (e) => {
              ...
              s = (0, x.addEvent)(o, 'keydown', e),
              l = (0, x.addEvent)(a, 'keydown', e);
        ...
        initDropdownNav() {
          ...
          t &&
            ...
            (this.removeDropdownKeydownHandler = (0, x.addEvent)(i, 'keydown', (t) => {
              let i = (t.which || t.keyCode) === this.keyCodes.tab,
                r = e.accessibility;
              i &&
                (t.preventDefault(),
                t.stopPropagation(),
                r && r.keyboardNavigation.move(t.shiftKey ? -1 : 1));
            })));
        }
        getRangeSelectorButtonNavigation() {
          ...
          return new W(e, {
            ...
            init: function (t) {
              ...
              if (r && r.hasVisibleDropdown) i.initDropdownNav();
              else if (r) {
                let i = r.buttons.length - 1;
      ...
      function id(e) {
        let t = (this.rangeSelector && this.rangeSelector.buttons) || [],
          ...
          r = this.rangeSelector && this.rangeSelector.selected;
        return (
          void 0 !== i &&
            t[i] &&
            i !== r &&
          ...
          !!t[e] &&
            ...
            e !== r && ((this.oldRangeSelectorItemState = t[e].state), t[e].setState(1)),
            !0)
        );
      }
      function ic() {
      ...
      (ih || (ih = {})).compose = function (e, t) {
        let i = e.prototype;
        i.highlightRangeSelectorButton ||
          ((i.highlightRangeSelectorButton = id),
          (0, x.addEvent)(t, 'afterBtnClick', ic));
      };
      let iu = ih,
        { composed: ip } = y();
      !(function (e) {
        ...
        function i(e) {
          return (
            e.marker.states && e.marker.states.normal && e.marker.states.normal.opacity
          );
        }
        function r(e) {
        ...
        function n(e) {
          this.resetA11yMarkerOptions = (0, x.merge)(
            e.options.marker || {},
        ...
        function o() {
          ...
          !(function (e) {
            let t,
              i = e.chart.options.accessibility.enabled,
              r = !1 !== (e.options.accessibility && e.options.accessibility.enabled);
            return (
              i &&
              r &&
              ((t = e.chart.options.accessibility),
              ...
              ? (delete this.a11yMarkersForced,
                ...
                (function (e) {
                  ...
                  if (t) {
                    ...
                    (e.chart.styledMode && !1 === t.enabled && a(e),
                      e.userOptions &&
                ...
                e.marker?.enabled === !1 && delete this.resetA11yMarkerOptions)
              : this.chart.styledMode && e.marker?.enabled === !1 && !r(this) && a(this)
            : (e.marker?.enabled === !1 &&
              ...
              r(this) &&
                (function (e) {
                  ...
                  for (; r--; ) {
                    ...
                    if ((delete n.hasForcedA11yMarker, o.marker)) {
                      var s;
                      let e = a && 0 === i(o);
                      o.marker.enabled && !e
                        ? ((s = o),
                          (0, x.merge)(!0, s.marker, {
                            states: { normal: { opacity: i(s) || 1 } },
                          }),
                          (n.hasForcedA11yMarker = !1))
                        : !1 === o.marker.enabled && (t(o), (n.hasForcedA11yMarker = !0));
                    }
                  }
                })(this));
        }
        ...
        function l() {
          this.boosted &&
            this.a11yMarkersForced &&
            ((0, x.merge)(!0, this.options, { marker: { enabled: !1 } }),
            delete this.a11yMarkersForced);
        }
        e.compose = function (e) {
          (0, x.pushUnique)(ip, 'A11y.FM') &&
            ((0, x.addEvent)(e, 'afterSetOptions', n),
            (0, x.addEvent)(e, 'render', o),
            (0, x.addEvent)(e, 'afterRender', s),
            (0, x.addEvent)(e, 'renderCanvas', l));
        };
      })(p || (p = {}));
      let ig = p;
      var im = b(260),
        ...
        ix = b(820),
        iy = b.n(ix);
      let { seriesTypes: iv } = tn(),
        { doc: iE } = y(),
        { getPointFromXY: iw, getSeriesFromName: iA, scrollAxisToPoint: iT } = L;
      function ik(e) {
        let t = e.index,
          i = e.series.points,
          r = i.length;
        if (i[t] === e) return t;
        for (; r--; ) if (i[r] === e) return r;
      }
      function iM(e) {
        let t = e.chart.options.accessibility.keyboardNavigation.seriesNavigation,
          i = e.options.accessibility || {},
          r = i.keyboardNavigation;
        return (
          (r && !1 === r.enabled) ||
          !1 === i.enabled ||
      ...
      function iC(e) {
        let t = e.series,
          ...
          r = e.options.accessibility,
          s = t.chart.options.accessibility,
          n = r?.enabled === !1,
          o = s.keyboardNavigation.seriesNavigation.skipNullPoints ?? !i;
        return (e.isNull && o) || !1 === e.visible || !1 === e.isInside || n || iM(t);
      }
      function iS(e) {
        let t = e.series || [],
          i = t.length;
        for (let e = 0; e < i; ++e)
          if (!iM(t[e])) {
            let i = (function (e) {
              let t = e.points || [],
                i = t.length;
              for (let e = 0; e < i; ++e) if (!iC(t[e])) return t[e];
              return null;
            })(t[e]);
            if (i) return i;
          }
      ...
      class iN {
        ...
        init() {
          let e = this,
            t = this.chart,
            i = (this.eventProvider = new U());
          (i.addEvent(iy(), 'destroy', function () {
            return e.onSeriesDestroy(this);
          }),
            i.addEvent(t, 'afterApplyDrilldown', function () {
              let e;
              (e = iS(this)) && e.highlight(!1);
            }),
            i.addEvent(t, 'drilldown', function (t) {
              let i = t.point,
                r = i.series;
              e.lastDrilledDownPoint = { x: i.x, y: i.y, seriesName: r ? r.name : '' };
            }),
            ...
            i.addEvent(ib(), 'afterSetState', function () {
              let e = this.graphic && this.graphic.element,
                i = iE.activeElement,
                r = i && i.getAttribute('class'),
                s = r && r.indexOf('highcharts-a11y-proxy-element') > -1;
              t.highlightedPoint === this && i !== e && !s && e && e.focus && e.focus();
            }));
        }
        onDrillupAll() {
          let e,
            ...
            i = this.chart,
            r = t && iA(i, t.seriesName);
          (t && r && (0, x.defined)(t.x) && (0, x.defined)(t.y) && (e = iw(r, t.x, t.y)),
            (e = e || iS(i)),
        ...
        getKeyboardNavigationHandler() {
          ...
          return new W(i, {
            keyCodeMap: [
              [
                r ? [t.up, t.down] : [t.left, t.right],
                function (t) {
                  return e.onKbdSideways(this, t);
                },
              ],
              [
                r ? [t.left, t.right] : [t.up, t.down],
                function (t) {
              ...
              [
                [t.enter, t.space],
                function (e, t) {
                  let r = i.highlightedPoint;
                  if (r) {
                    let { plotLeft: e, plotTop: i } = this.chart,
                      { plotX: s = 0, plotY: n = 0 } = r;
                    ((t = {
                      ...t,
                      chartX: e + s,
                      chartY: i + n,
                      ...
                      (0, x.fireEvent)(r.series, 'click', t),
                      r.firePointEvent('click', t));
                  }
                  return this.response.success;
                },
              ],
              [
                [t.home],
                function () {
                  return (iD(i), this.response.success);
                },
              ],
              [
                [t.end],
                function () {
                  return (iP(i), this.response.success);
                },
              ],
              [
                [t.pageDown, t.pageUp],
        ...
        onKbdVertical(e, t) {
          ...
          return (i[o](s), e.response.success);
        }
        onHandlerTerminate() {
          let e = this.chart,
        ...
        attemptHighlightAdjacentPoint(e, t) {
          let i = this.chart,
            r = i.options.accessibility.keyboardNavigation.wrapAround;
      ...
      !(function (e) {
        ...
        function i(e) {
          ...
          return (
            ...
            (this.series.forEach((s) => {
              iM(s) ||
                s.points.forEach((n) => {
                  if (!(0, x.defined)(n.plotY) || !(0, x.defined)(n.plotX) || n === t)
                    return;
                  let o = n.plotY - t.plotY,
                    a = Math.abs(n.plotX - t.plotX),
                    l = Math.abs(o) * Math.abs(o) + a * a * 4;
                  (s.yAxis && s.yAxis.reversed && (o *= -1),
                    !((o <= 0 && e) || (o >= 0 && !e) || l < 5 || iC(n)) &&
                      l < i &&
                      ((i = l), (r = n)));
                });
            }),
        ...
        function r(e) {
          ...
          return this.highlightedPoint
            ? !!(t = this.series[s.series.index + (e ? -1 : 1)]) &&
                !!(i = (function (e, t, i, r) {
                  let s = 1 / 0,
                    n,
                    o,
                    a,
                    l = t.points.length,
                    h = (e) => !((0, x.defined)(e.plotX) && (0, x.defined)(e.plotY));
                  if (!h(e)) {
                    for (; l--; )
                      !h((n = t.points[l])) &&
                        (a =
                          (e.plotX - n.plotX) * (e.plotX - n.plotX) * 4 +
                          (e.plotY - n.plotY) * (e.plotY - n.plotY) * 1) < s &&
                        ((s = a), (o = l));
                    return (0, x.defined)(o) ? t.points[o] : void 0;
                  }
                })(s, t, 4)) &&
                (iM(t)
                  ? (i.highlight(), (r = this.highlightAdjacentSeries(e)))
                    ? r
                    : (s.highlight(), !1)
        ...
        function s(e = !0) {
          ...
          if (i && r && r < 0) {
            ...
            window.scrollTo({ behavior: 'smooth', top: e + r });
          }
          return this;
        }
        function n() {
          let e = this.chart.highlightedPoint,
            t = (e && e.series) === this ? ik(e) : 0,
            i = this.points,
            r = i.length;
          if (i && r) {
            for (let e = t; e < r; ++e) if (!iC(i[e])) return i[e].highlight();
            for (let e = t; e >= 0; --e) if (!iC(i[e])) return i[e].highlight();
          }
          return !1;
        }
        e.compose = function (e, o, a) {
          ...
          l.highlightAdjacentPoint ||
            ...
            (l.highlightAdjacentSeries = r),
            (h.highlight = s),
            (d.keyboardMoveVertical = !0),
            ['column', 'gantt', 'pie'].forEach((e) => {
              iv[e] && (iv[e].prototype.keyboardMoveVertical = !1);
            }),
            (d.highlightNextValidPoint = n));
        };
      })(iN || (iN = {}));
      let iB = iN,
        { hideSeriesFromAT: iI } = L,
        { describeSeries: iF } = tj,
        iO = class extends V {
          static compose(e, t, i) {
            (t3.compose(i), ig.compose(i), iB.compose(e, t, i));
          }
          init() {
            ((this.newDataAnnouncer = new t3(this.chart)),
              this.newDataAnnouncer.init(),
              (this.keyboardNavigation = new iB(this.chart, this.keyCodes)),
        ...
        iH = class extends V {
          ...
          onChartUpdate() {
            let e = this.chart,
              t = this;
            e.mapNavigation &&
              e.mapNavigation.navButtons.forEach((i, r) => {
                (iR(e, i.element),
                  t.setMapNavButtonAttrs(
                    i.element,
                    'accessibility.zoom.mapZoom' + (r ? 'Out' : 'In')
                  ));
              });
          }
          setMapNavButtonAttrs(e, t) {
            let i = this.chart,
              r = i.langFormat(t, { chart: i });
            (0, x.attr)(e, { tabindex: -1, role: 'button', 'aria-label': r });
          }
          onChartRender() {
          ...
          onMapKbdArrow(e, t) {
            let i = this.chart,
              ...
              l = 10 * Math.random(),
              h = {
                x: s.offsetLeft + i.plotLeft + i.plotWidth / 2 + l,
                y: s.offsetTop + i.plotTop + i.plotHeight / 2 + l,
              },
              d = n ? { x: h.x, y: h.y + a } : { x: h.x + a, y: h.y };
            return (
              [iL('mousedown', h), iL('mousemove', d), iL('mouseup', d)].forEach((e) =>
                s.dispatchEvent(e)
              ),
              e.response.success
            );
          ...
          onMapKbdTab(e, t) {
            let i = this.chart,
              ...
              s = t.shiftKey,
              n =
                (s && !this.focusedMapNavButtonIx) || (!s && this.focusedMapNavButtonIx);
            if ((i.mapNavigation.navButtons[this.focusedMapNavButtonIx].setState(0), n))
              return (i.mapView && i.mapView.zoomBy(), r[s ? 'prev' : 'next']);
            this.focusedMapNavButtonIx += s ? -1 : 1;
            let o = i.mapNavigation.navButtons[this.focusedMapNavButtonIx];
            return (i.setFocusToElement(o.box, o.element), o.setState(2), r.success);
          }
          onMapKbdClick(e) {
            let t =
              this.chart.mapNavigation.navButtons[this.focusedMapNavButtonIx].element;
            return (this.fakeClickEvent(t), e.response.success);
          }
          onMapNavInit(e) {
            let t = this.chart,
              i = t.mapNavigation.navButtons[0],
              r = t.mapNavigation.navButtons[1],
              s = e > 0 ? i : r;
            (t.setFocusToElement(s.box, s.element),
              s.setState(2),
          ...
          simpleButtonNavigation(e, t, i) {
            ...
            return new W(n, {
              keyCodeMap: [
                [
                  [r.tab, r.up, r.down, r.left, r.right],
                  function (e, t) {
                    let i = (e === r.tab && t.shiftKey) || e === r.left || e === r.up;
                ...
                [
                  ...
                  function () {
                    let e = i(this, n);
                    return (0, x.pick)(e, this.response.success);
                  },
                ],
              ],
              validate: function () {
                return n[e] && n[e].box && s[t].innerElement;
              },
              init: function () {
                n.setFocusToElement(n[e].box, s[t].innerElement);
              },
            });
          }
          getKeyboardNavigation() {
        ...
        { doc: iz, isMS: iq, win: iU } = y(),
        iG = function () {
          if (iq && iU.getComputedStyle) {
            let e = iz.createElement('div');
            ((e.style.backgroundImage =
              'url(data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)'),
              iz.body.appendChild(e));
            let t = (e.currentStyle || iU.getComputedStyle(e)).backgroundImage;
            return (iz.body.removeChild(e), 'none' === t);
          }
          return iU.matchMedia && iU.matchMedia('(forced-colors: active)').matches;
        },
        iK = function (e) {
          let t = e.highContrastState || (e.highContrastState = {});
            ...
            (e.series.forEach(function (e) {
              let r = t.plotOptions[e.type] || {},
                ...
                n = {
                  ...
                  colors: i ? t.colors : [r.color || 'windowText'],
        ...
        iV = {
          ...
          navigation: {
            buttonOptions: { symbolStroke: 'windowText', theme: { fill: 'window' } },
          },
          rangeSelector: {
            buttonTheme: {
              fill: 'window',
      ...
      function iW(e, t, i) {
        let r = e,
          s,
          n = 0;
        for (; n < t.length - 1; ++n) r = r[(s = t[n])] = (0, x.pick)(r[s], {});
        r[t[t.length - 1]] = i;
      }
      function iX(e, t, i, r) {
        function s(e, t) {
      ...
      let iY = function (e) {
          ...
          ((t = e.options.chart),
            ...
            ['description', 'typeDescription'].forEach(function (r) {
              t[r] &&
                ((i[r] = t[r]),
                (0, x.error)(32, !1, e, { [`chart.${r}`]: `use accessibility.${r}` }));
            }),
            ...
            e.series &&
              ((r = {
                ...
                pointDescriptionFormat: ['accessibility', 'point', 'descriptionFormat'],
              ...
              e.series.forEach(function (t) {
                Object.keys(r).forEach(function (i) {
                  let s = t.options[i];
                  ('accessibility.pointDescriptionFormatter' === i &&
                    (s =
                      t.options.accessibility &&
                      t.options.accessibility.pointDescriptionFormatter),
                    void 0 !== s &&
                      (iW(t.options, r[i], 'skipKeyboardNavigation' === i ? !s : s),
                      (0, x.error)(32, !1, e, {
                        [`series.${i}`]: 'series.' + r[i].join('.'),
                      })));
                });
              })),
            iX(e, ['accessibility'], ['accessibility'], {
            ...
            iX(e, ['lang', 'accessibility'], ['lang', 'accessibility'], {
        ...
        { defaultOptions: ij } = y(),
        { doc: iZ } = y(),
        { escapeStringForHTML: i_, removeElement: i$, stripHTMLTagsFromString: iQ } = k;
      class iJ {
        constructor(e) {
          this.init(e);
        }
        init(e) {
          if (((this.chart = e), !iZ?.addEventListener)) {
            ((this.zombie = !0),
              (this.components = {}),
          ...
          (iY(e),
            (this.proxyProvider = new io(this.chart)),
            this.initComponents(),
            (this.keyboardNavigation = new eH(e, this.components)));
        }
        initComponents() {
          let e = this.chart,
          ...
          ((this.components = {
            ...
            legend: new e$(),
            chartMenu: new eD(),
            rangeSelector: new iu(),
            series: new iO(),
            zoom: new iH(),
            navigator: new tI(),
          }),
            i.customComponents && (0, x.extend)(this.components, i.customComponents));
          let r = this.components;
          this.getComponentOrder().forEach(function (i) {
            (r[i].initBase(e, t), r[i].init());
          });
        }
        getComponentOrder() {
        ...
        update() {
          let e = this.components,
            t = this.chart,
            i = t.options.accessibility;
          ((0, x.fireEvent)(t, 'beforeA11yUpdate'), (t.types = this.getChartTypes()));
          let r = i.keyboardNavigation.order;
          (this.proxyProvider.updateGroupOrder(r),
            this.getComponentOrder().forEach(function (i) {
              (e[i].onChartUpdate(),
                (0, x.fireEvent)(t, 'afterA11yComponentUpdate', {
                  name: i,
                  component: e[i],
                }));
            }),
            this.keyboardNavigation.update(r),
            !t.highContrastState?.applying &&
              !1 !== i.highContrastMode &&
              (t.highContrastState?.active || iG() || !0 === i.highContrastMode) &&
              iK(t),
            (0, x.fireEvent)(t, 'afterA11yUpdate', { accessibility: this }));
        }
        destroy() {
          let e = this.chart || {},
            t = this.components;
          (Object.keys(t).forEach(function (e) {
            ...
            e.announcerContainer && i$(e.announcerContainer),
      ...
      (!(function (e) {
        ...
        function r(e) {
          ...
          let i = t.components.infoRegions,
            r = i && (i.getLongdescText() || i.getTypeDescriptionText());
          if (!r) return;
          let s = i_(iQ(r, !0));
          if (!s.trim()) return;
          let n = e.chartCopy.renderer.box;
          (n.querySelector(':scope > metadata')?.remove(),
            n.insertAdjacentHTML(
              'afterbegin',
              '<metadata><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:dc="http://purl.org/dc/elements/1.1/"><rdf:Description><dc:description>' +
                s +
                '</dc:description></rdf:Description></rdf:RDF></metadata>'
            ));
        }
        function s(e) {
          ...
          (t &&
            ...
            (0, x.merge)(!0, this.options.accessibility, t),
            this.accessibility &&
        ...
        function n() {
          let t = this.accessibility,
            ...
            r = this.renderer.boxWrapper.element,
            s = this.title;
          if (i && i.enabled)
            t && !t.zombie
              ? t.update()
              : ((this.accessibility = t = new e(this)),
                t && !t.zombie && t.update(),
                'img' === r.getAttribute('role') && r.removeAttribute('role'));
            ...
            (this.renderTo.setAttribute('role', 'img'),
              ...
              this.renderTo.setAttribute(
                'aria-label',
                ((s && s.element.textContent) || '').replace(/</g, '&lt;')
              ),
        ...
        ((e.i18nFormat = B.i18nFormat),
          (e.compose = function (e, a, l, h, d, c) {
            (eH.compose(e),
              t3.compose(h),
              e$.compose(e, a),
              eD.compose(e),
            ...
            let u = e.prototype;
            u.updateA11yEnabled ||
              ((u.updateA11yEnabled = n),
              (0, x.addEvent)(e, 'destroy', t),
              (0, x.addEvent)(e, 'render', i),
              (0, x.addEvent)(e, 'update', s),
              (0, x.addEvent)(e, 'getSVG', r),
              ['addSeries', 'init'].forEach((t) => {
                (0, x.addEvent)(e, t, function () {
                  this.a11yDirty = !0;
                });
              }),
              ...
              (0, x.addEvent)(l, 'update', o),
              ['update', 'updatedData', 'remove'].forEach((e) => {
                (0, x.addEvent)(h, e, function () {
        ...
        (0, x.merge)(
          ...
          {
            accessibility: { highContrastTheme: iV },
            lang: {
              accessibility: {
      ...
      let i0 = iJ,
        i1 = y();
      ((i1.i18nFormat = i0.i18nFormat),
        (i1.A11yChartUtilities = L),
        (i1.A11yHTMLUtilities = k),
        (i1.AccessibilityComponent = V),
        (i1.KeyboardNavigationHandler = W),
        (i1.SeriesAccessibilityDescriber = tj),
        i0.compose(
          i1.Chart,
          i1.Legend,
          i1.Point,
