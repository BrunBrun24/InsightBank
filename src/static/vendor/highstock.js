!(
 ...
 - ${i}: ${e}`),
        ...
        (tf(V, 'displayError', { chart: i, code: t, message: a, params: s }, function () {
          if (e) throw Error(a);
      ...
      function tf(t, e, i, s) {
        if (
          ((i = i || {}), _?.createEvent && (t.dispatchEvent || (t.fireEvent && t !== V)))
        ) {
      ...
      Z.jQuery &&
        (Z.jQuery.fn.highcharts = function () {
          let t = [].slice.call(arguments);
          if (this[0])
            return t[0]
              ? (new V[J(t[0]) ? t.shift() : 'Chart'](this[0], t[0], t[1]), this)
              : $[tr(this[0], 'data-highcharts-chart')];
        });
      let tx = {
          ...
          createElement: function (t, e, i, s, o) {
            ...
            return (
              e && tn(r, e),
              o && tl(r, { padding: '0', border: 'none', margin: '0' }),
              i && tl(r, i),
              s && s.appendChild(r),
              r
            );
          ...
          getStyle: function t(e, i, s) {
            ...
            return (
              r && ((o = r.getPropertyValue(i)), th(s, 'opacity' !== i) && (o = K(o))),
              o
            );
          },
          insertItem: function (t, e) {
            ...
            for (i = t.options.isInternal ? o : 0; i < o + 1; i++)
              if (
                !e[i] ||
                (ts(s) && s < th(e[i].options.index, e[i]._i)) ||
          ...
          normalizeTickInterval: function (t, e, i, s, o) {
            ...
            for (
              ...
              r < e.length &&
              ((a = e[r]),
              (!o || !(a * i >= t)) && (o || !(n <= (e[r] + (e[r + 1] || e[r])) / 2)));
              r++
            );
            return tc(a * i, -Math.round(Math.log(0.001) / Math.LN10));
          },
          objectEach: tu,
          offset: function (t) {
        ...
        tD = class {
            ...
            if (!o) {
              ...
              try {
                ...
                /Invalid time zone/i.test(e.message)
                  ? (tk(34), (t.timeZone = 'UTC'), (o = new Intl.DateTimeFormat(i, t)))
                  : tk(e.message, !1);
              }
            }
          ...
          makeTime(t, e, i = 1, s = 0, o, r, a) {
            ...
            if ('UTC' !== this.timezone) {
              ...
              if (
                ((n += t), -1 !== [2, 3, 8, 9, 10, 11].indexOf(e) && (s < 5 || s > 20))
              ) {
                let e = this.getTimezoneOffset(n);
                t !== e
                  ? (n += e - t)
                  : t - 36e5 !== this.getTimezoneOffset(n - 36e5) || tB || (n -= 36e5);
              }
            }
            return n;
          }
          ...
          dateFormat(t, e, i) {
            ...
            if (tA(t) && -1 !== t.indexOf('%')) {
              ...
              let i = (this.getTimezoneOffset(e) || 0) / 36e5,
                ...
                { prefix: o = '', suffix: r = '' } = t;
              t = o + this.dateTimeFormat(tM({ timeZone: s }, t), e) + r;
            }
            return i ? tL(t) : t;
          }
          resolveDTLFormat(t) {
            return tS(t, !0)
              ? tS(t, !0) && void 0 === t.main
                ? { main: t }
                : t
        ...
        tN = class extends tD {
          getTimeTicks(t, e, i, s) {
            ...
            return ((r.info = tz(t, { higherRanks: a, totalRange: h * n })), r);
          }
        },
        { isTouchDevice: tW } = V,
        ...
        tY = {
          ...
          setOptions: function (t) {
            return (
              tG(V, 'setOptions', { options: t }),
              tX(!0, tH, t),
              t.time && tF.update(tH.time),
              t.lang && 'locale' in t.lang && tF.update({ locale: t.lang.locale }),
              t.lang?.chartTitle && (tH.title = { ...tH.title, text: t.lang.chartTitle }),
              tH
            );
          },
        },
      ...
      class tJ {
        ...
        constructor(t) {
          ...
          if ('object' == typeof t && void 0 !== t.stops)
            ...
            for (
              this.input = t = tJ.names[t.toLowerCase()] || t, s = tJ.parsers.length;
              s-- && !i;
            )
        ...
        brighten(t) {
          ...
          if (this.stops)
            ...
            if (tU(e[0]))
              ...
              tJ.useColorMix &&
                tK(this.input) &&
                (this.output = tq(this.input, t > 0 ? 'white' : 'black', Math.abs(t)));
          return this;
        }
        setOpacity(t) {
        ...
        tweenTo(t, e) {
          let i = this.rgba,
            s = t.rgba;
          if (!tU(i[0]) || !tU(s[0]))
            return tJ.useColorMix && tK(this.input) && tK(t.input) && e < 0.99
              ? tq(this.input, t.input, e)
              : t.input || 'none';
          let o = 1 !== s[3] || 1 !== i[3],
            r = (t, s) => t + (i[s] - t) * (1 - e),
      ...
      ((tJ.names = { white: '#ffffff', black: '#000000' }),
        (tJ.parsers = [
          {
            regex:
      ...
      class t3 {
        ...
        strokeSetter() {
          this.elem.attr(
            this.prop,
            tQ(this.start).tweenTo(tQ(this.end), this.pos),
            void 0,
            !0
          );
        }
      ...
      function es(t, e) {
        ...
        for (; i--; )
          t3.timers[i].elem !== t ||
            (e && e !== t3.timers[i].prop) ||
            (t3.timers[i].stopped = !0);
      }
      let eo = {
          animate: function (t, e, i) {
            let s,
              ...
              n;
            (t8(i) ||
              ((n = arguments), (i = { duration: n[2], easing: n[3], complete: n[4] })),
              ...
              et(e, function (n, h) {
                (es(t, h),
                  ...
                  'd' === h && t9(e.d)
                    ...
                    : t.attr
                      ? (s = t.attr(h))
                      : ((s = parseFloat(t6(t, h)) || 0), 'opacity' !== h && (o = 'px')),
                  r || (r = n),
        ...
        em =
          ef &&
          ec(ef.createPolicy) &&
          ef.createPolicy('highcharts', { createHTML: (t) => t }),
        ex = em ? em.createHTML('') : '';
      class ey {
            ...
            eu(t, (e, i) => {
              ...
              (-1 === ey.allowedAttributes.indexOf(i) && (s = !1),
                -1 !== ['background', 'dynsrc', 'href', 'lowsrc', 'src'].indexOf(i) &&
                  (s = ep(e) && ey.allowedReferences.some((t) => 0 === e.indexOf(t))),
                s ||
                  (ed(33, !1, void 0, { 'Invalid attribute in config': `${i}` }),
                  delete t[i]),
        ...
        addToDOM(t) {
          return (function t(e, i) {
            let s;
            return (
              eg(e).forEach(function (e) {
                let o,
                  r = e.tagName,
                  a = e.textContent ? V.doc.createTextNode(e.textContent) : void 0,
                  n = ey.bypassHTMLFiltering;
                if (r)
                  if ('#text' === r) o = a;
                    ...
                    (eu(e, function (t, e) {
                      ...
                      t(e.children || [], h),
                      (o = h));
                  } else ed(33, !1, void 0, { 'Invalid tagName in config': r });
      ...
      function eB(t = '', e, i) {
        let s = RegExp('\\{([\\p{L}\\d:\\.,;\\-\\/<>\\[\\]%_@+"\'’= #\\(\\)]+)\\}', 'gu'),
          ...
          a = /f$/,
          n = /\.(\d)/,
          h = i?.options?.lang || eb.lang,
          l = i?.time || ev,
          d = i?.numberFormatter || eD.bind(i),
          c = (t = '') => {
            let i;
            return (
              'true' === t ||
        ...
        return (
          r.forEach((s) => {
            let r,
              p,
              { body: u, elseBody: g, expression: f, fn: m } = s;
            if (m) {
              let t = [s],
                o = [],
                a = f.length,
      ...
      function eD(t, e, i, s) {
        ...
        return (
          (o = (eL[g] ?? (eL[g] = new Intl.NumberFormat(u, c))).format(t)),
          p &&
            (o = o
              .replace(/([,\.])/g, '_$1')
              .replace(/_\,/g, s ?? ',')
      ...
      class id {
        ...
        align(t, e, i, s = !0) {
          ...
          let h = is(i, o[n], o),
            ...
            d =
              (h.y || 0) +
              (t.y || 0) +
              ((h.height || 0) - (t.height || 0)) * e6(t.verticalAlign),
            c = {};
          return (
                  ...
                  function (e, i) {
                    ((l = !1),
                      ...
                      this.rotation &&
                        ...
                        (this.doTransform = !0),
                      l ||
                        (this[i + 'Setter'] || this._defaultSetter).call(this, e, i, o));
                  },
                  this
                ),
                this.afterSetters()),
        ...
        clip(t) {
          if (t && !t.clipPath) {
            ...
            (e3(t, { clipPath: i, id: e, count: 0 }), t.add(i));
          }
        ...
        crisp(t, e) {
          ...
          let i = t.x || this.x || 0,
            ...
            n = eQ(s, e);
          return (
            e3(t, { x: a, y: n, width: eQ(o, e) - a, height: eQ(r, e) - n }),
        ...
        complexColor(t, e, i) {
          let s = this.renderer,
            ...
            g = [],
            f;
          e5(this.renderer, 'complexColor', { args: arguments }, function () {
            if (
              (t.radialGradient
                ? (r = 'radialGradient')
              ...
              if (
                ...
                ((t.radAttr = n),
                  ...
                  l.forEach(function (e) {
                    0 === e[1].indexOf('rgba')
                      ? ((d = (o = tJ.parse(e[1])).get('rgb')), (c = o.get('a')))
                      : ((d = e[1]), (c = 1));
                    let i = s
                      .createElement('stop')
        ...
        destroy() {
          ...
          for (t.safeRemoveChild(e); r?.div && 0 === r.div.childNodes.length; )
            ((a = r.parentGroup), t.safeRemoveChild(r.div), delete r.div, (r = a));
        ...
        getBBox(t, e) {
          let i,
            ...
            p = is(e, this.rotation, 0),
            u = a.styledMode
              ? r && id.prototype.getStyle.call(r, 'font-size')
              : n.fontSize,
          ...
          if ((g && !t && (i = l[g]), !i || i.polygon)) {
            if (c || a.forExport) {
              try {
                ((o =
                  ...
                  (i = r.getBBox
                    ? e3({}, r.getBBox())
                    : { width: r.offsetWidth, height: r.offsetHeight, x: 0, y: 0 }),
                  e4(o) && o(''));
              } catch {}
            ...
            ((s = i.height),
              c &&
                (i.height = s =
                  { '11px,17': 14, '13px,20': 16 }[`${u || ''},${Math.round(s)}`] || s),
        ...
        constructor(t, e) {
          ((this.onEvents = {}),
            ...
            (this.SVG_NS = e$),
            (this.element =
              'span' === e || 'body' === e ? eJ(e) : eU.createElementNS(this.SVG_NS, e)),
            (this.renderer = t),
            (this.styles = {}),
            e5(this, 'afterInit'));
        }
        ...
        setRadialReference(t) {
          let e =
            (this.element.gradient && this.renderer.gradients[this.element.gradient]) ||
            void 0;
          return (
        ...
        strokeWidth() {
          ...
          return (
            /px$/.test(t)
              ? (e = io(t))
              : '' !== t &&
                (eK((i = eU.createElementNS(e$, 'rect')), {
                  width: t,
                  'stroke-width': 0,
                }),
        ...
        updateTransform(t = 'transform') {
          ...
          (e1(s) && u.push('matrix(' + s.join(',') + ')'),
            ...
            u.length &&
              !(d || this).textPath &&
              (i?.element || e).setAttribute(t, u.join(' ')));
        }
        ...
        zIndexSetter(t, e) {
          ...
          if (
            (e1(t)
              ...
              : e1(this[e]) && r.removeAttribute('data-z-index'),
            (this[e] = t),
            p)
          ) {
            for (
      ...
      ((id.symbolCustomAttribs = [
        ...
        (id.prototype.matrixSetter =
          id.prototype.rotationOriginXSetter =
          id.prototype.rotationOriginYSetter =
          id.prototype.rotationSetter =
          id.prototype.scaleXSetter =
          id.prototype.scaleYSetter =
          id.prototype.translateXSetter =
          id.prototype.translateYSetter =
          id.prototype.verticalAlignSetter =
            function (t, e) {
      ...
      class iv extends ic {
        ...
        alignSetter(t) {
          ...
          ((this.textAlign = t),
            e !== this.alignFactor &&
              ((this.alignFactor = e),
              this.bBox && im(this.xSetting) && this.attr({ x: this.xSetting }),
        ...
        onAdd() {
          (this.text.add(this),
            this.attr({ text: iy(this.textStr, ''), x: this.x || 0, y: this.y || 0 }),
            this.box &&
              ip(this.anchorX) &&
        ...
        updateBoxSize() {
          let t,
            ...
            s = this.padding,
            o = (this.bBox =
              (!im(this.widthSetting) || !im(this.heightSetting) || this.textAlign) &&
              ip(e.textStr)
                ? e.getBBox(void 0, 0)
                : iv.emptyBBox);
          ...
          if (!t.textPath) {
            ...
            let i = this.baseline ? 0 : this.baselineOffset,
              s =
                ...
                ig(e) * (this.widthSetting ?? this.bBox.width);
            ((s !== t.x || i !== t.y) &&
      ...
      ((iv.emptyBBox = { width: 0, height: 0, x: 0, y: 0 }),
        (iv.textProps = [
          'color',
          'direction',
          'fontFamily',
          ...
          modifyDOM() {
            ...
            [].forEach.call(e.element.querySelectorAll('tspan.highcharts-br'), (t, s) => {
              t.nextSibling &&
                ...
                iL(t, { dy: this.getLineHeight(t.nextSibling), x: i }));
            });
            let s = this.width || 0;
            if (!s) return;
            let o = (t, o) => {
                ...
                if (n) {
                  ...
                  for (; a.length; )
                    if (
                      ...
                      a.length &&
                        (this.truncate(t, t.textContent || '', void 0, 0, s, l, iN),
          ...
          truncate(t, e, i, s, o, r, a) {
            ...
            if (((l.rotation = 0), s + (h = f(t.textContent.length)) > o)) {
              ...
              (0 === u
                ...
                this.ellipsis &&
                  h > o &&
                  this.truncate(t, t.textContent || '', void 0, 0, o, r, iN));
            }
            (i && i.splice(0, g), (l.actualWidth = h), (l.rotation = d));
          }
          unescapeEntities(t, e) {
            return (
              iz(this.renderer.escapes, function (i, s) {
                (e && -1 !== e.indexOf(i)) ||
      ...
      class ss {
        constructor(t, e, i, s, o, r, a) {
          ...
          (a || l.css(this.getStyle(s || {})),
            ...
            this.createElement('desc')
              .add()
              .element.appendChild(iF.createTextNode('Created with Highcharts 12.5.0')),
        ...
        getReferenceURL() {
          if ((iY || iU) && iF.getElementsByTagName('base').length) {
            if (!i1(e)) {
              ...
              i0(i, { position: 'fixed', top: 0, left: 0, zIndex: 9e5 });
              let s = iF.elementFromPoint(6, 6);
              ((e = s?.id === 'hitme'), iF.body.removeChild(i));
            }
            if (e)
              return se(
                iZ.location.href.split('#')[0],
                [/<[^>]*>/g, ''],
                [/([\('\)])/g, '\\$1'],
                [/ /g, '%20']
              );
            ...
            (d.setState = (t = 0) => {
              if (
                ...
                d
                  ...
                  .addClass(
                    'highcharts-button-' + ['normal', 'hover', 'pressed', 'disabled'][t]
                  ),
                !c)
              ) {
                d.attr(m[t]);
        ...
        crispLine(t, e) {
          let [i, s] = t;
          return (
            i1(i[1]) && i[1] === s[1] && (i[1] = s[1] = iQ(i[1], e)),
        ...
        path(t) {
          ...
          return (
            i5(t) ? (e.d = t) : i9(t) && i3(e, t),
            this.createElement('path').attr(e)
          );
        }
        circle(t, e, i) {
          let s = i9(t) ? t : void 0 === t ? {} : { x: t, y: e, r: i },
        ...
        rect(t, e, i, s, o, r) {
          ...
          return (
            this.styledMode ||
              (void 0 !== r && ((a['stroke-width'] = r), i3(a, n.crisp(a))),
              (a.fill = 'none')),
        ...
        symbol(t, e, i, s, o, r) {
          ...
          if (g)
            ('number' == typeof e &&
              ...
              i3(a, { symbolName: u || void 0, x: e, y: i, width: s, height: o }),
              r && i3(a, r));
          else if (p) {
            h = t.match(c)[1];
                ...
                s[`${t}Setter`] = function (t, e) {
                  ...
                  (r && 'within' === r.backgroundSize && o && a && n && h
                    ...
                    !i &&
                      n &&
                      h &&
                      this.translate(((o || 0) - n * d) / 2, ((a || 0) - h * d) / 2));
                };
              }),
              i1(e) && s.attr({ x: e, y: i }),
              (s.isImg = !0),
              (s.symbolUrl = t),
              i1(s.imgwidth) && i1(s.imgheight)
                ? l(s)
                : (s.attr({ width: 0, height: 0 }),
                  iJ('img', {
                    onload: function () {
                      ...
                      (0 === this.width &&
                        (i0(this, { position: 'absolute', top: '-999em' }),
                        iF.body.appendChild(this)),
                        (i_[h] = { width: this.width, height: this.height }),
        ...
        rotCorr(t, e, i) {
          let s = t;
          return (
            e && i && (s = Math.max(s * Math.cos(e * iH), 4)),
            { x: (-t / 3) * Math.sin(e * iH), y: s }
          );
        }
        pathToSegments(t) {
          let e = [],
      ...
      let sm = (t, e) => {
        if (!t.div) {
          ...
          ((t.classSetter = (t, e, i) => {
            ...
            (t.on = function () {
              return (
                ic.prototype.on.apply({ element: o, onEvents: t.onEvents }, arguments),
                t
              );
            }),
            (t.div = o));
      ...
      class sx extends ic {
        ...
        css(t) {
          let e,
            ...
            o = s && t.width;
          return (
            s && (delete t.width, (this.textWidth = su(o) || void 0), (e = !0)),
        ...
        updateTransform() {
          ...
          let {
            ...
            x = () =>
              this.textPxLength
                ? this.textPxLength
                : (sn(t, { width: '', whiteSpace: d || 'nowrap' }), t.offsetWidth);
          if (
            (e || sn(t, { marginLeft: `${u}px`, marginTop: `${g}px` }),
            'SPAN' === t.tagName)
          ) {
            let u,
            ...
            if (p !== i) {
              let e = x(),
                r = p || 0,
                a =
                  !s.styledMode && '' === t.style.textOverflow && t.style.webkitLineClamp;
              (r > i || e > r || a) &&
            ...
            (e &&
              (sn(t, { display: 'inline-block', verticalAlign: 'top' }),
              ...
              g !== this.cTT &&
                ...
                this.getSpanCorrection(
                  (!sl(o) && !this.textWidth && this.textPxLength) || t.offsetWidth,
                  u,
                  sc(c)
                )));
                ...
                ? (super.updateTransform(),
                  sp(f) && sp(m)
                    ? (e.attr({
                      ...
                      sn(t, { display: l, textAlign: c }))
                    : sr && e.attr({ width: 0, height: 0 }))
                : sn(t, k),
              (this.cTT = g),
              (this.oldRotation = o),
              (this.oldAlign = c));
      ...
      ((sy.visibilitySetter = sy.opacitySetter = sf),
        (sy.ySetter =
          sy.rotationSetter =
          sy.rotationOriginXSetter =
          sy.rotationOriginYSetter =
            sy.xSetter),
        ((p = w || (w = {})).xAxis = {
          alignTicks: !0,
      ...
      (S || (S = {})).registerEventOptions = function (t, e) {
        ((t.eventOptions = t.eventOptions || {}),
          sM(e.events, function (e, i) {
            t.eventOptions[i] !== e &&
              (t.eventOptions[i] &&
                (sw(t, i, t.eventOptions[i]), delete t.eventOptions[i]),
              sk(e) && ((t.eventOptions[i] = e), sv(t, i, e, { order: 0 })));
          }));
      };
      let sS = S,
        { deg2rad: sA } = V,
        ...
        sN = class {
          ...
          addLabel() {
            let t = this,
              ...
              a = e.names,
              n = t.pos,
              h = sR(t.options?.labels, i.labels),
              l = e.tickPositions,
              d = n === l[0],
              c = n === l[l.length - 1],
                ...
                (u
                  ? (f = (m = s.time.resolveDTLFormat(
                      i.dateTimeLabelFormats[
                        (!i.grid?.enabled && u.higherRanks[n]) || u.unitName
                      ]
                    )).main)
                  : sD(y) &&
                    (f = e.dateTime.getXDateFormat(y, i.dateTimeLabelFormats || {}))),
              (t.isFirst = d),
              (t.isLast = c));
            let b = {
              axis: e,
          ...
          getPosition(t, e, i, s) {
            let o = this.axis,
              ...
              n = {
                x: t
                  ? sC(o.translate(e + i, void 0, void 0, s) + o.transB)
                  : o.left +
                    o.offset +
                    (o.opposite
                ...
                y: t
                  ...
                  : sC(a - o.translate(e + i, void 0, void 0, s) - o.transB),
              };
            return (
              (n.y = sT(n.y, -1e9, 1e9)),
            ...
            return (
              (h =
                0 === d.side
                  ...
                  : 2 === d.side
                    ? g.y + m
                    : Math.cos(i.rotation * sA) * (g.y - i.getBBox(!1, 0).height / 2)),
          ...
          handleOverflow(t) {
            let e = this.axis,
              ...
              h = this.label,
              l = this.rotation,
              d = sB(e.labelAlign || h.attr('align')),
              c = h.getBBox().width,
            ...
            (l || 'justify' !== i.overflow
              ? l < 0 && s - d * c < a
                ? (f = Math.round(s / Math.cos(l * sA) - a))
                : l > 0 && s + d * c > n && (f = Math.round((o - s) / Math.cos(l * sA)))
              : (s - d * c < a
                  ? (u = t.x + u * (1 - d) - a)
              ...
              f &&
                ...
                (this.shortenLabel
                  ? this.shortenLabel()
                  : h.css(
                      sE({}, { width: Math.floor(f) + 'px', lineClamp: +!e.isRadial })
                    )));
          }
          moveLabel(t, e) {
            let i = this,
        ...
        os = (t, e) =>
          s9(
            ...
            void 0,
            void 0,
            s8(t.options.allowDecimals, e < 0.5 || void 0 !== t.tickAmount),
            !!t.tickAmount
          );
      sJ(sH, { xAxis: sG, yAxis: s6(sG, sX) });
      class oo {
        constructor(t, e, i) {
          this.init(t, e, i);
        }
        init(t, e, i = this.coll) {
          ...
          (this.type ?? (this.type = r.type || 'linear'),
            ...
            (this.categories =
              (s2(r.categories) && r.categories) || (this.hasNames ? [] : void 0)),
        ...
        setOptions(t) {
          ...
          ((this.options = s6(
            ...
            sQ(this, 'afterSetOptions', { userOptions: t }));
        }
        defaultLabelFormatter() {
          let t = this.axis,
            { numberFormatter: e } = this.chart,
            i = s3(this.value) ? this.value : NaN,
            s = t.chart.time,
            o = t.categories,
          ...
          if (o) p = `${this.value}`;
            ...
            for (; d-- && void 0 === p; )
              l >= (c = Math.pow(h, d + 1)) &&
                ...
                (p = e(i / c, -1) + n[d]);
          return (
            void 0 === p && (p = Math.abs(i) >= 1e4 ? e(i, -1) : e(i, -1, void 0, '')),
            p
          );
        }
        getSeriesExtremes() {
              ...
              e.series.forEach((i) => {
                if (i.reserveSpace()) {
                  ...
                  if (
                    ...
                    (s3(t.dataMin) &&
                      ((a = t.dataMin), (e.dataMin = Math.min(s8(e.dataMin, a), a))),
                      s3(t.dataMax) &&
                        ((n = t.dataMax), (e.dataMax = Math.max(s8(e.dataMax, n), n))),
                      s_(r) && (e.threshold = r),
        ...
        getPlotLinePath(t) {
          ...
          function y(t, e, i) {
            return (
              'pass' !== p && (t < e || t > i) && (p ? (t = sV(t, e, i)) : (x = !0)),
              t
            );
          }
          let b = {
          ...
          return (
            sQ(this, 'getPlotLinePath', b, function (t) {
              ((u = f =
                (c = sV((c = s8(c, e.translate(a, void 0, void 0, r))), -1e9, 1e9)) + d),
                (g = m = h - c - d),
                s3(c)
                  ? e.horiz
                    ? ((g = o),
        ...
        getLinearTickPositions(t, e, i) {
          let s,
            o,
            r,
            a = s$(Math.floor(e / t) * t),
            n = s$(Math.ceil(i / t) * t),
            h = [];
          if ((s$(a + t) === a && (r = 20), this.single)) return [e];
        ...
        adjustForMinRange() {
          ...
          (this.isXAxis &&
            ...
            !e &&
            (r =
              s_(t.min) || s_(t.max) || s_(t.floor) || s_(t.ceiling)
                ? null
                : Math.min(
                    5 *
                      (s0(
            ...
            s3(s) &&
              ...
              (s = sU(l)) - o < r &&
                ((h[0] = s - r), (h[1] = i.parse(t.min) ?? s - r), (o = sj(h)))),
            (this.minRange = r),
            (this.min = o),
            (this.max = s));
        }
            ...
            (this.series.forEach(function (t) {
              ...
              1 === o.length
                ...
                : t.sorted &&
                  s_(s) &&
                  t.reserveSpace() &&
                  (e = s_(e) ? Math.min(e, s) : s);
            }),
              i.length && (i.sort((t, e) => t - e), (t = s0([i]))));
          }
          return t && e ? Math.min(t, e) : t || e;
        }
        nameToX(t) {
          let e = s2(this.options.categories),
        ...
        setTickInterval(t) {
          let {
            ...
            d = i.time,
            c = s3(this.threshold) ? this.threshold : void 0,
            p = this.minRange || 0,
            { ceiling: u, floor: g, linkedTo: f, softMax: m, softMin: x } = h,
            y = s3(f) && i[this.coll]?.[f],
            b = h.tickPixelInterval,
            v = h.maxPadding,
            k = h.minPadding,
            M = 0,
            w,
            S = s3(h.tickInterval) && h.tickInterval >= 0 ? h.tickInterval : void 0,
            A,
            T,
            C,
            P;
          if (
            ...
            y
              ? ((this.linkedParent = y),
                ...
                this.type !== y.type && sK(11, !0, i))
              : (l &&
                  s_(c) &&
                  s3(s) &&
                  s3(o) &&
                  (o >= c ? ((A = c), (k = 0)) : s <= c && ((T = c), (v = 0))),
                (this.min = s8(C, A, o)),
                (this.max = s8(P, T, s))),
            s3(this.max) &&
              s3(this.min) &&
              (n &&
                (this.positiveValuesOnly &&
                  !t &&
                  0 >= Math.min(this.min, s8(o, this.min)) &&
                  sK(10, !0, i),
                (this.min = s$(n.log2lin(this.min), 16)),
                (this.max = s$(n.log2lin(this.max), 16))),
              this.range &&
                s3(o) &&
                ((this.userMin = this.min = C = Math.max(o, this.minFromRange() || 0)),
            ...
            if (
              (!s3(this.userMin) && s3(x) && x < this.min && (this.min = C = x),
            ...
            (!i.polar &&
              this.min > this.max &&
              (s_(h.min) ? (this.max = this.min) : s_(h.max) && (this.min = this.max)),
              (M = this.max - this.min));
          }
          if (
            (this.min !== this.max && s3(this.min) && s3(this.max)
              ? y && !S && b === y.options.tickPixelInterval
                ? (this.tickInterval = S = y.tickInterval)
                : (this.tickInterval = s8(
                    S,
            ...
            (this.series.forEach(function (e) {
              ...
              sQ(this, 'postProcessData', { hasExtremesChanged: t }));
          }
        ...
        setTickPositions() {
          ...
          if (
            ...
            if (
              ...
              ((n = [this.min, this.max]), sK(19, !1, this.chart));
        ...
        adjustTickAmount() {
          let t = this,
            ...
            h = r?.length,
            l = s8(t.threshold, t.softThreshold ? 0 : null),
            d,
            c,
            p = t.tickInterval,
            u,
            g = () => r.push(s$(r[r.length - 1] + p)),
            f = () => r.unshift(s$(r[0] - p));
          if (
            (s3(n) &&
              ((u =
                0 === n ? 0 : 1 === n ? a - 1 : Math.round(sV(n * (a - 1), 1, a - 2))),
              o.reversed && (u = a - 1 - u)),
            t.hasData() && s3(s) && s3(i))
          ) {
            let n = () => {
        ...
        setExtremes(t, e, i = !0, s, o) {
          ...
          (this.series.forEach((t) => {
            ...
            (t = r.time.parse(t)),
            (e = r.time.parse(e)),
            sQ(this, 'setExtremes', (o = sJ(o, { min: t, max: e })), (t) => {
              ((this.userMin = t.min),
                (this.userMax = t.max),
                (this.eventArgs = t),
                i && r.redraw(s));
        ...
        setAxisSize() {
          let t = this.chart,
            ...
            o = (this.width = Math.round(
              s7(s8(e.width, t.plotWidth - i[3] + i[1]), t.plotWidth)
            )),
            r = (this.height = Math.round(
              s7(s8(e.height, t.plotHeight - i[0] + i[2]), t.plotHeight)
            )),
            a = (this.top = Math.round(
              s7(s8(e.top, t.plotTop + i[0]), t.plotHeight, t.plotTop)
            )),
            n = (this.left = Math.round(
              s7(s8(e.left, t.plotLeft + i[3]), t.plotWidth, t.plotLeft)
            ));
        ...
        autoLabelAlign(t) {
          let e = (((t - 90 * this.side) % 360) + 360) % 360,
            i = { align: 'center' };
          return (
            sQ(this, 'autoLabelAlign', i, function (t) {
              e > 15 && e < 165
                ? (t.align = 'right')
        ...
        unsquish() {
          ...
          if (i) {
            if (
              (!t.staggerLines &&
                (s3(r) ? (p = [r]) : o < t.autoRotationLimit && (p = t.autoRotation)),
              p)
            ) {
              let t, e;
              for (let i of p)
                (i === r || (i && i >= -90 && i <= 90)) &&
                  (e = (t = h(Math.abs(a / Math.sin(sY * i)))) + Math.abs(i / 360)) < c &&
                  ((c = e), (d = i), (l = t));
            }
          } else l = h(0.75 * a);
          return (
              ...
              i &&
                ...
                e.shortenLabel
                  ...
                  : p &&
                    ...
                    ? i.css(sJ(a, { width: `${p}px`, lineClamp: u }))
          ...
          if (
            ...
            v &&
              ...
              (k +=
                f *
                (i
                  ? s8(c.y, t.tickRotCorr.y + f * c.distance)
                  : s8(c.x, f * c.distance)))),
        ...
        getTitlePosition(t) {
          let e = this.horiz,
            ...
            u = { low: a + (e ? 0 : o), middle: a + o / 2, high: a + (e ? o : 0) }[
              r.align
            ],
            g =
              (e ? s + this.height : i) +
          ...
          return (sQ(this, 'afterGetTitlePosition', { titlePosition: f }), f);
        }
        renderMinorTick(t, e) {
        ...
        render() {
          ...
          if (i.hasData() || n) {
            ...
            (i.minorTickInterval &&
              ...
              h.length &&
                ...
                m &&
                  (0 === i.min || i.single) &&
                  (d[-1] || (d[-1] = new sN(i, -1, null, !0)), d[-1].render(-1))),
              g &&
                h.forEach(function (r, a) {
                  ((e = void 0 !== h[a + 1] ? h[a + 1] + m : i.max - m),
                    a % 2 == 0 &&
                      r < i.max &&
                      e <= i.max + (s.polar ? -m : m) &&
                      (p[r] || (p[r] = new V.PlotLineOrBand(i, {})),
                      (t = r + m),
                      (p[r].options = {
          ...
          ([d, c, p].forEach(function (t) {
            ...
            l &&
              y &&
              (l[l.isNew ? 'attr' : 'animate'](i.getTitlePosition(l)), (l.isNew = !1)),
        ...
        drawCrosshair(t, e) {
          let i = this.crosshair,
            ...
            l;
          if (
            (sQ(this, 'drawCrosshair', { e: t, point: e }),
            t || (t = this.cross?.e),
            i && !1 !== (s_(e) || !s))
          ) {
            if (
                ...
                !o.styledMode &&
                  (h
                    .attr({
                      stroke:
                        i.color ||
                        (n ? tJ.parse('#ccd3ff').setOpacity(0.25).get() : '#cccccc'),
          ...
          sQ(this, 'afterDrawCrosshair', { e: t, point: e });
        }
        hideCrosshair() {
        ...
        class s {
          ...
          normalizeTimeTickInterval(t, e) {
            ...
            for (
              ...
              ((o = oh[(s = i[a])[0]]),
              (r = s[1]),
              !i[a + 1] || !(t <= (o * r[r.length - 1] + oh[i[a + 1][0]]) / 2));
              a++
            );
      ...
      class oP {
            ...
            (!t.chart.styledMode &&
              (v
                ? ((M.stroke = o || '#999999'),
                  ...
                  e.dashStyle && (M.dashstyle = e.dashStyle))
                : b &&
                  ((M.fill = o || '#e6e9ff'),
                  u && ((M.stroke = e.borderColor), (M['stroke-width'] = u)))),
            (l.zIndex = a),
            (w += '-' + a),
            (y = t.plotLinesAndBandsGroups[w]) ||
              (t.plotLinesAndBandsGroups[w] = y =
                n
                  .g('plot-' + w)
                  .attr(l)
                  .add()),
        ...
        renderLabel(t, e, i, s) {
          ...
          let h = e.xBounds || [e[0][1], e[1][1], i ? e[2][1] : e[0][1]],
            ...
            c = ov(l),
            p = ob(h) - d;
          (n.align(t, !1, { x: d, y: c, width: p, height: ob(l) - c }),
            (n.alignAttr.y -= r.fontMetrics(n).b),
            (!n.alignValue || 'left' === n.alignValue || ok(a)) &&
              n.css({
                width:
                  (t.style?.width ||
                    (i && a
      ...
      class oQ {
        ...
        refresh(t, e) {
          ...
          n.points = void 0;
          let m = n.series;
          if (((this.distance = oZ(m.tooltipOptions.distance, 16)), !1 === f))
            this.hide();
          else {
            if (this.split && this.allowShared) this.renderSplit(f, a);
                ...
                return void this.hide();
              {
                ...
                ((!s.style.width || d) &&
                  ...
                  d ||
                    t.attr({ stroke: s.borderColor || n.color || m.color || '#666666' }),
                  this.updatePosition({
                    plotX: u,
                    plotY: g,
                    negative: n.negative,
        ...
        renderSplit(t, e) {
          let i = this,
            {
              ...
              distance: p,
              options: u,
              options: { fixed: g, position: f, positioner: m },
              pointer: x,
            } = i,
            ...
            v =
              i.outside && 'number' != typeof d
                ? oD.documentElement.getBoundingClientRect()
          ...
          let L = t.slice(0, e.length + 1).reduce(function (t, s, o) {
            if (!1 !== s && '' !== s) {
                  ...
                  if (!o) {
                    ...
                    (c ||
                      ...
                      (o = M.label(
                        ...
                        0,
                        0,
                        n[r ? 'headerShape' : 'shape'] || (g && !r ? 'rect' : 'callout'),
                        void 0,
                        void 0,
                        n.useHTML
                      )
              ...
              let { anchorX: b, anchorY: S } = (function (t) {
                ...
                return { anchorX: (e = oN(e, v.left - p, v.right + p)), anchorY: i };
              })(r);
              if ('number' == typeof S) {
                let e = x.height + 1,
          ...
          (!T &&
            ...
            (L = L.map((t) => {
              ...
              return oH(t, { target: i, x: e });
            })),
            i.cleanSplit(),
            oz(L, O));
          let B = { left: S, right: S };
          (L.forEach(function (t) {
            let { x: e, boxWidth: s, isHeader: o } = t;
            !o &&
              (i.outside && S + e < B.left && (B.left = S + e),
            ...
            L.forEach(function (t) {
              ...
              if (i.outside && e < s) {
                ...
                t > 0 &&
                  ...
                  a && ((n.x = (B.right - B.left) / 2), (n.anchorX = s + t)));
              }
              t.tt.attr(n);
            }));
          ...
          oI && k.attr({ opacity: 1 === k.opacity ? 0.999 : 1 });
        }
        drawTracker() {
          let t = this;
        ...
        headerFooterFormatter(t, e) {
          ...
          return (
            oF(this, 'headerFormatter', a, function (e) {
              if (
                (r &&
                  !n &&
                  oU(t.key) &&
        ...
        updatePosition(t) {
          ...
          if (a && i) {
            ...
            ((b = (o.borderWidth || 0) + 2 * s + 2),
              ...
              (1 !== u || 1 !== g) &&
                (oW(i, { transform: `scale(${u}, ${g})` }), (x *= u), (y *= g)),
              (x += c - f.x),
              (y += p - f.y));
          }
      ...
      class rl {
        ...
        applyOptions(t, e) {
          ...
          return (
            o4(this, (t = rl.prototype.optionsToObject.call(this, t))),
            ...
            void 0 === this.x && i
              ...
              : ri(t.x) && i.options.relativeXValue
                ? (this.x = i.autoIncrement(t.x))
                : 'string' == typeof this.x &&
                  (e ?? (e = i.chart.time.parse(this.x)), ri(e) && (this.x = e)),
            ...
            let t = this,
              ...
              a = () => {
                for (let e in ((t.graphic || t.graphics || t.dataLabel || t.dataLabels) &&
                  (rn(t), t.destroyElements()),
                t))
                  delete t[e];
              };
            (t.legendItem && i.legend.destroyItem(t),
              o && (t.setState(), o9(o, t), o.length || (i.hoverPoints = null)),
              t === i.hoverPoint && t.onMouseOut(),
              s?.enabled ? (this.animateBeforeDestroy(), ra(a, r.duration)) : a(),
              i.pointCount--);
          }
          this.destroyed = !0;
        }
        ...
        optionsToObject(t) {
          ...
          if (ri(t) || null === t) r[s[0]] = t;
            ...
            for (
              ...
              ((i && void 0 === t[n]) ||
                (s[h].indexOf('.') > 0
                  ? rl.prototype.setNestedProperty(r, t[n], s[h])
                  : (r[s[h]] = t[n])),
                n++,
                h++);
          else
        ...
        setState(t, e) {
          let i = this.series,
            ...
            r = o2.plotOptions[i.type].marker && i.options.marker,
            a = r && !1 === r.enabled,
            n = r?.states?.[t || 'normal'] || {},
            h = !1 === n.enabled,
            l = this.marker || {},
          ...
          if (
            ...
            (u &&
              this.graphic.animate(
                u,
                rr(d.options.chart.animation, n.animation, r.animation)
              ),
              m && m.hide());
          } else
            (t &&
                ...
                (m
                  ...
                  : x &&
                    ((i.stateMarkerGraphic = m =
                      d.renderer
                        .symbol(x, u.x, u.y, u.width, u.height, ro(r, n))
                        .add(i.markerGroup)),
                    (m.currentSymbol = x))),
              !d.styledMode &&
                m &&
            ...
            ? (p || (i.halo = p = d.renderer.path().add(b.parentGroup)),
              ...
              p.attr({
                class:
                  ...
                  rr(this.colorIndex, i.colorIndex) +
              ...
              d.styledMode ||
                p.attr(
                  o4(
                    ...
                    ey.filterUserAttributes(y.attributes || {})
                  )
                ))
            : p?.point?.haloPath &&
              !p.point.destroyed &&
              p.animate({ d: p.point.haloPath(0) }, null, p.hide),
            o8(this, 'afterSetState', { state: t }));
        }
        haloPath(t) {
          let e = this.pos();
          return e
      ...
      class rP {
        ...
        destroy() {
          ...
          (this.eventsToUnbind.forEach((t) => t()),
            (this.eventsToUnbind = []),
            !V.chartCount &&
              (rP.unbindDocumentMouseUp.forEach((t) => t.unbind()),
              (rP.unbindDocumentMouseUp.length = 0),
              rP.unbindDocumentTouchEnd &&
                (rP.unbindDocumentTouchEnd = rP.unbindDocumentTouchEnd())),
            rw(t, function (e, i) {
              t[i] = void 0;
            }));
        }
        getSelectionMarkerAttrs(t, e) {
          ...
          return (
            rv(this, 'getSelectionMarkerAttrs', i, (i) => {
              let s,
        ...
        drag(t) {
          ...
          if (
            ...
            (this.hasZoom &&
              ...
              e.styledMode ||
                m.attr({ fill: a || rc('#334eff').setOpacity(0.25).get() })),
              m && m.attr(l),
              f && !m && c && e.pan(t, o));
          }
        }
        ...
        drop(t) {
          ...
          i &&
            rk(i.index) &&
            (rx(i.container, { cursor: i._cursor }),
        ...
        getChartCoordinatesFromPoint(t, e) {
          ...
          if (i && s) {
            let r = t.clientX ?? t.plotX ?? 0,
              a = t.plotY || 0;
            return (
              t.isNode && o && rk(o.x) && rk(o.y) && ((r = o.x), (a = o.y)),
              e
          ...
          let a = [],
            n = function (t) {
              return (
                t.visible &&
                !(!o && t.directTouch) &&
                rA(t.options.enableMouseTracking, !0)
              );
            },
            h = e,
            l,
            ...
            c &&
              (o && !h.noSharedTooltip
                ? (l = i.filter(function (t) {
                    ...
                    rM(i) &&
                      (t.boosted && t.boost && (i = t.boost.getPoint(i)), a.push(i));
                  })
                : a.push(c)),
            rv(this, 'afterGetHoverData', (d = { hoverPoint: c })),
        ...
        normalize(t, e) {
          let i = t.touches,
            s = i
              ? i.length
                ? i.item(0)
                : rA(i.changedTouches, t.changedTouches)[0]
              : t;
        ...
        onContainerClick(t) {
          ...
          !e.cancelClick &&
            (i && this.inClass(s.target, 'highcharts-tracker')
              ? (rv(i.series, 'click', ry(s, { point: i })),
                e.hoverPoint && i.firePointEvent('click', s))
              : (ry(s, this.getCoordinates(s)),
          ...
          (a > 1 ? (e.initiated = !0) : l && (e.initiated = !1),
            ...
            'touchstart' === t.type
              ...
              : l
                ...
                : o &&
                  (rv(i, 'touchpan', { originalEvent: t, touches: r }, () => {
                    let e = (t) => {
                      let e = t[0],
                        i = t[1] || e;
                      return {
        ...
        runPointActions(t, e, i) {
          ...
          (this.unDocMouseMove ||
            ((this.unDocMouseMove = rf(s.container.ownerDocument, 'mousemove', (t) =>
              rp[rP.hoverChartIndex ?? -1]?.pointer?.onDocumentMouseMove(t)
            )),
        ...
        setDOMEvents() {
          ...
          ((t.onmousedown = this.onContainerMouseDown.bind(this)),
            ...
            this.eventsToUnbind.push(
              rf(t, 'mouseenter', this.onContainerMouseEnter.bind(this)),
              rf(t, 'mouseleave', this.onContainerMouseLeave.bind(this))
            ),
            rP.unbindDocumentMouseUp.some((t) => t.doc === e) ||
              rP.unbindDocumentMouseUp.push({
                doc: e,
          ...
          for (; s && 'BODY' !== s.tagName; )
            (this.eventsToUnbind.push(
              ...
              (s = i(s)));
          (this.eventsToUnbind.push(
            rf(t, 'touchstart', this.onContainerTouchStart.bind(this), { passive: !1 }),
            rf(t, 'touchmove', this.onContainerTouchMove.bind(this), { passive: !1 })
          ),
            rP.unbindDocumentTouchEnd ||
              (rP.unbindDocumentTouchEnd = rf(
                e,
                'touchend',
        ...
        setPointerCapture() {
          ...
          let t = this.pointerCaptureEventsToUnbind,
            ...
            i = e.container,
            s =
              rA(e.options.tooltip?.followTouchMove, !0) &&
          ...
          !this.hasPointerCapture && s
            ? (t.push(
              ...
              e.styledMode || rx(i, { 'touch-action': 'none' }),
      ...
      let { setLength: rE, splice: rL } = P,
        ...
        rz = class {
          ...
          deleteRows(t, e = 1) {
            ...
            (rB(this, 'afterDeleteRows', { rowIndex: t, rowCount: e }),
              (this.versionTag = rI()));
          }
          getColumn(t, e) {
          ...
          setColumns(t, e, i) {
            ...
            (rD(t, (t, e) => {
              ...
              i?.silent || (rB(this, 'afterSetColumns'), (this.versionTag = rI())));
          }
          setRow(t, e = this.rowCount, i, s) {
            ...
            (rD(o, (a, n) => {
              (a || s?.addColumns === !1 || (a = Array(r)),
                a &&
                  (i
                    ? (a = rL(a, e, 0, !0, [t[n] ?? null]).array)
                    : (a[e] = t[n] ?? null),
                  (o[n] = a)));
            }),
              r > this.rowCount && this.applyRowCount(r),
              s?.silent || (rB(this, 'afterSetRows'), (this.versionTag = rI())));
          }
          getModified() {
      ...
      function rX(t, e, i) {
        ...
        if (m && !1 !== m.enabled && n) {
          ...
          (0 === l.indexOf('url') && ((m = rN(m, { width: h, height: h })), (t = 0)),
            (s.symbol = f =
              c
                .symbol(l, n / 2 - t, u - t, 2 * t, 2 * t, rR({ context: 'legend' }, m))
      ...
      function r$(t, e) {
        ...
        return (
          ...
          !rV.seriesTypes[t] && (s && (i[t] = s), (rV.seriesTypes[t] = e), !0)
        );
      }
      ...
      class ax {
          ...
          (ar(this, 'bindAxes', null, function () {
            (e.axisTypes || []).forEach(function (o) {
              ((s[o] || []).forEach(function (s) {
                ((t = s.options),
                  (ag(i[o], 0) === s.index || (void 0 !== i[o] && i[o] === t.id)) &&
                    (ah(e, s.series), (e[o] = s), (s.isDirty = !0)));
              }),
        ...
        autoIncrement(t) {
          ...
          if (
            ((this.pointInterval = e = ag(this.pointInterval, i.pointInterval, 1)),
            o && ad(t) && (e *= t),
            s)
          ) {
            let t = r.toParts(a);
        ...
        setOptions(t) {
          ...
          ((this.tooltipOptions = ap(
            rK.tooltip,
            rK.plotOptions.series?.tooltip,
            c?.tooltip,
          ...
          return (
            (u.negativeColor || u.negativeFillColor) &&
              ...
              g.push(e)),
            g.length &&
              r8(g[g.length - 1].value) &&
              g.push(a ? {} : { color: this.color, fillColor: this.fillColor }),
            ar(this, 'afterSetOptions', { options: u }),
            u
          );
        }
        getName() {
          return (
            this.options.name ?? r2(this.chart.options.lang.seriesName, this, this.chart)
          );
        }
        getCyclic(t, e, i) {
          let s,
          ...
          (!e &&
            (r8((o = ag('color' === t ? this.options.colorIndex : void 0, this[a])))
              ? (s = o)
        ...
        getColor() {
          this.chart.styledMode
            ...
            : this.options.colorByPoint
              ...
              : this.getCyclic(
                  'color',
                  this.options.color || rK.plotOptions[this.type].color,
        ...
        getColumn(t, e) {
          return (
            (e ? this.dataTable.getModified() : this.dataTable).getColumn(t, !0) || []
          );
        }
        findPointIndex(t, e) {
          let i,
        ...
        updateData(t, e) {
                ...
                ? (-1 === (h = this.findPointIndex(d, p)) || void 0 === h
                    ...
                    : r[h] && t !== i.data?.[h]
                      ? (r[h].update(t, !1, void 0, !1),
                        ...
                        s && (p = h + 1))
                      : r[h] && (r[h].touched = !0),
                  (!n || e !== h || o?.enabled || this.hasDerivedData) && (l = !0))
                : a.push(t);
            }, this),
            l)
          )
          ...
          return (
            null !== h &&
              ...
              g.length &&
              ((this.xIncrement = r3(g)), this.autoIncrement()),
            !0
          );
        }
        dataColumnKeys() {
        ...
        setData(t, e = !0, i, s) {
          ...
          if (
            ...
            if (!e) {
              ...
              for (m = 0; m < k; m++) {
                let i = this.pointClass.prototype.applyOptions.apply({ series: this }, [
                  t[m],
                ]);
            ...
            for (
              ac(this.getColumn('y')[0]) && ai(14, !0, n),
                this.data = [],
        ...
        sortData(t) {
          let e = this,
            ...
            s = function (t, e) {
              return (
                (r8(e) &&
                  t.pointClass.prototype.optionsToObject.call({ series: t }, e)) ||
                {}
              );
            };
          return (
        ...
        cropData(t, e, i) {
          ...
          return { modified: new rz({ columns: r }), start: h, end: l };
        }
        generatePoints() {
          let t = this.options,
                ...
                : ((f = x[g]),
                  ...
                  f || void 0 === y
                    ? f &&
                      ...
                      (f.key = f.name ?? f.category))
                    : (x[g] = f = new o(this, y, s[m]))),
              f && ((f.index = n ? d + m : g), (l[m] = f)));
          if (((this.options.keys = h), x && (r !== (u = x.length) || n)))
            for (m = 0; m < u; m++)
              (m !== a || n || (m += r),
        ...
        getExtremes(t, e) {
          ...
          let b = { activeYData: d, dataMin: r5(d), dataMax: r3(d) };
          return (ar(this, 'afterGetExtremes', { dataExtremes: b }), b);
        }
        applyExtremes() {
        ...
        translate() {
          ...
          for (p = 0; p < a; p++) {
            ...
            ((a.plotX = ad((u = i.translate(y, !1, !1, !1, !0, n))) ? r9(x(u)) : void 0),
              ...
              ad(k) && void 0 !== a.plotX
                ? (t = ad((t = o.translate(k, !1, !0, !1, !0))) ? x(t) : void 0)
                : !ad(k) && c && (t = c),
              (a.plotY = t),
        ...
        markerAttribs(t, e) {
          ...
          return (
            ad(l) &&
              d &&
              (i.crisp &&
                (d[0] = r4(d[0], t.hasImage ? 0 : 'rect' === r ? s?.lineWidth || 0 : 1)),
              (a.x = d[0] - l),
              (a.y = d[1] - l)),
        ...
        pointAttribs(t, e) {
          ...
          return (
            ...
            (g = ag(
              ...
              l.lineWidth,
              g + ag(d.lineWidthPlus, l.lineWidthPlus, 0)
            )),
        ...
        destroy(t) {
          let e,
            ...
            s = this,
            o = s.chart,
            r = /AppleWebKit\/533/.test(r0.navigator.userAgent),
            a = s.data || [];
          for (
            ar(s, 'destroy', { keepEventsForUpdate: t }),
              this.removeEvents(t),
              (s.axisTypes || []).forEach(function (t) {
                ((i = s[t]),
                  i?.series && (ae(i.series, s), (i.isDirty = i.forceRedraw = !0)));
              }),
          ...
          return (
            ...
            r.addClass(
              'highcharts-' +
                ...
                this.type +
                '-series ' +
                (r8(this.colorIndex) ? 'highcharts-color-' + this.colorIndex + ' ' : '') +
          ...
          if ((this.kdTree || this.buildingKdTree || this.buildKDTree(i), this.kdTree))
            return (function t(e, i, s, o) {
              ...
              return (
                ...
                i[A] &&
                  p(Math.sqrt(w * w), k[h], M) &&
                  (k = c(k, t(e, i[A], s + 1, o), h)[0]),
                k
              );
            })(t, this.kdTree, l, l);
        }
        ...
        drawTracker() {
          let t = this,
            ...
            l = 'rgba(192,192,192,' + (rQ ? 1e-4 : 0.002) + ')',
            d = t.tracker;
          (d
            ? d.attr({ d: s })
            : t.graph &&
        ...
        addPoint(t, e, i, s, o) {
          ...
          (d.setRow(f, a, !0, { addColumns: !1 }),
            ...
            i &&
              (l[0] && l[0].remove
                ? l[0].remove(!1)
                : ([l, u].filter(r8).forEach((t) => {
                    t.shift();
                  }),
                  d.deleteRows(0))),
            !1 !== o && ar(this, 'addPoint', { point: f }),
            (this.isDirty = !0),
            (this.isDirtyData = !0),
            e && h.redraw(s));
        }
        ...
        update(t, e) {
          ar(this, 'update', { options: (t = at(t, this.userOptions)) });
          let i = this,
            s = i.chart,
            o = i.userOptions,
          ...
          ((u = u || r),
            g
              ? (p.push.apply(p, ax.keepPropsForPoints),
                !1 !== t.visible && p.push('area', 'graph'),
                i.parallelArrays.forEach(function (t) {
                  p.push(t + 'Data');
                }),
                t.data &&
                  (t.dataSorting && as(i.options.dataSorting, t.dataSorting),
          ...
          } else ai(17, !0, s, { missingModuleFor: u });
          if (
      ...
      class aX {
        ...
        update(t, e) {
          ...
          (this.setOptions(aI(!0, this.options, t)),
            ...
            az(e, !0) && i.redraw(),
            aB(this, 'afterUpdate', { redraw: e }));
        }
        colorizeItem(t, e) {
          let i = t.color,
            { area: s, group: o, label: r, line: a, symbol: n } = t.legendItem || {};
          if (
            ((t instanceof ay || t instanceof rd) &&
          ...
          ((t.color = i), aB(this, 'afterColorizeItem', { item: t, visible: e }));
        }
        positionItems() {
        ...
        positionItem(t) {
          ...
          if (e?.element) {
            let o = {
              ...
              n = () => {
                aB(this, 'afterPositionItem', { item: t });
              };
        ...
        renderItem(t) {
          ...
          (!y &&
            ...
            !this.baseline &&
              ...
              o.squareSymbol &&
                ((this.symbolWidth = az(o.symbolWidth, Math.max(this.symbolHeight, 16))),
              ...
              y.css({
                width:
                  Math.min(
                    ...
                    o.maxWidth ? aN(o.maxWidth, i.chartWidth) : 1 / 0
                  ) -
                  b +
                  'px',
              }),
        ...
        layoutItem(t) {
          let e = this.options,
            ...
            l =
              e.alignColumns && this.totalItemWidth > h ? this.maxItemWidth : t.itemWidth,
            d = t.legendItem || {};
          (s &&
            this.itemX - i + l > h &&
            ((this.itemX = i),
        ...
        getAllItems() {
          ...
          return (
            this.chart.series.forEach(function (e) {
              let i = e?.options;
              e &&
                az(i.showInLegend, !aO(i.linkedTo) && void 0, !0) &&
                (t = t.concat(
                  e.legendItem?.labels || ('point' === i.legendType ? e.data : e)
                ));
            }),
            aB(this, 'afterGetAllItems', { allItems: t }),
            t
          );
        }
        getAlignment() {
        ...
        proximatePositions() {
          ...
          for (let o of (this.allItems.forEach(function (t) {
            ...
            t.yAxis &&
              ...
              t.points &&
                (o = aL(a ? t.points : t.points.slice(0).reverse(), function (t) {
                  return aD(t.plotY);
                })),
              (r =
                this.itemMarginTop +
        ...
        render() {
          ...
          ((this.itemX = o),
            ...
            aW(
              r,
              (t, e) => (t.options?.legendIndex || 0) - (e.options?.legendIndex || 0)
            ),
            ...
            (n =
              (s.maxWidth
                ? Math.min(
                    ...
                    d,
                    aN(s.maxWidth, t.chartWidth) || 1 / 0
                  )
            ...
            n > 0 &&
              ...
              c[c.placed ? 'animate' : 'attr'](
                c.crisp.call({}, { x: 0, y: 0, width: n, height: h }, c.strokeWidth())
              ),
            l[a ? 'show' : 'hide'](),
        ...
        scroll(t, e) {
          ...
          (l > o && (l = o),
            l > 0 &&
              ...
              aG(
                () => {
                  aB(this, 'afterScroll', { currentPage: l });
                },
            ...
            i &&
              i
                ...
                .on('click', function (e) {
                  ...
                  (r.removeClass(h),
                    aB(s, 'itemClick', { browserEvent: e, legendItem: t }, i),
                    a
                      ? t.firePointEvent('legendItemClick', { browserEvent: e })
                      : n && aB(t, 'legendItemClick', { browserEvent: e }));
                });
        }
      ...
      class nx {
        ...
        init(t, e) {
          ne(this, 'init', { args: arguments }, function () {
            let i = nh(aU, t),
              s = i.chart,
            ...
            ((this.userOptions = a7({}, t)),
              ...
              (this.time = new tN(a7(i.time || {}, { locale: this.locale }), i.lang)),
        ...
        initSeries(t) {
          let e = this.options.chart,
            i = t.type || e.type,
            s = aQ[i];
          s || a8(17, !0, this, { missingModuleFor: i });
          let o = new s();
        ...
        createAxes() {
          ...
          for (let e of (ne(this, 'createAxes'), ['xAxis', 'yAxis']))
        ...
        layOutTitles(t = !0) {
          ...
          (['title', 'subtitle', 'caption'].forEach((t) => {
            let i = this[t],
              ...
              n = i?.textPxLength || 0;
            if (i && r) {
              ne(this, 'layOutTitle', { alignTo: a, key: t, textPxLength: n });
        ...
        getChartSize() {
          ...
          ((this.chartWidth = Math.max(0, e || s.width || 600)),
            (this.chartHeight = Math.max(
              0,
              np(i, this.chartWidth) || (o ? 400 : s.height)
            )),
            (this.containerBox = s));
        }
        temporaryDisplay(t) {
          ...
          if (t)
            for (; e?.style; )
              (e.hcOrigStyle && (a3(e, e.hcOrigStyle), delete e.hcOrigStyle),
                e.hcOrigDetached && (aZ.body.removeChild(e), (e.hcOrigDetached = !1)),
                (e = e.parentNode));
          else
            for (
              ;
              ...
              (aZ.body.contains(e) ||
                e.parentNode ||
                ((e.hcOrigDetached = !0), aZ.body.appendChild(e)),
              ('none' === ns(e, 'display', !1) || e.hcOricDetached) &&
                ((e.hcOrigStyle = {
        ...
        getContainer() {
          ...
          let l = a2('div', { id: o }, t, r);
          ((this.container = l),
            this.getChartSize(),
            h !== this.chartWidth &&
              ((h = this.chartWidth),
              this.styledMode || a3(l, { width: nd(i.style?.width, h + 'px') })),
          ...
          (delete e.pointer?.chartPosition,
            !e.exporting?.isPrinting &&
              ...
              ((s.width !== i.width || s.height !== i.height) &&
                (tx.clearTimeout(e.reflowTimeout),
        ...
        setChartSize(t) {
          ...
          ((this.plotLeft = e = Math.round(this.plotLeft)),
            ...
            t ||
              ...
              l.alignElements()),
            ne(this, 'afterSetChartSize', { skipAxes: t }));
        }
        resetMargins() {
        ...
        propFromSeries() {
          ...
          ['inverted', 'angular', 'polar'].forEach(function (a) {
            for (
              e = aQ[o.type], i = o[a] || (e && e.prototype[a]), t = r?.length;
              !i && t--;
            )
        ...
        linkSeries(t) {
          ...
          (i.forEach(function (t) {
            ...
            ne(this, 'afterLinkSeries', { isUpdating: t }));
        }
        renderSeries() {
          this.series.forEach(function (t) {
          ...
          t)) {
            ...
            if (
              ...
              if (
                (s.destroy(),
                o &&
                  nd(i.reserveSpace, !nr(t.crossing)) &&
        ...
        destroy() {
          ...
          ([
            ...
            o && ((o.innerHTML = ey.emptyHTML), nu(o), r && a9(o)),
            nl(e, function (t, i) {
              delete e[i];
            }));
        }
        ...
        warnIfCSSNotLoaded() {
          this.styledMode &&
            '0' !== aJ.getComputedStyle(this.container).zIndex &&
            a8(35, !1, this);
        }
        addSeries(t, e, i) {
          let s,
          ...
          return (
            t &&
              ((e = nd(e, !0)),
              ne(o, 'addSeries', { options: t }, function () {
                ((s = o.initSeries(t)),
                  (o.isDirtyLegend = !0),
                  o.linkSeries(),
                  s.enabledDataSorting && s.setData(t.data, !1),
                  ne(o, 'afterAddSeries', { series: s }),
                  e && o.redraw(i));
              })),
            s
          );
        ...
        showLoading(t) {
          ...
          (r ||
            ...
            a ||
              ((e.loadingSpan = a =
                a2('span', { className: 'highcharts-loading-inner' }, null, r)),
              a0(e, 'redraw', o)),
            (r.className = 'highcharts-loading'),
            ey.setElementHTML(a, nd(t, i.lang.loading, '')),
            !e.styledMode &&
              (a3(r, a7(s.style, { zIndex: 10 })),
              a3(a, s.labelStyle),
              e.loadingShown ||
                (a3(r, { opacity: 0, display: '' }),
                aF(
                  r,
        ...
        update(t, e, i, s) {
                ...
                (ng(t[e]).forEach(function (t, s) {
                  ...
                  (r && (o = n.get(t.id)),
                    !o &&
                      n[e] &&
                      (o = n[e][nd(t.index, s)]) &&
                      ((r && a5(o.options.id)) || o.options.isInternal) &&
                      (o = void 0),
          ...
          (a || (nr(p) && p !== n.chartWidth) || (nr(u) && u !== n.chartHeight)
            ? n.setSize(p, u, s)
            : nd(e, !0) && n.redraw(s),
            ne(n, 'afterUpdate', { options: t, redraw: e, animation: s }));
        }
        setSubtitle(t, e) {
        ...
        zoomOut() {
          ne(this, 'selection', { resetSelection: !0 }, () =>
        ...
        transform(t) {
          ...
          for (let t of e) {
            ...
            let T = t.chart.polar || t.isOrdinal ? 0 : f * A || 0,
              ...
              L = t.allExtremes;
            if (
              (r && r[t.coll].push({ axis: t, min: Math.min(C, P), max: Math.max(C, P) }),
              O > E && ([O, E] = [E, O]),
              ...
              for (let e of t.series) {
                ...
                (L ?? (L = { dataMin: Number.MAX_VALUE, dataMax: -Number.MAX_VALUE }),
                  nr(t.dataMin) &&
                    nr(t.dataMax) &&
                    ((L.dataMin = Math.min(t.dataMin, L.dataMin)),
            ...
            (!t.isOrdinal || 1 !== M || o) &&
              (O < U && ((O = U), M >= 1 && (E = O + X)),
              E > V && ((E = V), M >= 1 && (O = E - X)),
              (o || (t.series.length && (O !== I || E !== z) && O >= U && E <= V)) &&
                (r
                  ? r[t.coll].push({ axis: t, min: O, max: E })
                  : ((t.isPanning = 'zoom' !== n),
      ...
      function nP() {
        ...
        ((this.scrollablePixelsX || this.scrollablePixelsY) &&
          !t &&
          (this.scrollablePlotArea = t = new nE(this)),
          t?.applyFixed());
      }
      function nO() {
      ...
      class nE {
            ...
            if (
              (r
                ? ((t.scrollablePixelsX = i = Math.max(0, r - t.chartWidth)),
                  i &&
                    ((t.scrollablePlotBox = nT(t.plotBox)),
        ...
        constructor(t) {
          ...
          (t.scrollablePixelsX && (a.overflowX = 'auto'),
            ...
            (this.chart = t));
          const n = (this.parentDiv = nM(
              'div',
              { className: 'highcharts-scrolling-parent' },
              { position: 'relative' },
              t.renderTo
            )),
            h = (this.scrollingContainer = nM(
              'div',
              { className: 'highcharts-scrolling' },
              a,
              n
            )),
            l = (this.innerContainer = nM(
              'div',
          ...
          ((this.mask = c
            ...
            nw(t.renderTo, { overflow: 'visible' }),
          ...
          setOffset(t, e, i, s, o, r) {
            ...
            if (h && p) {
              let t = h.getBBox(void 0, 0),
                e = h.padding,
                i = 'justify' === nN(l.overflow, 'justify'),
                s;
              ((a.x = l.x || 0), (a.y = l.y || 0));
              ...
              ((p.x -= o),
                (p.y -= r),
                h.align(a, !1, p),
                (s = c.isInsidePlot(h.alignAttr.x + a.x + o, h.alignAttr.y + a.y + r)) ||
                  (i = !1),
          ...
          getStackBox(t) {
            let e = this.axis,
              ...
              p = Math.abs(
                l -
                  e.toPixels(
                    n || (nR(e.min) && e.logarithmic && e.logarithmic.lin2log(e.min)) || 0
                  )
              ),
              u = i.inverted,
              g = this.isNegative;
      ...
      function n1(t) {
        (this.is('column') || this.is('columnrange')) &&
          (this.options.centerInCategory && this.chart.series.length > 1
            ? nX.setStackedPoints.call(this, t, 'group')
      ...
      function n2(t, e) {
        ...
        if (!l || !this.reserveSpace() || ({ group: 'xAxis' }[l] || 'yAxis') !== t.coll)
          return;
        ...
        for (k.stacksTouched += 1, h = 0; h < u; h++) {
          ...
          ((n = (i = this.getStackIndicator(i, e, this.index)).key || ''),
            ...
            M[a][e] ||
              (w[a]?.[e]
                ...
                : (M[a][e] = new nW(t, t.options.stackLabels, !!s, e, x))),
            (o = M[a][e]),
            null !== u
              ? ((o.points[n] = o.points[this.index] = [n_(o.cumulative, m)]),
          ...
          ('percent' === l
            ...
            'group' === l
              ? (o.cumulative = (S || 1) - 1)
              : (o.cumulative = nF(n_(o.cumulative, m) + g)),
            (o.total = S),
            null !== u &&
      ...
      class n3 {
        ...
        resetStacks() {
          n$(this.stacks, (t) => {
            n$(t, (e, i) => {
              nV(e.touched) && e.touched < this.stacksTouched
          ...
          [this, ...this.zones].forEach((s, o) => {
            ...
            (a
              ...
              a &&
                ...
                a[n](r).shadow(
                  t.shadow &&
                    n9({ filterUnits: 'userSpaceOnUse' }, n4(t.shadow) ? t.shadow : {})
                )),
      ...
      ((n8.defaultOptions = n9(ay.defaultOptions, { legendSymbol: 'lineMarker' })),
        ...
        getGraphPath(t) {
          ...
          for (let o = 0, r = t.length; o < r; ++o)
            (a ||
              ...
              (!i || g) &&
                (g || f(o, o - 1, 'left'),
                (i && !a && g) || (l.push(t[o]), h.push({ x: o, plotX: e, plotY: s })),
                g || f(o, o + 1, 'right')));
      ...
      ((ho.defaultOptions = he(n7.defaultOptions, {
        ...
        ht(ho.prototype, { singleStacks: !1 }),
      ...
      class hP extends ay {
        ...
        getColumnMetrics() {
          ...
          let l = Math.min(
            ...
            p = Math.min(
              ...
              hT(e.pointWidth, c * (1 - 2 * e.pointPadding))
            ),
            u = (t.columnIndex || 0) + +!!r;
          return (
            (t.columnMetrics = {
        ...
        translate() {
          ...
          (i.pointPadding && i.crisp && (f = Math.ceil(f)),
            ...
            t.points.forEach(function (s) {
              let o = hT(s.yBottom, g),
                m = 999 + Math.abs(o),
                x = s.plotX || 0,
                y = hy(s.plotY, -m, a.len + m),
                b,
                v = Math.min(y, o),
                k = Math.max(y, o) - v,
                M = d,
        ...
        pointAttribs(t, e) {
          ...
          (t &&
            ...
            e &&
              t &&
              ((h = (a = hA(i.states[e], t.options.states?.[e] || {})).brightness),
      ...
      !(function (t) {
        ...
        function i(t, e, i, s, o) {
          let { chart: r, enabledDataSorting: a } = this,
            ...
            u =
              ...
              (t.series.forceDL ||
                (a && !p) ||
                c ||
                (hX(i.inside, !!this.options.stacking) &&
                  s &&
          ...
          if (u && g) {
            ...
            if (
              ((s = hD({ x: g[0], y: Math.round(g[1]), width: 0, height: 0 }, s || {})),
              'plotEdges' === i.alignTo &&
                this.isCartesian &&
                ((s[n ? 'x' : 'y'] = 0),
                (s[n ? 'width' : 'height'] = this.yAxis?.len || 0)),
              hD(i, { width: h.width, height: h.height }),
              (f = s),
        ...
        function s(t, e) {
          (hI(this, 'initDataLabelsGroup', { index: t, zIndex: e?.zIndex ?? 6 }),
        ...
        function r(t) {
          ...
          let i = this,
            ...
            g = u ? hE(s, p, i) : { defer: 0, duration: 0 };
              ...
              t.forEach((t) => {
                ...
                hF(n(c, t.dlOptions || t.options?.dataLabels)).forEach((n, l) => {
                  ...
                  let c =
                    ...
                    w;
                  (c &&
                    ((y = hB((x = hX(n[t.formatPrefix + 'Format'], n.format)))
                      ? hL(x, t, s)
                    ...
                    !s.styledMode &&
                      ((m.color = hX(
                        n.color,
                        m.color,
                        hN(i.color) ? i.color : void 0,
                        '#000000'
                      )),
                      'contrast' === m.color
                        ? ('none' !== p && (w = p),
                          (t.contrastColor = r.getContrast(
                            ('auto' !== w && hN(w) && w) || (hN(h) ? h : '')
                          )),
                          (m.color =
                            w || (!hB(f) && n.inside) || 0 > hH(f || 0) || o.stacking
                              ? t.contrastColor
                              : d))
                    ...
                    !k ||
                      (c &&
                        ...
                        ((k.rotation && n.rotation) || k.rotation === n.rotation)) ||
                      ((k = void 0), (M = !0)),
                    c &&
                      hB(y) &&
                      '' !== y &&
                      ...
                      k &&
                        ...
                        hI(k, 'beforeAddingDataLabel', { labelOptions: n, point: t }),
                        k.added || k.add(e),
        ...
        function a(t, e, i, s, o, r) {
          ...
          return (
            (m = (i.x || 0) + l + c) < 0 &&
              ('right' === n && g >= 0 ? ((e.align = 'left'), (e.inside = !0)) : (g -= m),
              (x = !0)),
        ...
        function n(t, e) {
          ...
          if (hR(t) && !hR(e))
            ...
            if (hR(t) && hR(e))
              for (s = Math.max(t.length, e.length); s--; ) i[s] = hW(t[s], e[s]);
          } else i = hW(t, e);
          return i;
        }
        function h(t) {
          ...
          return hF(
            n(n(e?.series?.dataLabels, e?.[t.type]?.dataLabels), t.options.dataLabels)
          );
        }
              ...
              ['x', 'y'].forEach(function (r, a) {
                if (e[r] && !s.isNull) {
                  ...
                  if (h && !h.logarithmic) {
                    ...
                    ((s[n] =
                      e + (d - e) * ((t = 1e4 * Math.sin(o + a * i)) - Math.floor(t))),
      ...
      (((x = I || (I = {})).getCenter = function () {
        ...
        for (!e.angular || this instanceof ay || (u[3] = 0), c = 0; c < 4; ++c)
          ((p = u[c]),
            (h = c < 2 || (2 === c && /%$/.test(p))),
        ...
        return (
          ...
          h9(this, 'afterGetCenter', { positions: u }),
          u
        );
      }),
        (x.getStartAndEndRadians = function (t, e) {
          ...
          return { start: h6 * (i + -90), end: h6 * (s + -90) };
        }));
      let lt = I,
        { setAnimation: le } = eo,
        {
      ...
      !(function (t) {
        ...
        function s() {
          ...
          t.visible &&
                    ...
                    if (x) {
                      if (
                        (u &&
                          ...
                          (void 0 === m.pos
                            ? (S = 'hidden')
                            : ((f = m.size), (w = p.radialDistributionY(i, l)))),
                        d.justify)
                      )
                        M = p.justify(i, l, h, n);
                      else
                      ...
                      if (
                        ...
                        (x.posAttribs = {
                          x: M + (d.x || 0) + ({ left: b, right: -b }[x.alignment] || 0),
                          y: w + (d.y || 0) - v / 2,
                        }),
                        (x.computed.x = M),
                        (x.computed.y = w - k),
                        ...
                        (M - (g = l.getBBox().width) < b && 1 === a
                          ...
                          w - f / 2 < 0
                            ? (c[0] = Math.max(Math.round(-w + f / 2), c[0]))
                            : w + f / 2 > o &&
                              (c[2] = Math.max(Math.round(w + f / 2 - o), c[2])),
                          (x.sideOverflow = t));
                      }
                    }
                  });
            ...
            (0 === lk(c) || this.verifyDataLabelOverflow(c)) &&
                    ...
                    ((u = s.connector),
                      n && n.distance > 0
                        ? ((h = !u),
                          ...
                          u[h ? 'attr' : 'animate']({ d: e.getConnectorPath(s) }),
        ...
        function r(t) {
          ...
          return (
            !a &&
              ...
              null !== s[1]
                ? (r = lM(r, o, e[2] - Math.max(t[0], t[2])))
                : ((r = lM(r, o, e[2] - t[0] - t[2])), (e[1] += (t[0] - t[2]) / 2)),
              r < e[2]
                ? ((e[2] = r),
                  (e[3] = Math.min(
                    i.thickness
                      ? Math.max(0, r - 2 * i.thickness)
                      : Math.max(0, lC(i.innerSize || 0, r)),
                    r
                  )),
                  this.translate(e),
            ...
            t.oldOpacity !== i &&
              (t.hasClass('highcharts-data-label')
                ? (t[i ? 'removeClass' : 'addClass']('highcharts-data-label-hidden'),
                  ...
                  lB(e, 'afterHideOverlappingLabel'))
                : t.attr({ opacity: i })),
            (t.isOld = !0)),
          s
        );
      ...
      let { defaultOptions: lR } = tY,
        ...
        lY = { radius: 0, scope: 'stack', where: void 0 },
        lj = lN,
        lU = lN;
      function lV(t, e, i, s, o = {}) {
        ...
        let p = c - d,
          u = Math.sin(p / 2),
          g = Math.max(
            Math.min(lF(o.borderRadius || 0, l - h), (l - h) / 2, (l * u) / (1 + u)),
            0
          ),
        ...
        if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
          ...
          for (let s of this.points) {
            ...
            if ('roundedRect' === s.shapeType && a) {
              ...
              ('end' === u && (p && (d -= g), (c += g)),
                lG(a, { brBoxHeight: c, brBoxY: d, r: g }));
            }
          }
        }
      }
      function l_(t, e) {
        return (lX(t) || (t = { radius: t || 0 }), lH(lY, e, t));
      }
      function lZ() {
      ...
      function l3(t, e) {
        ...
        (
          ...
          function () {
            return (
              this.chartWidth <= l1(i.maxWidth, Number.MAX_VALUE) &&
              this.chartHeight <= l1(i.maxHeight, Number.MAX_VALUE) &&
              this.chartWidth >= l1(i.minWidth, 0) &&
              this.chartHeight >= l1(i.minHeight, 0)
            );
          }
      ...
      (N || (N = {})).compose = function (t) {
        let e = t.prototype;
        return (
          e.matchResponsiveRule || lJ(e, { matchResponsiveRule: l3, setResponsive: l5 }),
          t
        );
      };
      let l6 = N;
      ((V.AST = ey),
        ...
        (V.timers = t3.timers),
        {
          compose: function (t, e, i) {
            ...
            if (!e.symbolCustomAttribs.includes('borderRadius')) {
              ...
              (lW(t, 'afterColumnTranslate', l$, { order: 9 }),
        ...
        aH.compose(V.Chart),
        ou.compose(V.Axis),
        (l = (b = V.Chart).prototype).hideOverlappingLabels ||
          ((l.hideOverlappingLabels = function (t) {
            let e = t.length,
              i = (t, e) =>
                !(
                  e.x >= t.x + t.width ||
              ...
              s = (t, e) => {
                for (let i of t) if (lO({ x: i[0], y: i[1] }, e)) return !0;
                return !1;
              },
              o,
              r,
                      ...
                      (s.dataLabels || []).forEach((i) => {
                        ...
                        ((i.labelrank = lI(
                          ...
                          (o.allowOverlap ?? Number(o.distance) > 0)
                            ? ((i.oldOpacity = i.opacity), (i.newOpacity = 1), lz(i, t))
                            : e.push(i));
                      });
                };
      ...
      !(function (t) {
          ...
          !this.isXAxis &&
            (this.series.forEach(function (i) {
              'compare' === t && 'boolean' != typeof e
                ? i.setCompare(e, !1)
                : 'cumulative' !== t || dr(e) || i.setCumulative(e, !1);
            }),
          ...
          let e = this,
            ...
            s = function (s) {
              t = t.replace(
                '{point.' + s + '}',
                (e[s] > 0 && 'change' === s ? '+' : '') +
                  i(e[s], da(e.series.tooltipOptions.changeDecimals, 2))
              );
            };
          return (
            de(e.change) && s('change'),
        ...
        function s() {
          ...
          if (e) {
            ...
            t instanceof ay &&
              (this.options.compare = da(this.userOptions.compare, t.options.compare));
          }
        ...
        function o(t) {
          ...
          if (this.dataModify && e) {
            ...
            (this.options.compare
              ...
              t && ((e.dataMin = l7(t)), (e.dataMax = l8(t))));
          }
        }
        function r(t, e) {
              ...
              if (void 0 !== e && void 0 !== s) {
                if (
                  ('value' === t
                    ? (e -= s)
                    : (e =
                        (e / s) * 100 - 100 * (100 !== this.series.options.compareBase)),
                  void 0 !== i)
                ) {
          ...
          initCumulative() {
            this.modifyValue = function (t, e) {
              if ((null === t && (t = 0), void 0 !== t && void 0 !== e)) {
                ...
                return (
                  s && (!o || r ? (s.cumulativeSum = t) : (s.cumulativeSum = void 0)),
                  t
                );
              }
              return 0;
      ...
      function dg() {
        ...
        if (o) {
          ...
          (this.inverted
            ...
            : ((o.left = dc(e.left, this.plotLeft + a)),
              (o.top =
      ...
      function dx() {
        ...
        if (
          ...
          ((!dh && 'x' === this.zooming.type) || (dh && 'x' === this.zooming.pinchType))
        )
          return !1;
      }
      function dy(t) {
      ...
      !(function (t) {
        ...
        function i(t) {
          ...
          return {
            axisMin: e,
            axisMax: i,
            scrollMin: dZ(t.dataMin)
              ? Math.min(e, t.min ?? 1 / 0, t.dataMin, t.threshold ?? 1 / 0)
              : e,
            scrollMax:
              t.treeGrid?.adjustedMax ??
              (dZ(t.dataMax)
                ? Math.max(i, t.max ?? -1 / 0, t.dataMax, t.threshold ?? -1 / 0)
                : i),
          };
        }
        function s() {
            ...
            d$(t.scrollbar, 'changed', function (e) {
              ...
              if (dZ(r) && dZ(a))
                if (
                  ...
                  let i =
                    'mousemove' !== e.DOMType && 'touchmove' !== e.DOMType && void 0;
          ...
          if (a && h) {
            ...
            if (
              ...
              isNaN(o) ||
                ...
                !dZ(this.min) ||
                !dZ(this.max) ||
                (dZ(this.dataMin) && this.dataMin === this.dataMax))
            )
              a.setRange(0, 1);
      ...
      class cs {
        static compose(t) {
          (dJ.compose(t, cs), ce(d1, 'Scrollbar') && d4(d0, { scrollbar: dQ }));
        }
        static swapXY(t, e) {
          return (
            e &&
        ...
        buttonToMaxClick(t) {
          let e = (this.to - this.from) * ct(this.options.step, 0.2);
        ...
        buttonToMinClick(t) {
          let e = d3(this.to - this.from) * ct(this.options.step, 0.2);
        ...
        drawScrollbarButton(t) {
          ...
          if ((i.push(r), s.buttonsEnabled)) {
            ...
            (this.chart.styledMode ||
              ...
              a.attr(
                a.crisp(
                  { x: -0.5, y: -0.5, width: o, height: o, r: s.buttonBorderRadius },
                  a.strokeWidth()
                )
              ));
            let n = e
        ...
        render() {
          ...
          (this.track.attr({ x: -d5(0, r), y: -d5(0, r) }),
            ...
            this.scrollbarGroup.translate(
              -d5(0, this.scrollbarStrokeWidth),
              -d5(0, this.scrollbarStrokeWidth)
            ),
        ...
        setRange(t, e) {
          ...
          ((this.from = t),
            (this.to = e),
            r
              ? (this.scrollbarGroup[h]({ translateY: d }),
                this.scrollbar[h]({ height: s }),
                this.scrollbarRifles[h]({ translateY: c }),
                (this.scrollbarTop = d),
                (this.scrollbarLeft = 0))
              : (this.scrollbarGroup[h]({ translateX: d }),
                this.scrollbar[h]({ width: s }),
                this.scrollbarRifles[h]({ translateX: c }),
        ...
        shouldUpdateExtremes(t) {
          return (
            ct(
              ...
              V.svg && !V.isTouchDevice && !this.chart.boosted
            ) ||
            'mouseup' === t ||
            'touchend' === t ||
            !d6(t)
      ...
      class cw {
            ...
            ([!i, i, !i].forEach((i, o) => {
              let h =
                ...
                (t.shades[o] = r
                  .rect()
                  .addClass(
                    'highcharts-navigator-mask' + (1 === o ? '-inside' : '-outside')
                  )
                  .add(n));
              s.styledMode ||
                (h.attr({ fill: i ? e.maskFill : 'rgba(0,0,0,0)' }), 1 === o && h.css(a));
            }),
            t.outline ||
              (t.outline = r.path().addClass('highcharts-navigator-outline').add(n)),
            s.styledMode ||
              t.outline.attr({ 'stroke-width': e.outlineWidth, stroke: e.outlineColor }),
            e.handles?.enabled)
          ) {
            let i = e.handles,
              { height: o, width: h } = i;
            [0, 1].forEach((e) => {
              ...
              if (t.handles[e] && t.handles[e].symbolUrl === l) {
                if (!t.handles[e].isImg && t.handles[e].symbolName !== l) {
                  ...
                  (t.handles[e].attr({ d: i }), (t.handles[e].symbolName = l));
                }
              } else
                (t.handles[e]?.destroy(),
        ...
        update(t, e = !1) {
          ...
          if (
            ...
            (this.xAxis.update(
              ...
              this.yAxis.update(
                { ...t.yAxis, [i.inverted ? 'width' : 'height']: this.height },
                !1
              ));
          }
          e && i.redraw();
            ...
            this.scrollbar &&
              (d
                ? ((m = this.top - u),
                  ...
                  (x = y + 2 * u))
                : ((m = this.top + (h ? this.height : -x)), (f = this.left - u)),
        ...
        addMouseEvents() {
          ...
          ((t.mouseMoveHandler = o =
            ...
            (s = t.getPartsEvents('mousedown')).push(
              cn(e.renderTo, 'mousemove', o),
              cn(i.ownerDocument, 'mouseup', r),
              cn(e.renderTo, 'touchmove', o),
              cn(i.ownerDocument, 'touchend', r)
            ),
            ...
            t.series &&
              t.series[0] &&
              s.push(
                cn(t.series[0].xAxis, 'foundExtremes', function () {
          ...
          (i.inverted && ((h = t.chartY), (n = this.top)),
            1 === e
              ...
              : ((p = h - n - a / 2),
                ...
                p !== o &&
                  ((this.fixedWidth = a),
                  cd((c = s.navigatorAxis.toFixedRange(p, p + a, d, l)).min) &&
                    cf(this, 'setRange', {
        ...
        onMouseMove(t) {
          ...
          (!t.touches || 0 !== t.touches[0].pageX) &&
            ...
            e.hasDragged &&
              e.scrollbar &&
              cb(e.scrollbar.options.liveRedraw, !cr && !this.chart.boosted) &&
              ((t.DOMType = t.type),
              setTimeout(function () {
                e.onMouseUp(t);
              }, 0)));
        ...
        onMouseUp(t) {
          ...
          (((this.hasDragged && (!l || !l.hasDragged)) || 'scrollbar' === t.trigger) &&
            ...
            cd(
              (a = h.navigatorAxis.toFixedRange(this.zoomedMin, this.zoomedMax, o, r)).min
            ) &&
              cf(this, 'setRange', {
        ...
        init(t) {
          ...
          let l = this,
            ...
            c = t.xAxis.length,
            p = t.yAxis.length,
            u = (d && d[0] && d[0].xAxis) || t.xAxis[0] || { options: {} };
          if (((t.isDirtyBox = !0), l.navigatorEnabled)) {
            ...
            ((l.xAxis = new oo(
              ...
              cy(
                ...
                t.inverted ? { offsets: e, width: a } : { offsets: e, height: a }
              ),
              'xAxis'
            )),
              (l.yAxis = new oo(
              ...
              d || i.series.data
                ...
                : 0 === t.series.length &&
                  (l.unbindRedraw = cn(t, 'beforeRedraw', function () {
                    t.series.length > 0 &&
                      !l.series &&
                      (l.setBaseSeries(), l.unbindRedraw());
                  })),
              (l.reversedExtremes =
            ...
            ((l.xAxis = {
              ...
              (l.xAxis.navigatorAxis.toFixedRange = dO.prototype.toFixedRange.bind(
                l.xAxis.navigatorAxis
              )));
          if (t.options.scrollbar?.enabled) {
            let e = cy(t.options.scrollbar, { vertical: t.inverted });
          ...
          return (
            (t && null === i.dataMin) ||
              (e = {
                dataMin: cb(
                  s.parse(r?.min),
                  cM('min', s.parse(a.min), i.dataMin, o.dataMin, o.min)
                ),
                dataMax: cb(
                  s.parse(r?.max),
                  cM('max', s.parse(a.max), i.dataMax, o.dataMax, o.max)
                ),
              }),
            e
          );
        ...
        setBaseSeries(t, e) {
          ...
          ((t =
            ...
            (i.series.length ? cg(i.series, (t) => !t.options.isInternal).index : 0)),
          ...
          let i = this,
            ...
            a = (i.series = (i.series || []).filter((t) => {
              ...
              return (
                !(0 > o.indexOf(e)) ||
                (e &&
                  (cv(e, 'updatedData', i.updatedDataHandler), delete e.navigatorSeries),
                t.chart && t.destroy(),
                !1)
              );
            })),
          ...
          (o &&
            ...
            o.forEach((t) => {
              ...
              ((r.name = 'Navigator ' + o.length),
                ...
                ((h = cy(n, r, p, d)).pointRange = cb(
                  p.pointRange,
                  d.pointRange,
                  co.plotOptions[h.type || 'line'].pointRange
                )));
              let u = d.data || p.data;
            ...
            ((l.data && !(o && o.length)) || cm(l)) &&
              ...
              (l = ck(l)).forEach((t, e) => {
                ((r.name = 'Navigator ' + (a.length + 1)),
                  ...
                  h.data && ((i.hasNavigatorData = !0), a.push(s.initSeries(h))));
              })),
        ...
        addBaseSeriesEvents() {
          ...
          (e[0] &&
            ...
            e[0].eventsToUnbind.push(
              cn(e[0].xAxis, 'foundExtremes', this.modifyBaseAxisExtremes)
            ),
            e.forEach((i) => {
              (i.eventsToUnbind.push(
                ...
                !1 !== this.navigatorOptions.adaptToUpdatedData &&
                  i.xAxis &&
                  i.eventsToUnbind.push(cn(i, 'updatedData', this.updatedDataHandler)),
                i.eventsToUnbind.push(
                  cn(i, 'remove', function () {
                    (e && cp(e, i),
                      this.navigatorSeries &&
                        t.series &&
                        (cp(t.series, this.navigatorSeries),
                        cd(this.navigatorSeries.options) &&
        ...
        modifyBaseAxisExtremes() {
          let t,
            ...
            l = i.stickToMin,
            d = i.stickToMax,
            c = cb(this.ordinal?.convertOverscroll(this.options.overscroll), 0),
        ...
        addChartEvents() {
          (this.eventsToUnbind || (this.eventsToUnbind = []),
            this.eventsToUnbind.push(
              cn(this.chart, 'redraw', function () {
                let t = this.navigator,
                  e =
                    t &&
                    ((t.baseSeries && t.baseSeries[0] && t.baseSeries[0].xAxis) ||
                      this.xAxis[0]);
        ...
        destroy() {
          (this.removeEvents(),
            this.xAxis &&
              (cp(this.chart.xAxis, this.xAxis), cp(this.chart.axes, this.xAxis)),
            this.yAxis &&
              (cp(this.chart.yAxis, this.yAxis), cp(this.chart.axes, this.yAxis)),
            (this.series || []).forEach((t) => {
              t.destroy && t.destroy();
            }),
            [
        ...
        function e(t, i, s, o, r = [], a = 0, n) {
          ...
          if (n && cC(l)) {
            let t = y.length,
              ...
              c = t;
            for (; c--; )
              ((r = this.translate(y[c])), a && (i[c] = a - r), (e[c] = a = r));
            for (
              i.sort((t, e) => t - e),
        ...
        function l(t) {
          ...
          if (
            ...
            let o,
              ...
              f = Math.round((n - s) / (e.translationSlope * (e.ordinal.slope || g))),
              m = e.ordinal.getExtendedPositions(),
              x = { ordinal: { positions: m, extendedOrdinalPositions: m } },
              y = e.index2val,
              b = e.val2lin;
            ...
            x.ordinal.positions
              ? Math.abs(f) > 1 &&
                ...
                i &&
                  (a = x.ordinal.positions =
                    a.concat(e.ordinal.getOverscrollPositions())),
                ...
                (o = e.navigatorAxis.toFixedRange(
                  ...
                  e.setExtremes(o.min, o.max, !0, !1, { trigger: 'pan' }),
                (this.mouseDownX = s),
                cT(this.container, { cursor: 'move' }))
              : (r = !0);
          } else r = !0;
          r || (o && /y/.test(o.type))
            ? i && cO(e.dataMax) && (e.max = e.dataMax + i)
            : t.preventDefault();
        }
        function d() {
          let t = this.xAxis;
          t?.options.ordinal &&
            (delete t.ordinal.index, delete t.ordinal.originalOrdinalRange);
        }
        function c(t, e) {
          let i,
            s = this.ordinal,
              ...
              let t = this.axis,
                ...
                n =
                  (t.options.overscroll &&
                    t.ordinal.convertOverscroll(t.options.overscroll)) ||
                  0,
                h,
                l,
                d,
                ...
                !d[r] &&
                  (((h = {
                    ...
                    getExtremes: function () {
                      return { min: n.dataMin, max: n.dataMax + a };
                    },
                  ...
                  i.series.forEach((i) => {
                    ...
                    ((l.dataTable = new rz({ columns: { x: s } })),
                      (l.options = {
                        ...i.options,
                  ...
                  h.applyGrouping({ hasExtremesChanged: !0 }),
                  l?.closestPointRange !== l?.basePointRange &&
                    l.currentDataGrouping &&
                    (h.forceOrdinal = !0),
                  i.ordinal.beforeSetTickPositions.apply({ axis: h }),
                ...
                s = function (t) {
                  return (
                    cE(
                      ...
                      cC(i.dataMax) && cC(i.dataMin) ? i.dataMax - i.dataMin : 0
                    ) * t
                  );
                };
              if (cB(t)) {
      ...
      function cQ(t) {
        ...
        if (
          ...
          (r.options.floating ||
            ...
            (this.extraBottomMargin !== i || this.extraTopMargin !== o) &&
              (this.isDirtyBox = !0));
        }
      }
      ...
      class ph {
        ...
        clickButton(t, e) {
          let i = this.chart,
            ...
            l = r.dataMax,
            d,
            c = pe(o?.max) ? Math.round(Math.min(o.max, l ?? o.max)) : void 0,
            p,
            u = s._range,
            g,
            f,
          ...
          if (null !== h && null !== l) {
            if (
              ...
              n &&
                ...
                oo.prototype.setDataGrouping.call(o || { chart: this.chart }, n, !1),
                (this.frozenStates = s.preserveDataGrouping)),
              'month' === a || 'year' === a)
            )
              o
                ? ((f = { range: s, max: c, chart: i, dataMin: h, dataMax: l }),
                  (d = o.minFromRange.call(f)),
                  pe(f.newMax) && (c = f.newMax),
                  (x = !1))
                : (u = s);
            else if (u)
              pe(c) && ((c = Math.min((d = Math.max(c - u, h)) + u, l)), (x = !1));
            else if ('ytd' === a)
              if (o)
                (!o.hasData() ||
                  (pe(l) && pe(h)) ||
                  ...
                  i.series.forEach((t) => {
                    let e = t.getColumn('x');
                    e.length &&
                      ((h = Math.min(e[0], h)), (l = Math.max(e[e.length - 1], l)));
                  }),
                  (e = !1)),
                  pe(l) &&
                    pe(h) &&
                    ((d = g = (m = this.getYTDExtremes(l, h)).min), (c = m.max)));
              else {
          ...
          ((e.chart = t),
            ...
            (e.buttonOptions = o.map(
              (t) => (
                ...
                (t.text = c2(t.text, { count: t.count || 1 })),
                (t.title = c2(t.title, { count: t.count || 1 })),
                t
              )
            )),
            (this.eventsToUnbind = []),
            ...
            this.eventsToUnbind.push(
              c3(t, 'load', function () {
                t.xAxis &&
                  t.xAxis[0] &&
                  c3(t.xAxis[0], 'setExtremes', function (i) {
                    pe(this.max) &&
                      pe(this.min) &&
        ...
        updateButtonStates() {
          ...
          (t.buttonOptions.forEach((e, i) => {
            ...
            if ((k && M && (b = !0), o.isOrdinal && o.ordinal?.positions && s && r < s)) {
              ...
              ('month' === h || 'year' === h) &&
              r + 36e5 >= { month: 28, year: 365 }[h] * n * c - y &&
              r - 36e5 <= { month: 31, year: 366 }[h] * n * c + y
                ? (A = !0)
                : 'ytd' === h
                  ? ((A = u - p + y === r), (S = !k))
            ...
            null !== v
              ...
              : (t.setSelected(),
                ...
                s &&
                  (s.setState(0),
                  s.attr({ text: (c1.lang.rangeSelectorZoom || '') + ' ▾' }))));
          for (let e = 0; e < m.length; e++) {
            ...
            if (r.state !== o && (r.setState(o), i)) {
              ((i.options[e + 1].disabled = 3 === o),
                2 === o &&
                  (s && (s.setState(2), s.attr({ text: t.buttonOptions[e].text + ' ▾' })),
                  (i.selectedIndex = e + 1)));
              let r = s.getBBox();
              c6(i, { width: `${r.width}px`, height: `${r.height}px` });
            }
          }
        }
        ...
        hideInput(t) {
          let e = 'min' === t ? this.minInput : this.maxInput;
          e && c6(e, { top: '-9999em', border: 0, width: '1px', height: '1px' });
        }
        ...
        drawInput(t) {
          ...
          function d(t) {
            ...
            pe(c) &&
              ...
              (l && i && pe(n)
                ...
                : s &&
                  pe(h) &&
                  (c < Number(s.getAttribute('data-hc-time'))
                    ? (c = void 0)
                    : c > h && (c = h)),
              void 0 !== c &&
          ...
          let c = h[l ? 'rangeSelectorFrom' : 'rangeSelectorTo'] || '',
            p = a
              ...
              .attr({ padding: 2 * !!c, height: c ? n.inputBoxHeight : 0 })
              .add(s),
            u = a
              .label('', 0)
          ...
          (e.styledMode || u.attr({ stroke: n.inputBoxBorderColor, 'stroke-width': 1 }),
            u.add(s));
          let g = c5(
            'input',
          ...
          (g.setAttribute('type', pn(n.inputDateFormat || '%e %b %Y')),
            e.styledMode ||
              (p.css(ps(r, n.labelStyle)),
              u.css(ps({ color: '#333333' }, r, n.inputStyle)),
              c6(
                g,
                c7(
                  {
          ...
          return (
            ...
            (g.onkeydown = (e) => {
              ((f = !0),
                ('ArrowUp' === e.key || 'ArrowDown' === e.key || 'Tab' === e.key) &&
                  d(t));
            }),
            (g.onkeyup = () => {
              f = !1;
            }),
            { dateBox: u, input: g, label: p }
          );
        }
        getPosition() {
          let t = this.chart,
        ...
        renderButtons() {
          ...
          (c3(n, l, () => {
            ...
            c5('option', { textContent: this.zoomText.textStr, disabled: !0 }, void 0, n),
            this.createButtons());
        }
        createButtons() {
          let { options: t } = this,
        ...
        createButton(t, e, i, s) {
          let { dropdown: o, buttons: r, chart: a, options: n } = this,
            h = a.renderer,
            l = ps(n.buttonTheme);
          (o?.add(c5('option', { textContent: t.title || t.text }), e + 2),
            (r[e] = h
              .button(
                t.text ?? '',
                0,
              ...
              .attr({ 'text-align': 'center', width: i })
              .add(this.buttonGroup)),
        ...
        alignElements() {
          ...
          if (s && l && d) {
            ...
            (r.inputEnabled &&
              ...
              o.align(
                { y: d.y, width: o.getBBox().width, align: d.align, x: d.x + n - 2 },
                !0,
                i.spacingBox
              ),
              ...
              m =
                ...
                (f =
                  ...
                  (t && 'bottom' === t.verticalAlign && t.enabled && !t.floating
                    ? i.legend.legendHeight + pr(t.margin, 10)
                    : 0) -
                  20) -
                (r.floating ? 0 : r.y) -
            ...
            ('top' === c
              ...
              : 'middle' === c &&
                (d.y === l.y
                  ? (m = g)
                  : (d.y || l.y) &&
                    (d.y < 0 || l.y < 0 ? (m -= Math.min(d.y, l.y)) : (m = g - f))),
        ...
        redrawElements() {
          ...
          if (
            (this.maxDateBox?.attr({ height: e }),
            this.minDateBox?.attr({ height: e }),
            t.styledMode ||
              (this.maxDateBox?.attr({ stroke: i }),
              this.minDateBox?.attr({ stroke: i })),
            this.isDirty)
          ) {
        ...
        alignButtonGroup(t, e) {
          ...
          ('right' === n.align
            ? ((l += t - h),
              this.hasVisibleDropdown &&
                (d = i.chartWidth + t - this.maxButtonWidth() - 20))
            : 'center' === n.align &&
              ((l -= h / 2),
              this.hasVisibleDropdown && (d = i.chartWidth / 2 - this.maxButtonWidth())),
            r && c6(r, { left: d + 'px', top: o?.translateY + 'px' }),
            a?.attr({ x: d }),
            o &&
              o.align(
                {
        ...
        positionButtons() {
          ...
          s &&
            'hidden' !== s.visibility &&
            (s[o]({ x: pr(a + r.x, a) }), (n += r.x + s.getBBox().width + 5));
          for (let e = 0, s = this.buttonOptions.length; e < s; ++e)
            'hidden' !== t[e].visibility
              ? (t[e][o]({ x: n }), (n += (t[e].width || 0) + i.buttonSpacing))
              : t[e][o]({ x: a });
        }
        handleCollision(t) {
          let {
          ...
          (s && i
            ? n.align === r.align
              ? (h(),
                o > e.plotWidth + t - 20 ? this.collapseButtons() : this.expandButtons())
        ...
        showDropdown() {
          ...
          t &&
            i &&
            (e.show(), c6(i, { visibility: 'inherit' }), (this.hasVisibleDropdown = !0));
        }
        hideDropdown() {
          let { dropdown: t } = this;
          t &&
            (this.dropdownLabel.hide(),
            c6(t, { visibility: 'hidden' }),
        ...
        destroy() {
          let t = this,
            ...
            i = t.maxInput;
          (t.eventsToUnbind &&
            (t.eventsToUnbind.forEach((t) => t()), (t.eventsToUnbind = void 0)),
            c4(t.buttons),
            ...
            po(
              ...
              function (e, i) {
                (e &&
                  ...
                  (e instanceof ic
                    ? e.destroy()
                    : e instanceof window.HTMLElement && c8(e),
                  delete t[i]),
      ...
      class pA extends ny {
        init(t, e) {
          ...
          let a = pv(
            {
              ...
              navigator: { enabled: r },
              scrollbar: { enabled: pk(dQ.enabled, !0) },
              rangeSelector: { enabled: pk(cz.enabled, !0) },
              title: { text: null },
              tooltip: { split: pk(i.tooltip?.split, !0), crosshairs: !0 },
              legend: { enabled: !1 },
            },
            t,
            { isStock: !0 }
          ...
          ((t.xAxis = s),
            (t.yAxis = o),
            (a.xAxis = pM(t.xAxis || {}).map((e) =>
              pv(pw('xAxis', e, i.xAxis), e, pS('xAxis', t))
            )),
        ...
        createAxis(t, e) {
          return (
            (e.axis = pv(pw(t, e.axis, pd()[t]), e.axis, pS(t, this.userOptions))),
      ...
      (pp(ny, 'update', function (t) {
        ...
        'scrollbar' in e &&
          this.navigator &&
          (pv(!0, this.options.scrollbar, e.scrollbar),
          this.navigator.update({ enabled: !!this.navigator.navigatorEnabled }),
          delete e.scrollbar);
      }),
        (function (t) {
          function e(t) {
            ...
            (!u &&
              ...
              o
                ? ((g = d ? (p.plotX || 0) + a : c.chartX),
                  (f = n + (r ? 0 : this.height)))
                : ((g = a + this.offset + (r ? h : 0)),
            ...
            let w = d
                ? this.isXAxis
                  ? p.x
                  : p.y
                : this.toValue(o ? c.chartX : c.chartY),
              S = p?.series ? p.series.isPointInside(p) : py(w) && w > v && w < k,
              A = '';
            (m
              ? (A = pl(m, { value: w }, e))
              : s.formatter && py(w) && (A = s.formatter.call(this, w)),
              u.attr({ text: A, x: g, y: f, visibility: S ? 'inherit' : 'hidden' }));
            let T = u.getBBox();
            (!py(u.x) || o || r || (g = u.x - T.width / 2),
              py(u.y) &&
                (o
                  ? ((l && !r) || (!l && r)) && (f = u.y - T.height)
                  : (f = u.y - T.height / 2)),
              (y = o
          ...
          function r(t) {
            ...
            if (i.options.isStock && ('xAxis' === this.coll || 'yAxis' === this.coll)) {
              ...
              (m = this.options[f]),
              (p =
                a && !this.options.isInternal
                  ? d.filter((t) => !t.options.isInternal)
                  : py(m)
                    ? [i[f][m]]
                    : pb(m)
                      ? [i.get(m)]
              ...
              p))
                -1 !== u.indexOf(t) ||
                  px(u, (e) => e.pos === t.pos && e.len === t.len) ||
                  u.push(t);
              if (py((g = pk(h, this.translate(l || 0, void 0, void 0, t.old))))) {
                let t,
                  e = s ? g + this.pos : this.pos + this.len - g;
                if (
                  ('pass' !== n &&
                    (e < this.pos || e > this.pos + this.len) &&
                    (n ? (e = pu(e, this.pos, this.pos + this.len)) : (t = !0)),
                  !t)
                ) {
                  let t = s ? 'top' : 'left',
                    i = s ? 'height' : 'width';
      ...
      class pD extends pP {
        ...
        drawSinglePoint(t) {
          ...
          void 0 !== t.plotY &&
            ...
            o[!o ? 'attr' : 'animate']({ d: s }).addClass(t.getClassName(), !0));
        }
        drawPoints() {
            ...
            if (void 0 !== s.plotY) {
              ...
              ((d = p_(s.plotX || 0, g)),
                ...
                (c = []).push(
                  ...
                  ['Z'],
                  ['M', d, a],
                  ['L', d, h ? Math.round(i ? s.yBottom : s.plotHigh) : a],
                  ['M', d, n],
                  ['L', d, l ? Math.round(i ? s.plotHigh : s.yBottom) : n]
                ),
                t[u ? 'attr' : 'animate']({ d: c }).addClass(s.getClassName(), !0));
            }
          }
        }
      }
      ((pq.defaultOptions = pZ(
        p$.defaultOptions,
              ...
              (e.plotX >= 0 && e.plotX <= l.len
                ? h
                  ? ((e.plotY = l.translate(e.x, 0, 1, 0, 1)),
                    (e.plotX = p5(e.y) ? d.translate(e.y, 0, 0, 0, 1) : 0))
      ...
      class up extends uo {
        ...
        drawPoints() {
          let t,
            ...
            y = {},
            b = [],
            v = uh(f.borderRadius) ? f.borderRadius : 0;
          for (s = c.length; s--; )
            ((o = c[s]),
              ...
              void 0 !== (e = o.plotY) &&
                (e = o.plotY + m - (void 0 !== a && a * f.stackDistance)),
              ...
              void 0 !== e && t >= 0 && !l
                ? (r && o.hasNewShapeType() && (r = r.destroy()),
                  r ||
                    ((r = o.graphic =
                      u
                        .label('', 0, void 0, i, void 0, void 0, f.useHTML)
                  ...
                  p.styledMode ||
                    r
                      ...
                      .css(ul(f.style, o.style))
                      .shadow(f.shadow),
                  t > 0 && (t -= r.strokeWidth() % 2),
                  (h = { y: e, anchorY: n }),
                  f.allowOverlapX && ((h.x = t), (h.anchorX = o.anchorX)),
                  r
                    .attr({ text: o.options.title ?? f.title ?? 'A' })
          ...
          f.useHTML &&
            this.markerGroup &&
            uc(this.markerGroup, 'on', function (t) {
        ...
        pointAttribs(t, e) {
          ...
          return (
            ...
            { fill: a || s, stroke: o || s, 'stroke-width': r || i.lineWidth || 0 }
          );
        }
        setClip() {
      ...
      ((up.compose = p0.compose),
        (up.defaultOptions = ul(uo.defaultOptions, {
          ...
          style: { color: '#000000', fontSize: '0.7em', fontWeight: 'bold' },
        })),
        ut.compose(up),
        un(up.prototype, {
          allowDG: !1,
          ...
          if (o && r > 0) {
            ...
            for (
              ...
              if (
                ...
                if (a.x - t.x > o) {
                  let e = (t.x + a.x) / 2;
                  (i.splice(r + 1, 0, { isNull: !0, x: e }),
                    s.stacking &&
                      this.options.stacking &&
                      ((s.stacking.stacks[this.stackKey][e] = new nW(
                        s,
        ...
        class l {
          ...
          isInAnyBreak(t, e) {
            ...
            if (o && ux(t)) {
              for (; o--; )
                l.isInBreak(s[o], t) &&
                  ((r = !0), a || (a = uy(s[o].showPoints, !i.isXAxis)));
              n = r && e ? r && !a : r;
            }
            return n;
          }
                ...
                (s.setAxisTranslation = function () {
                  if (
                    ...
                    let t = s.options.breaks || [],
                      ...
                      f;
                    (ux(s.threshold) &&
                      ((p = Math.min(p ?? s.threshold, s.threshold)),
      ...
      function uN() {
        ...
        for (; e--; )
          (r = t[e].options.dataGrouping) &&
            ((i = Math.max(i, uz(r.groupPixelWidth, uO.groupPixelWidth))),
            (o = (t[e].dataTable.getModified() || t[e].dataTable).rowCount),
            (t[e].groupPixelWidth || o > this.chart.plotSizeX / i || (o && r.forced)) &&
              (s = !0));
        return s ? i : 0;
      }
      function uW() {
      ...
      function uG(t, e) {
        let i;
        if (((e = uz(e, !0)), t || (t = { forced: !1, units: null }), this instanceof o))
          for (i = this.series.length; i--; )
            this.series[i].update({ dataGrouping: t }, !1);
        else
      ...
      let uX = function (t) {
          ...
          let e = t.prototype;
          e.applyGrouping ||
            (uB(t, 'afterSetScale', uW),
            uB(t, 'postProcessData', uR),
            uD(e, { applyGrouping: uR, getGroupPixelWidth: uN, setDataGrouping: uG }));
        },
        {
          series: { prototype: uH },
        } = r_,
      ...
      function uK(t) {
        ...
        let o,
          ...
          h = !1 !== this.allowDG && n && u_(n.enabled, a.options.isStock),
          l = this.reserveSpace(),
        ...
        let f = n.groupAll
            ? this.dataTable
            : this.dataTable.getModified() || this.dataTable,
        ...
        if (k && m && f.rowCount && x && uV(b.min)) {
          ...
          let t = b.min,
            ...
            h = ((k * (e - t)) / x) * i,
            d = y.getTimeTicks(
              ol.Additions.prototype.normalizeTimeTickInterval(h, n.units || uL),
              Math.min(t, m[0]),
              Math.max(e, m[m.length - 1]),
          ...
          for (
            n?.smoothed &&
              ...
              uj(32, !1, a, { 'dataGrouping.smoothed': 'use dataGrouping.anchor' })),
              o = 1;
            o < d.length;
            o++
          )
          ...
          (((c = d.info).gapSize = w),
            ...
            l &&
              ...
              (uY((s = M)[0]) &&
                ...
                uV(y.dataMin) &&
                s[0] < y.min &&
                (((!uY(y.options.min) && y.min <= y.dataMin) || y.min === y.dataMin) &&
              ...
              uY(s[s.length - 1]) &&
                ...
                uV(y.dataMax) &&
                s[s.length - 1] > y.max &&
                (((!uY(y.options.max) && uV(y.dataMax) && y.max >= y.dataMax) ||
                  y.max === y.dataMax) &&
                  (y.max = Math.max(s[s.length - 1], y.max)),
                (y.dataMax = Math.max(s[s.length - 1], y.dataMax)))),
            n.groupAll &&
              ((this.allGroupedTable = g),
              (M = (g = (p = this.cropData(g, y.min || 0, y.max || 0))
                .modified).getColumn('x')),
        ...
        let s = t.getColumn('x', !0) || [],
          ...
          S =
            'function' == typeof i
              ...
              : i && uv[i]
                ? uv[i]
                : uv[(r.getDGApproximation && r.getDGApproximation()) || 'average'];
        if (f) {
          let t = g.length;
          for (; t--; ) u.push([]);
        } else u.push([]);
          ...
          if (!(s[t] < e[0])) {
            for (; (void 0 !== e[M + 1] && s[t] >= e[M + 1]) || t === c; ) {
              if (
                ...
                (k = S.apply(r, u)),
                r.pointClass &&
                  !uY(r.dataGroupInfo.options) &&
                  ((r.dataGroupInfo.options = u$(
            ...
            if (g) {
              let e,
                ...
                s =
                  (a && a[i]) ||
                  r.pointClass.prototype.applyOptions.apply({ series: r }, [n[i]]);
              for (let t = 0; t < f; t++)
                uV((e = s[g[t]])) ? u[t].push(e) : null === e && (u[t].hasNulls = !0);
            } else
              uV((v = p ? o[t] : null))
                ? u[0].push(v)
                : null === v && (u[0].hasNulls = !0);
          }
        let T = { x: h };
        return (
          (g || ['y']).forEach((t, e) => {
      ...
      let u3 = function (t) {
          let e = t.prototype;
          e.applyGrouping ||
            (uF(t.prototype.pointClass, 'update', function () {
      ...
      function ge(t) {
        ...
        if (h && 'datetime' === h.options.type && n && u8(s.key)) {
          ...
          ((g = i.dateFormat(l, r)),
            ...
            (t.text = u5(f, { point: u4(s, { key: g }), series: o }, e)),
            t.preventDefault());
        }
      }
      ((V.dataGrouping = V.dataGrouping || {}),
        (V.dataGrouping.approximationDefaults =
          V.dataGrouping.approximationDefaults || uP),
      ...
      let { defined: gi, isNumber: gs, pick: go } = tx,
        ...
        gp = [],
        gu = { enabled: !0, sensitivity: 1.1, showResetButton: !1 },
        gg = function (t, e, i, s, o, a, n) {
          ...
          let d = t.transform({
            axes: l,
            to: { x: o - 5, y: a - 5, width: 10, height: 10 },
            from: { x: o - 5 * e, y: a - 5 * e, width: 10 * e, height: 10 * e },
            trigger: 'mousewheel',
      ...
      function gf() {
        var t;
        let e =
          (gn((t = this.zooming.mouseWheel)) || (t = { enabled: t ?? !0 }), gd(gu, t));
        e.enabled &&
          ga(this.container, 'wheel', (t) => {
            t = this.pointer?.normalize(t) || t;
            let { pointer: i } = this,
              s = i && !i.inClass(t.target, 'highcharts-no-mousewheel');
            if (
              this.isInsidePlot(t.chartX - this.plotLeft, t.chartY - this.plotTop) &&
              s
            ) {
