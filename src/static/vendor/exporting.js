!(
   ...
   */ (function (e, t) {
    'object' == typeof exports && 'object' == typeof module
      ? (module.exports = t(e._Highcharts, e._Highcharts.AST, e._Highcharts.Chart))
      : 'function' == typeof define && define.amd
        ? define('highcharts/modules/exporting', ['highcharts/highcharts'], function (e) {
    ...
    (() => {
      ...
      function C(e, t) {
        ...
        if (
          ((x && 'string' == typeof e && 0 === e.indexOf('data:application/pdf')) ||
            o ||
            e.length > 2e6) &&
          !(e =
            (function (e) {
            ...
            if (
              ...
              let n = F(
                  ...
                  function () {
                    e.isOpen
                      ? ((e.isOpen = !1), e.close())
                      : (t.setSize(null, null, !1), (e.isOpen = !0), e.setButtonText());
                  }
                ),
                i = F(t, 'destroy', n);
              e.unbindFullscreenEvent = () => {
      ...
      class eh {
        ...
        addButton(e) {
          ...
          (a
            ...
            r.text && r.symbol
              ...
              : r.text || Z(c, { width: r.width, height: r.height, padding: 0 }));
          let p = o
            .button(r.text || '', 0, 0, h, c, void 0, void 0, void 0, void 0, r.useHTML)
          ...
          ((p.menuClassName = e.menuClassName || 'highcharts-menu-' + n.btnCount++),
            ...
            (n.buttonOffset +=
              ((p.width || 0) + (r.buttonSpacing || 0)) * ('right' === r.align ? -1 : 1)),
        ...
        contextMenu(e, t, n, i, o, r, a) {
          ...
          (n + (s.menuWidth || 0) > h
            ? (y.right = h - n - o - g + 'px')
            : (y.left = n - g + 'px'),
            i + r + (s.menuHeight || 0) > p && a.alignOptions?.verticalAlign !== 'top'
              ? (y.bottom = p - i - g + 'px')
              : (y.top = i + r - g + 'px'),
            _(m, y),
        ...
        async fallbackToServer(e, t) {
          !1 === e.fallbackToExportServer
            ? e.error
              ? e.error(e, t)
              : Y(28, !0)
            : 'application/pdf' === e.type && ((e.local = !1), await this.exportChart(e));
        }
        getChartHTML(e) {
          let t = this.chart;
          return (
        ...
        getSVG(e) {
          ...
          return (
            ...
            (n =
              p.exporting?.getChartHTML(t.styledMode || o.exporting?.applyStyleSheets) ||
              ''),
            ...
            !(function o(a) {
              ...
              if (
                ...
                if (
                  ...
                  (l =
                    'svg' === a.nodeName ? {} : q.getComputedStyle(a.parentNode, null)),
                  !i[a.nodeName])
                ) {
                  ...
                  (G || $ || V || Object.hasOwnProperty.call(s, e)) &&
                    (function (e, o) {
                      ...
                      !h &&
                        ...
                        i[a.nodeName][o] !== e &&
                        (eh.inlineToAttributes && -1 === eh.inlineToAttributes.indexOf(o)
                          ? (u[o] = e)
        ...
        async localExport(e, t) {
          ...
          try {
            ...
            return (await this.downloadSVG(l, Z({ filename: this.getFilename() }, e)), l);
          } catch (t) {
            ...
            let i = this.options.exporting,
              {
                ...
                verticalAlign: a,
                width: s = 0,
              } = en(this.options.navigation?.buttonOptions, i?.buttons?.contextButton),
              l = e.width - n,
              c = s + r;
            (i?.enabled ?? !0) &&
              'title' === t &&
