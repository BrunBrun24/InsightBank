!(
 ...
 - ${i}: ${e}`),
        ...
        (tr(z, 'displayError', { chart: i, code: t, message: a, params: s }, function () {
          if (e) throw Error(a);
      ...
      function tr(t, e, i, s) {
        if (
          ((i = i || {}), W?.createEvent && (t.dispatchEvent || (t.fireEvent && t !== z)))
        ) {
      ...
      H.jQuery &&
        (H.jQuery.fn.highcharts = function () {
          ...
          if (this[0])
            return t[0]
              ? (new z[G(t[0]) ? t.shift() : 'Chart'](this[0], t[0], t[1]), this)
      ...
      let tn = {
          ...
          getStyle: function t(e, i, s) {
            ...
            return (
              r && ((o = r.getPropertyValue(i)), J(s, 'opacity' !== i) && (o = F(o))),
              o
            );
          },
            ...
            if (!o) {
              ...
              try {
                ...
                /Invalid time zone/i.test(e.message)
                  ? (tc(34), (t.timeZone = 'UTC'), (o = new Intl.DateTimeFormat(i, t)))
                  : tc(e.message, !1);
              }
            }
          ...
          makeTime(t, e, i = 1, s = 0, o, r, a) {
            ...
            if ('UTC' !== this.timezone) {
              ...
              if (
                ...
                t !== e
                  ? (n += e - t)
                  : t - 36e5 !== this.getTimezoneOffset(n - 36e5) || tw || (n -= 36e5);
              }
            }
            return n;
          }
                  ...
                  h === tC.year
                    ...
                    : h === tC.month
                      ...
                      : m && (h === tC.day || h === tC.week)
                        ? (t = o.makeTime(l, d, c + x * n * (h === tC.day ? 1 : 7)))
                        : m && h === tC.hour && n > 1
        ...
        tD = {
          ...
          setOptions: function (t) {
            return (
              ...
              t.lang && 'locale' in t.lang && tI.update({ locale: t.lang.locale }),
              t.lang?.chartTitle && (tE.title = { ...tE.title, text: t.lang.chartTitle }),
              tE
            );
          },
        },
      ...
      class tG {
        ...
        constructor(t) {
          ...
          if ('object' == typeof t && void 0 !== t.stops)
            ...
            for (
              this.input = t = tG.names[t.toLowerCase()] || t, s = tG.parsers.length;
              s-- && !i;
            )
        ...
        brighten(t) {
          ...
          if (this.stops)
            ...
            if (tN(e[0]))
              ...
              tG.useColorMix &&
                tF(this.input) &&
                (this.output = tX(this.input, t > 0 ? 'white' : 'black', Math.abs(t)));
          return this;
        }
        setOpacity(t) {
              ...
              t0(e, function (n, h) {
                (t3(t, h),
                  ...
                  'd' === h && tq(e.d)
                    ...
                    : t.attr
                      ? (s = t.attr(h))
                      : ((s = parseFloat(t_(t, h)) || 0), 'opacity' !== h && (o = 'px')),
                  r || (r = n),
            ...
            es(t, (e, i) => {
              ...
              (-1 === eh.allowedAttributes.indexOf(i) && (s = !1),
                -1 !== ['background', 'dynsrc', 'href', 'lowsrc', 'src'].indexOf(i) &&
                  (s = ei(e) && eh.allowedReferences.some((t) => 0 === e.indexOf(t))),
                s ||
                  (et(33, !1, void 0, { 'Invalid attribute in config': `${i}` }),
                  delete t[i]),
      ...
      class e7 {
              ...
              if (
                ...
                ((t.radAttr = n),
                  ...
                  l.forEach(function (e) {
                    0 === e[1].indexOf('rgba')
                      ? ((d = (o = tG.parse(e[1])).get('rgb')), (c = o.get('a')))
                      : ((d = e[1]), (c = 1));
                    let i = s
                      .createElement('stop')
        ...
        getBBox(t, e) {
          ...
          if ((u && !t && (i = l[u]), !i || i.polygon)) {
            ...
            ((s = i.height),
              c &&
                (i.height = s =
                  { '11px,17': 14, '13px,20': 16 }[`${g || ''},${Math.round(s)}`] || s),
        ...
        constructor(t, e) {
          ((this.onEvents = {}),
            ...
            (this.SVG_NS = eR),
            (this.element =
              'span' === e || 'body' === e ? eG(e) : eN.createElementNS(this.SVG_NS, e)),
            (this.renderer = t),
            (this.styles = {}),
            eZ(this, 'afterInit'));
        }
      ...
      class il extends it {
        ...
        onAdd() {
          (this.text.add(this),
            this.attr({ text: ia(this.textStr, ''), x: this.x || 0, y: this.y || 0 }),
            this.box &&
              ie(this.anchorX) &&
        ...
        updateBoxSize() {
          let t,
            ...
            s = this.padding,
            o = (this.bBox =
              (!io(this.widthSetting) || !io(this.heightSetting) || this.textAlign) &&
              ie(e.textStr)
                ? e.getBBox(void 0, 0)
                : il.emptyBBox);
      ...
      let ix = {
        ...
        iP = class {
                ...
                if (n) {
                  ...
                  for (; a.length; )
                    if (
                      ...
                      a.length &&
                        (this.truncate(t, t.textContent || '', void 0, 0, s, l, iA),
          ...
          modifyTree(t) {
            ...
            (t.forEach(e), iM(this.svgElement, 'afterModifyTree', { nodes: t }));
          }
        ...
        constructor(t, e, i, s, o, r, a) {
          ...
          (a || l.css(this.getStyle(s || {})),
            ...
            this.createElement('desc')
              .add()
              .element.appendChild(iI.createTextNode('Created with Highcharts 12.5.0')),
        ...
        symbol(t, e, i, s, o, r) {
          ...
          if (u)
            ('number' == typeof e &&
              ...
              iV(a, { symbolName: g || void 0, x: e, y: i, width: s, height: o }),
              r && iV(a, r));
          else if (p) {
            h = t.match(c)[1];
              ...
              ['width', 'height'].forEach((t) => {
                s[`${t}Setter`] = function (t, e) {
                  ...
                  (r && 'within' === r.backgroundSize && o && a && n && h
                    ? ((d = Math.min(o / n, a / h)),
                      iF(s, { width: Math.round(n * d), height: Math.round(h * d) }))
      ...
      let sa = (t, e) => {
        if (!t.div) {
          ...
          ((t.classSetter = (t, e, i) => {
            ...
            (t.on = function () {
              return (
                it.prototype.on.apply({ element: o, onEvents: t.onEvents }, arguments),
                t
              );
            }),
            (t.div = o));
        ...
        updateTransform() {
          ...
          let {
            ...
            x = () =>
              this.textPxLength
                ? this.textPxLength
                : (i4(t, { width: '', whiteSpace: d || 'nowrap' }), t.offsetWidth);
          if (
            ...
            (e &&
              ...
              u !== this.cTT &&
                ...
                this.getSpanCorrection(
                  (!i7(o) && !this.textWidth && this.textPxLength) || t.offsetWidth,
                  g,
                  se(c)
                )));
            ...
            return (
              (h =
                0 === d.side
                  ...
                  : 2 === d.side
                    ? u.y + m
                    : Math.cos(i.rotation * sf) * (u.y - i.getBBox(!1, 0).height / 2)),
              ...
              (x.x = t),
              (x.y = Math.round(e)),
              sk(this, 'afterGetLabelPosition', { pos: x, tickmarkOffset: r, index: a }),
              x
            );
          }
          getLabelSize() {
          ...
          handleOverflow(t) {
            ...
            (l || 'justify' !== i.overflow
              ? l < 0 && s - d * c < a
                ...
                : l > 0 && s + d * c > n && (f = Math.round((o - s) / Math.cos(l * sf)))
              : (s - d * c < a
                  ? (g = t.x + g * (1 - d) - a)
              ...
              f &&
                ...
                (this.shortenLabel
                  ? this.shortenLabel()
                  : h.css(
                      sv({}, { width: Math.floor(f) + 'px', lineClamp: +!e.isRadial })
                    )));
          }
          moveLabel(t, e) {
            let i = this,
      ...
      class s5 {
        ...
        init(t, e, i = this.coll) {
          ...
          (this.type ?? (this.type = r.type || 'linear'),
            ...
            (this.categories =
              (s$(r.categories) && r.categories) || (this.hasNames ? [] : void 0)),
              ...
              e.series.forEach((i) => {
                if (i.reserveSpace()) {
                  ...
                  if (
                    ...
                    (sV(t.dataMin) &&
                      ((a = t.dataMin), (e.dataMin = Math.min(sJ(e.dataMin, a), a))),
                      sV(t.dataMax) &&
                        ((n = t.dataMax), (e.dataMax = Math.max(sJ(e.dataMax, n), n))),
                      sW(r) && (e.threshold = r),
        ...
        getPlotLinePath(t) {
          ...
          function y(t, e, i) {
            return (
              'pass' !== p && (t < e || t > i) && (p ? (t = sz(t, e, i)) : (x = !0)),
              t
            );
          }
          let b = {
          ...
          return (
            sY(this, 'getPlotLinePath', b, function (t) {
              ((g = f =
                (c = sz((c = sJ(c, e.translate(a, void 0, void 0, r))), -1e9, 1e9)) + d),
                (u = m = h - c - d),
                sV(c)
                  ? e.horiz
                    ? ((u = o),
        ...
        adjustForMinRange() {
          ...
          (this.isXAxis &&
            ...
            sV(s) &&
              ...
              (s = sN(l)) - o < r &&
                ((h[0] = s - r), (h[1] = i.parse(t.min) ?? s - r), (o = sB(h)))),
            (this.minRange = r),
            (this.min = o),
            (this.max = s));
        }
        ...
        setTickInterval(t) {
          let {
            ...
            w = 0,
            M,
            S = sV(h.tickInterval) && h.tickInterval >= 0 ? h.tickInterval : void 0,
            T,
            C,
            A,
            P;
          if (
            ...
            (!i.polar &&
              this.min > this.max &&
              (sW(h.min) ? (this.max = this.min) : sW(h.max) && (this.min = this.max)),
              (w = this.max - this.min));
          }
          if (
        ...
        adjustTickAmount() {
          ...
          if (
            (sV(n) &&
              ((g =
                0 === n ? 0 : 1 === n ? a - 1 : Math.round(sz(n * (a - 1), 1, a - 2))),
              o.reversed && (g = a - 1 - g)),
            t.hasData() && sV(s) && sV(i))
          ) {
            let n = () => {
        ...
        unsquish() {
          ...
          if (i) {
            if (
              (!t.staggerLines &&
                (sV(r) ? (p = [r]) : o < t.autoRotationLimit && (p = t.autoRotation)),
              p)
            ) {
              let t, e;
              for (let i of p)
                (i === r || (i && i >= -90 && i <= 90)) &&
                  (e = (t = h(Math.abs(a / Math.sin(sD * i)))) + Math.abs(i / 360)) < c &&
                  ((c = e), (d = i), (l = t));
            }
          } else l = h(0.75 * a);
          return (
        ...
        renderUnsquish() {
          ...
          (sZ(o.rotation) || (l.rotation = o.rotation || 0),
            ...
            this.autoRotation
              ...
              : n && (p = h),
            l.rotation &&
              ((p = u > 0.5 * t.chartHeight ? 0.33 * t.chartHeight : u), c || (g = 1)),
        ...
        getTitlePosition(t) {
          let e = this.horiz,
            ...
            g = { low: a + (e ? 0 : o), middle: a + o / 2, high: a + (e ? o : 0) }[
              r.align
            ],
            u =
              (e ? s + this.height : i) +
                ...
                !o.styledMode &&
                  (h
                    .attr({
                      stroke:
                        i.color ||
                        (n ? tG.parse('#ccd3ff').setOpacity(0.25).get() : '#cccccc'),
          ...
          let E = t.slice(0, e.length + 1).reduce(function (t, s, o) {
            if (!1 !== s && '' !== s) {
              ...
              let { anchorX: b, anchorY: S } = (function (t) {
                ...
                return { anchorX: (e = oA(e, v.left - p, v.right + p)), anchorY: i };
              })(r);
              if ('number' == typeof S) {
                let e = x.height + 1,
            ...
            void 0 === this.x && i
              ...
              : o2(t.x) && i.options.relativeXValue
                ...
                : 'string' == typeof this.x &&
                  (e ?? (e = i.chart.time.parse(this.x)), o2(e) && (this.x = e)),
        ...
        destroy() {
          if (!this.destroyed) {
            ...
            (t.legendItem && i.legend.destroyItem(t),
              ...
              s?.enabled ? (this.animateBeforeDestroy(), o9(a, r.duration)) : a(),
              i.pointCount--);
          }
          this.destroyed = !0;
        }
      ...
      class ry {
        ...
        runPointActions(t, e, i) {
          ...
          (this.unDocMouseMove ||
            ((this.unDocMouseMove = rr(s.container.ownerDocument, 'mousemove', (t) =>
        ...
        setDOMEvents() {
          ...
          for (; s && 'BODY' !== s.tagName; )
            (this.eventsToUnbind.push(
              ...
              (s = i(s)));
          (this.eventsToUnbind.push(
            rr(t, 'touchstart', this.onContainerTouchStart.bind(this), { passive: !1 }),
            rr(t, 'touchmove', this.onContainerTouchMove.bind(this), { passive: !1 })
          ),
            ry.unbindDocumentTouchEnd ||
        ...
        rT = class {
          ...
          setColumns(t, e, i) {
            ...
            (rM(t, (t, e) => {
              ...
              i?.silent || (rw(this, 'afterSetColumns'), (this.versionTag = rS())));
          }
          setRow(t, e = this.rowCount, i, s) {
            ...
            (rM(o, (a, n) => {
              ...
              s?.silent || (rw(this, 'afterSetRows'), (this.versionTag = rS())));
          }
          getModified() {
      ...
      function rO(t, e, i) {
        ...
        if (m && !1 !== m.enabled && n) {
          ...
          (0 === l.indexOf('url') && ((m = rA(m, { width: h, height: h })), (t = 0)),
            (s.symbol = f =
              c
                .symbol(l, n / 2 - t, g - t, 2 * t, 2 * t, rC({ context: 'legend' }, m))
      ...
      class an {
          ...
          (r6(this, 'bindAxes', null, function () {
            (e.axisTypes || []).forEach(function (o) {
              ((s[o] || []).forEach(function (s) {
                ((t = s.options),
                  (ao(i[o], 0) === s.index || (void 0 !== i[o] && i[o] === t.id)) &&
        ...
        autoIncrement(t) {
          ...
          if (
            ((this.pointInterval = e = ao(this.pointInterval, i.pointInterval, 1)),
            o && at(t) && (e *= t),
            s)
          ) {
            let t = r.toParts(a);
        ...
        getName() {
          return (
            this.options.name ?? r$(this.chart.options.lang.seriesName, this, this.chart)
          );
        }
        getCyclic(t, e, i) {
          let s,
          ...
          (!e &&
            (rJ((o = ao('color' === t ? this.options.colorIndex : void 0, this[a])))
              ? (s = o)
        ...
        markerAttribs(t, e) {
          ...
          return (
            at(l) &&
              d &&
              (i.crisp &&
                (d[0] = rK(d[0], t.hasImage ? 0 : 'rect' === r ? s?.lineWidth || 0 : 1)),
              (a.x = d[0] - l),
              (a.y = d[1] - l)),
          ...
          for (
            r6(s, 'destroy', { keepEventsForUpdate: t }),
              ...
              (s.axisTypes || []).forEach(function (t) {
                ((i = s[t]),
                  i?.series && (r1(i.series, s), (i.isDirty = i.forceRedraw = !0)));
              }),
          ...
          return (
            ...
            r.addClass(
              'highcharts-' +
                ...
                this.type +
                '-series ' +
                (rJ(this.colorIndex) ? 'highcharts-color-' + this.colorIndex + ' ' : '') +
      ...
      class aO {
        ...
        colorizeItem(t, e) {
          ...
          ((t.color = i), aw(this, 'afterColorizeItem', { item: t, visible: e }));
        }
        positionItems() {
        ...
        renderItem(t) {
          ...
          (!y &&
            ...
            !this.baseline &&
              ...
              o.squareSymbol &&
                ((this.symbolWidth = aT(o.symbolWidth, Math.max(this.symbolHeight, 16))),
        ...
        proximatePositions() {
          ...
          for (let o of (this.allItems.forEach(function (t) {
            ...
            t.yAxis &&
              ...
              t.points &&
                (o = ak(a ? t.points : t.points.slice(0).reverse(), function (t) {
                  return aM(t.plotY);
                })),
              (r =
                this.itemMarginTop +
      ...
      class nn {
        ...
        init(t, e) {
          a1(this, 'init', { args: arguments }, function () {
            ...
            ((this.userOptions = aQ({}, t)),
              ...
              (this.time = new tA(aQ(i.time || {}, { locale: this.locale }), i.lang)),
          ...
          if (t)
            for (; e?.style; )
              (e.hcOrigStyle && (aV(e, e.hcOrigStyle), delete e.hcOrigStyle),
                e.hcOrigDetached && (aH.body.removeChild(e), (e.hcOrigDetached = !1)),
                (e = e.parentNode));
          else
            for (
              ;
        ...
        getContainer() {
          ...
          ((this.container = l),
            ...
            h !== this.chartWidth &&
              ((h = this.chartWidth),
              this.styledMode || aV(l, { width: nt(i.style?.width, h + 'px') })),
        ...
        transform(t) {
          ...
          for (let t of e) {
            ...
            let C = t.chart.polar || t.isOrdinal ? 0 : f * T || 0,
              ...
              E = t.allExtremes;
            if (
              (r && r[t.coll].push({ axis: t, min: Math.min(A, P), max: Math.max(A, P) }),
              L > O && ([L, O] = [O, L]),
              ...
              for (let e of t.series) {
                ...
                (E ?? (E = { dataMin: Number.MAX_VALUE, dataMax: -Number.MAX_VALUE }),
                  a6(t.dataMin) &&
                    a6(t.dataMax) &&
            ...
            (!t.isOrdinal || 1 !== w || o) &&
              (L < U && ((L = U), w >= 1 && (O = L + X)),
              O > $ && ((O = $), w >= 1 && (L = O - X)),
              (o || (t.series.length && (L !== B || O !== N) && L >= U && O <= $)) &&
                (r
          ...
          getStackBox(t) {
            let e = this.axis,
              ...
              p = Math.abs(
                l -
                  e.toPixels(
                    n || (nT(e.min) && e.logarithmic && e.logarithmic.lin2log(e.min)) || 0
                  )
              ),
              g = i.inverted,
              u = this.isNegative;
          ...
          [this, ...this.zones].forEach((s, o) => {
            ...
            (a
              ...
              a &&
                ...
                a[n](r).shadow(
                  t.shadow &&
                    n_({ filterUnits: 'userSpaceOnUse' }, nq(t.shadow) ? t.shadow : {})
                )),
      ...
      ((nK.defaultOptions = n_(ah.defaultOptions, { legendSymbol: 'lineMarker' })),
      ...
      class hx extends ah {
        ...
        pointAttribs(t, e) {
          ...
          (t &&
            ...
            e &&
              t &&
              ((h = (a = hu(i.states[e], t.options.states?.[e] || {})).brightness),
      ...
      !(function (t) {
        ...
        function i(t, e, i, s, o) {
          ...
          if (g && u) {
            ...
            if (
              ((s = hw({ x: u[0], y: Math.round(u[1]), width: 0, height: 0 }, s || {})),
              'plotEdges' === i.alignTo &&
                this.isCartesian &&
                ((s[n ? 'x' : 'y'] = 0),
        ...
        function s(t, e) {
          (hM(this, 'initDataLabelsGroup', { index: t, zIndex: e?.zIndex ?? 6 }),
                  ...
                  (c &&
                    ...
                    !s.styledMode &&
                      ...
                      'contrast' === m.color
                        ? ('none' !== p && (M = p),
                          ...
                          (m.color =
                            M || (!hk(f) && n.inside) || 0 > hO(f || 0) || o.stacking
                              ? t.contrastColor
                              : d))
                    ...
                    c &&
                      ...
                      k &&
                        ...
                        hM(k, 'beforeAddingDataLabel', { labelOptions: n, point: t }),
                        k.added || k.add(e),
                    ...
                    ((g = s.connector),
                      n && n.distance > 0
                        ? ((h = !g),
                          ...
                          g[h ? 'attr' : 'animate']({ d: e.getConnectorPath(s) }),
          ...
          return (
            !a &&
              ...
              null !== s[1]
                ...
                : ((r = lc(r, o, e[2] - t[0] - t[2])), (e[1] += (t[0] - t[2]) / 2)),
              r < e[2]
                ? ((e[2] = r),
                  (e[3] = Math.min(
                    i.thickness
      ...
      function lN(t, e, i, s, o = {}) {
        ...
        let p = c - d,
          g = Math.sin(p / 2),
          u = Math.max(
            Math.min(lE(o.borderRadius || 0, l - h), (l - h) / 2, (l * g) / (1 + g)),
            0
          ),
      ...
      (D || (D = {})).compose = function (t) {
        let e = t.prototype;
        return (
          e.matchResponsiveRule || lF(e, { matchResponsiveRule: l$, setResponsive: lV }),
          t
        );
      };
      let lZ = D;
                      ...
                      (s.dataLabels || []).forEach((i) => {
                        ...
                        ((i.labelrank = lM(
                          ...
                          (o.allowOverlap ?? Number(o.distance) > 0)
                            ? ((i.oldOpacity = i.opacity), (i.newOpacity = 1), lS(i, t))
                            : e.push(i));
                      });
                };
