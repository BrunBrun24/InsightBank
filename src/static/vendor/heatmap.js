!(
   ...
   */ (function (t, e) {
    'object' == typeof exports && 'object' == typeof module
      ...
      : 'function' == typeof define && define.amd
        ? define('highcharts/modules/heatmap', ['highcharts/highcharts'], function (t) {
            return e(t, t.Axis, t.Color, t.SeriesRegistry, t.SVGElement, t.SVGRenderer);
          })
  ...
  })('u' < typeof window ? this : window, (t, e, i, s, o, r) =>
    (() => {
      'use strict';
      var l,
        a,
      ...
      function c(t) {
        ...
        let i = (p[t] = { exports: {} });
        return (d[t](i, i.exports, c), i.exports);
      }
      ((c.n = (t) => {
      ...
      var g = c(944),
        ...
        b = c.n(y);
      let { parse: v } = b();
      (((l = a || (a = {})).initDataClasses = function (t) {
        let e = this.chart,
          ...
          ((r = o[t]),
            ...
            (e.styledMode || !r.color) &&
              ('category' === s.dataClassColor
                ? (e.styledMode ||
                    ((a = (h = e.options.colors || []).length), (r.color = h[n])),
                  (r.colorIndex = n),
                  ++n === a && (n = 0))
                : (r.color = v(s.minColor).tweenTo(
                    v(s.maxColor),
                    i < 2 ? 0.5 : t / (i - 1)
                  ))));
      }),
        (l.initStops = function () {
          ...
          for (let t = 0, i = e.length; t < i; ++t) e[t].color = v(e[t][1]);
        }),
        ...
        (l.toColor = function (t, e) {
          ...
          if (n) {
            ...
            for (i = this.normalizedValue(t), a = h.length; a-- && !(i > h[a][0]); );
            ((s = h[a] || h[a + 1]),
              (i = 1 - ((o = h[a + 1] || s)[0] - i) / (o[0] - s[0] || 1)),
      ...
      !(function (t) {
        ...
        function i() {
          ...
          ((this.colorAxis = []),
            t.colorAxis &&
              ((t.colorAxis = (0, g.splat)(t.colorAxis)),
        ...
        ((t.compose = function (t, c, u, m, f) {
          var x;
          let y,
            b = c.prototype,
            v = u.prototype,
            C = f.prototype;
          b.collectionsWithUpdate.includes('colorAxis') ||
            ((e = t),
            b.collectionsWithUpdate.push('colorAxis'),
            (b.collectionsWithInit.colorAxis = [b.addColorAxis]),
            (0, g.addEvent)(c, 'afterCreateAxes', i),
            (y = (x = c).prototype.createAxis),
            (x.prototype.createAxis = function (t, i) {
              if ('colorAxis' !== t) return y.apply(this, arguments);
              let s = new e(
                this,
                (0, g.merge)(i.axis, { index: this[t].length, isX: !1 })
              );
              return (
                ...
                (0, g.pick)(i.redraw, !0) && this.redraw(i.animation),
                s
              );
            }),
            (v.fillSetter = d),
            (v.strokeSetter = p),
            (0, g.addEvent)(m, 'afterGetAllItems', s),
            (0, g.addEvent)(m, 'afterColorizeItem', o),
            (0, g.addEvent)(m, 'afterUpdate', r),
            (0, g.extend)(C, { optionalAxis: 'colorAxis', translateColors: h }),
            (0, g.extend)(C.pointClass.prototype, { setVisible: n }),
            (0, g.addEvent)(f, 'afterTranslate', l, { order: 1 }),
            (0, g.addEvent)(f, 'bindAxes', a));
        }),
          (t.pointSetVisible = n));
      })(n || (n = {}));
      let k = n;
      var w = c(512),
        M = c.n(w);
      let { defaultOptions: L } = m(),
        { series: I } = M();
      L.colorAxis = (0, g.merge)(L.xAxis, {
        lineWidth: 0,
        minPadding: 0,
        maxPadding: 0,
      ...
      class P extends x() {
        ...
        init(t, e) {
          ...
          ((this.side = e.side || s ? 2 : 1),
            ...
            (this.userOptions = e),
            (0, g.isArray)(t.userOptions.colorAxis) &&
        ...
        setOptions(t) {
          let e = this.chart.options.legend || {},
            i = L.colorAxis,
            s = t.layout || e.layout || i.layout,
            o = (0, g.merge)(
              'vertical' !== s
                ? { title: { rotation: 0 } }
                : { title: { rotation: 90, margin: 10 } },
              i,
              t,
              {
                showEmpty: !1,
          ...
          (super.setOptions(o), (this.options.crosshair = this.options.marker));
        }
        setAxisSize() {
          let t = this.chart,
          ...
          (e &&
            ...
            (this.len = (this.horiz ? i : s) || P.defaultLegendLength));
        }
        getOffset() {
          let t = this.chart,
            e = this.legendItem?.group,
            i = t.axisOffset[this.side],
            { clipOffset: s, legend: o } = t;
          e &&
            ((this.axisParent = e),
            super.getOffset(),
            o.allItems.forEach(function (t) {
              t instanceof P && t.drawLegendSymbol(o, t);
            }),
            o.render(),
            t.getMargins(!0),
        ...
        drawLegendSymbol(t, e) {
          let i = e.legendItem || {},
            ...
            l = (0, g.pick)(o.itemDistance, 10),
            a = this.horiz,
            { width: n, height: h } = this.getSize(),
            d = (0, g.pick)(o.labelPadding, a ? 16 : 30);
          this.setLegendColor();
          let p = 0,
            c = 0;
          if (this.options.title?.text && !this.axisTitle) {
            this.axisGroup || ((this.axisParent = i.group), this.createGroups());
            let t = this.len,
              e = this.top,
              s = this.left,
              o = this.width;
          ...
          if (this.axisTitle) {
            let t = this.axisTitle.getBBox();
            ((p = t.height), (c = t.width));
          }
          let u = this.options.title || {},
            m = this.axisTitle ? (u.margin ?? 0) : 0,
            f = a ? p + m : 0;
          (i.symbol ||
            (i.symbol = this.chart.renderer
              ...
              .add(i.group)),
            i.symbol.attr({ x: 0, y: (t.baseline || 0) - 11 + f, width: n, height: h }),
            a
              ? ((i.labelWidth = Math.max(n + s + l, c || 0)),
                (i.labelHeight = h + s + d + p + m))
              : ((i.labelWidth =
                  n +
                  s +
                  (r.x ?? r.distance ?? 0) +
                  ...
                  (c || 0) +
                  m),
                (i.labelHeight = Math.max(h + s, p || 0))));
        }
        getTitlePosition(t) {
          let e = super.getTitlePosition(t),
            i = this.options.title?.margin ?? 0;
          if (this.horiz && t) e.y = this.top - i;
          else if (!this.horiz && t) {
            let t = this.options.labels || {},
              s = t.x ?? t.distance ?? 0;
            e.x = this.left + this.width + s + (this.maxLabelLength || 0) + i;
          }
          return e;
        }
        setState(t) {
        ...
        drawCrosshair(t, e) {
          ...
          e &&
            ((i = this.toPixels(e.getNestedProperty(e.series.colorKey))) < l
              ? (i = l - 2)
              : i > l + a && (i = l + a + 2),
            (e.plotX = i),
            (e.plotY = this.len - i),
            ...
            this.cross &&
              ...
              s.group &&
              (this.cross.addClass('highcharts-coloraxis-marker').add(s.group),
          ...
          if ((0, g.isNumber)(i)) {
            if (s) {
              let t = this.height,
                ...
                l = o;
              return (
                this.horiz || ((t = this.width), (r = e), (l = i - t / 2)),
                this.chart.renderer.symbols[s](r, l, t, t)
              );
            }
            return this.horiz
              ? [['M', i - 4, o - 6], ['L', i + 4, o - 6], ['L', i, o], ['Z']]
              : [['M', e, i], ['L', e - 6, i + 6], ['L', e - 6, i - 6], ['Z']];
          }
          return super.getPlotLinePath(t);
        }
        update(t, e) {
          ...
          (this.series.forEach((t) => {
            ...
            super.update(t, e),
            this.legendItem?.label && (this.setLegendColor(), i.colorizeItem(this, !0)));
        }
        destroyItems() {
          let t = this.chart,
            e = this.legendItem || {};
        ...
        getDataClassLegendSymbols() {
          let t,
            ...
            o = i.options.legend,
            r = (0, g.pick)(o.valueDecimals, -1),
            l = (0, g.pick)(o.valueSuffix, ''),
            a = (t) =>
              e.series.reduce(
                    ...
                    (0, g.extend)(
                      {
                        ...
                        setVisible: function () {
                          ...
                          (i.legend.colorizeItem(this, c),
                            t.forEach((t) => {
                              (0, g.fireEvent)(t, 'afterDataClassLegendClick');
                            }));
                        },
                      },
                      o
        ...
        getSize() {
          ...
          return {
            width: (0, g.pick)(
              (0, g.defined)(s) ? (0, g.relativeLength)(s, t.chartWidth) : void 0,
              o?.symbolWidth,
              e ? P.defaultLegendLength : 12
            ),
            height: (0, g.pick)(
              (0, g.defined)(i) ? (0, g.relativeLength)(i, t.chartHeight) : void 0,
              o?.symbolHeight,
              e ? 12 : P.defaultLegendLength
            ),
          };
        }
      }
      ((P.defaultLegendLength = 200),
        ...
        (0, g.extend)(P.prototype, C),
        Array.prototype.push.apply(x().keepProps, P.keepProps));
      /**
       ...
       * see www.highcharts.com/license
       */ let T = m();
      ((T.ColorAxis = T.ColorAxis || P),
        T.ColorAxis.compose(T.Chart, T.Fx, T.Legend, T.Series));
      var E = c(28),
        S = c.n(E);
      let {
        column: { prototype: D },
      ...
      function V(t) {
        ...
        this.moveToTopOnHover &&
          ...
          (e.stateMarkerGraphic ||
            (e.stateMarkerGraphic = new (S())(i, 'use')
      ...
      ((O.pointMembers = {
        ...
        (O.compose = function (t) {
          ...
          return ((0, g.addEvent)(e, 'afterSetState', V), t);
        }));
      let H = h,
        {
          scatter: {
            prototype: { pointClass: z },
          },
        } = M().seriesTypes;
      class G extends z {
        applyOptions(t, e) {
        ...
        getCellAttributes() {
          let t = this.series,
            ...
            n = (0, g.pick)(this.pointPadding, e.pointPadding, 0),
            h = {
              x1: (0, g.clamp)(
                Math.round(o.len - o.translate(this.x - i, !1, !0, !1, !0, -a)),
                -o.len,
                2 * o.len
              ),
              x2: (0, g.clamp)(
          ...
          for (let t of [
            ...
            let e = t[0],
              ...
              d = Math.abs(h[s] - h[a]),
              p = (l && l.lineWidth) || 0,
              c = Math.abs(h[s] + h[a]) / 2,
              u = l && l[e];
            if ((0, g.defined)(u) && u < d) {
              let t = u / 2 + p / 2;
              ((h[s] = c - t), (h[a] = c + t));
            }
            n &&
      ...
      let { doc: W } = m(),
        {
          series: _,
          seriesTypes: { column: K, scatter: j },
        } = M(),
        {
          prototype: { symbols: X },
        } = N(),
        { colorFromPoint: F, getContext: U } = {
          colorFromPoint: function (t, e) {
            ...
            if (i) {
              let s = i
                ...
                .split('(')[1]
                .split(',')
                .map((t) => (0, g.pick)(parseFloat(t), parseInt(t, 10)));
              return (
                (s[3] = 255 * (0, g.pick)(s[3], 1)),
                ((0, g.defined)(t) && e.visible) || (s[3] = 0),
                s
              );
            }
            return [0, 0, 0, 0];
          ...
          getContext: function (t) {
            ...
            return e && i?.clearRect
              ? (i.clearRect(0, 0, e.width, e.height), i)
              : ((t.canvas = W.createElement('canvas')),
                (t.context =
                  t.canvas.getContext('2d', { willReadFrequently: !0 }) || void 0),
                t.context);
          },
        };
      class Y extends j {
            ...
            if (!e || t.isDirtyData || t.isDirtyCanvas) {
              ...
              if (n && l && g) {
                let { min: g, max: m } = s.getExtremes(),
                  ...
                  M = w * (n.height = C + 1),
                  L = (u - 1) / M,
                  I = new Uint8ClampedArray(4 * M),
                  P = (t, e) => 4 * Math.ceil(w * k(e - f) + A(t - g));
                t.buildKDTree();
                for (let t = 0; t < M; t++) {
                  let e = c[Math.ceil(L * t)],
                    { x: i, y: s } = e;
                  I.set(F(e.value, e), P(i, s));
                }
        ...
        getExtremes() {
          let { dataMin: t, dataMax: e } = _.prototype.getExtremes.call(
            this,
            this.getColumn('value')
          );
          return (
            (0, g.isNumber)(t) && (this.valueMin = t),
            (0, g.isNumber)(e) && (this.valueMax = e),
            _.prototype.getExtremes.call(this)
          );
        }
        getValidPoints(t, e) {
          return _.prototype.getValidPoints.call(this, t, e, !0);
        }
        hasData() {
        ...
        init() {
          ...
          let t = this.options;
          ((t.pointRange = (0, g.pick)(t.pointRange, t.colsize || 1)),
            (this.yAxis.axisPointRange = t.rowsize || 1),
            (X.ellipse = X.circle),
            t.marker && (0, g.isNumber)(t.borderRadius) && (t.marker.r = t.borderRadius));
          let e = (this.canvas = document.createElement('canvas'));
          e && (this.context = e?.getContext('webgpu'));
        }
        markerAttribs(t, e) {
          let i = t.shapeArgs || {};
          ...
          if (e && 'normal' !== e) {
            let s = t.options.marker || {},
              ...
              l = s.states?.[e] || {},
              a =
                (l.width || r.width || i.width || 0) + (l.widthPlus || r.widthPlus || 0),
              n =
                (l.height || r.height || i.height || 0) +
                (l.heightPlus || r.heightPlus || 0);
            return {
              x: (i.x || 0) + ((i.width || 0) - a) / 2,
              y: (i.y || 0) + ((i.height || 0) - n) / 2,
              width: a,
              height: n,
            };
          }
        ...
        pointAttribs(t, e) {
          let i = _.prototype.pointAttribs.call(this, t, e),
            s = this.options || {},
            o = this.chart.options.plotOptions || {},
            r = o.series || {},
            l = o.heatmap || {},
            a = t?.options.borderColor || s.borderColor || l.borderColor || r.borderColor,
            n =
              ...
              i['stroke-width'];
          if (
            ((i.stroke = t?.marker?.lineColor || s.marker?.lineColor || a || this.color),
            (i['stroke-width'] = n),
            e && 'normal' !== e)
          ) {
            let o = (0, g.merge)(
        ...
        translate() {
          ...
          for (let e of (this.generatePoints(), this.points)) {
            ...
            if (((e.hasImage = 0 === (e.marker?.symbol || i || '').indexOf('url')), o)) {
              let t = Math.abs(n - h);
            ...
            (e.hasImage && (e.marker = { width: n, height: h }),
              ...
              (e.plotY = (r.y1 + r.y2) / 2),
              (e.shapeType = 'path'),
              (e.shapeArgs = (0, g.merge)(
                !0,
                { x: l, y: a, width: n, height: h },
                { d: X[s](l, a, n, h, { r: (0, g.isNumber)(t) ? t : 0 }) }
              )));
          }
          (0, g.fireEvent)(this, 'afterTranslate');
        }
      }
      ((Y.defaultOptions = (0, g.merge)(j.defaultOptions, {
        ...
        (0, g.addEvent)(Y, 'afterDataClassLegendClick', function () {
          ((this.isDirtyCanvas = !0),
            this.drawPoints(),
            this.options.enableMouseTracking && this.drawTracker());
        }),
        (0, g.extend)(Y.prototype, {
        ...
        H.compose(Y),
        M().registerSeriesType('heatmap', Y));
      let B = m();
      return u.default;
    })()
  )
